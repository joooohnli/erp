...
response.sendRedirect("contactPeriodExpiry.jsp");
crm_db.close();

//response.sendRedirect("contactPeriodExpiry444.jsp");
}else{
%>
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick=location="contactPeriodExpiry.jsp"></div>
 </td>
 </tr>
 </table>
 </div>
