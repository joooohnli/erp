...
<form id="timeLocateValidation" class="x-form" method="post" action="aliveQuery_locate_getpara.jsp" onSubmit="return doValidate('../../xml/crm/crm_config_public_char.xml','timeLocateValidation')">	
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
