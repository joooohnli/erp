...
<form id="secondAlarm" class="x-form" method="post" action="secondAlarm_register.jsp" onSubmit="return doValidate('../../../xml/crm/crm_config_public_double.xml','secondAlarm')">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
String check_expiry="";
String return_limit="";
String sql1 = "select * from crm_config_public_double where kind='回款橙警'";
...
String sql4 = "select * from crm_config_public_double where kind='欠款橙警'";
