...
<form id="thirdAlarm" class="x-form" method="post" action="thirdAlarm_register.jsp" onSubmit="return doValidate('../../../xml/crm/crm_config_public_double.xml','thirdAlarm')">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","修改")%>" style="width: 50; "></div></td>
 </tr>
</table>
<%
...
String check_expiry="";
String return_limit="";
String sql1 = "select * from crm_config_public_double where kind='回款黄警'";
...
String sql2 = "select * from crm_config_public_double where kind='联络黄警'";
...
String sql4 = "select * from crm_config_public_double where kind='欠款黄警'";
...
<input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="gather_expiry" value="<%=exchange.toHtml(gather_expiry)%>" style="width: 30%"></td>
</tr>
