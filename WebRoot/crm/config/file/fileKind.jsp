...
<!--目录不同-->
<script type="text/javascript" src="../../../javascript/crm/config/file/treeBusiness.js"></script>
...
function addTree(){
 ...
 Nseer_tree1.setModuleName('../../../xml/crm/config/file');
 Nseer_tree1.addRootNode('No0','<%=demo.getLang("erp","全部分类")%>',false,'1',[]);
 Nseer_tree1.setParent('nseer1');
initMyTree(Nseer_tree1);
createButton('../../../xml/crm/config/file','crm_config_file_kind','treeButton');
}
</script>
