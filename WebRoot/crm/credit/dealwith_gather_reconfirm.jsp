...
<tr <%=TR_STYLE1%> class="TR_STYLE1"> 
 ...
 <td colspan="2" <%=TD_STYLE11%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","登记人")%></td>
...
%>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2"><input name="cost_price<%=i%>" type="hidden" value="<%=exchange.toHtml(cost_price[i])%>"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(subtotal)%></td>
...
<input type="hidden" name="sales_name" value="<%=exchange.toHtml(sales_name)%>">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"> <input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","返回")%>">
 </td>
 </tr>
 </table>
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","数量、单价、折扣、运费额度必须是 数字，请返回！")%></td>
 <td <%=TD_STYLE3%> class="TD_STYLE3">&nbsp;</td>
 </tr>
 </table>
</form>
