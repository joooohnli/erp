...
<form id="mutiValidation" method="POST" action="../../crm_discussion_change_ok?discussion_ID=<%=rs.getString("discussion_ID")%>" onSubmit="return doValidate('../../xml/crm/crm_discussion.xml','mutiValidation')">
 <table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","确认")%>"> <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick=location="change_list.jsp"></div></td>
 </tr>
 </table>
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><%=rs.getString("sale_price_sum")%>&nbsp;</td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <input name="changer_ID" type="hidden" value=""> 
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
