...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=exchange.toHtml(rs6.getString("product_ID"))%>&nbsp;</td>
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><a href="javascript:winopenm('query_attachment.jsp?id=<%=rs.getString("id")%>&tablename=crm_discussion&fieldname=attachment_name')"><%=attachment_name1[1]%></a>&nbsp;</td></tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
