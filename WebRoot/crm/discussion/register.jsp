...
<form id="mutiValidation" method="POST" action="register_reconfirm.jsp" onSubmit="return doValidate('../../xml/crm/crm_discussion.xml','mutiValidation')">
...
<table>
<span id="choiceListSpan" style="display:none;">
<tbody id="choiceList">
</tbody>
</table>
