...
if(tablename.equals("crm_file")){
condition="where check_tag='1'";
queue="order by register_time";
}else if(tablename.equals("crm_order")){
condition="where check_tag='1'";
queue="order by register_time";
}
else{
tablename="crm_discussion";
...
XmlFactory xml= new XmlFactory("conf/xml/crm/file_export.xml",dbase,tablename,colsNames,"conf/xml/crm/data_excel.xml",sql);
xml.makeElement();
xml.Xmlwrite();
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","下载")%>" onClick=location="xml_down.jsp">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" name="B5" onClick=location="xml.jsp"></div>
 </td>
 </tr>
 </table>
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
