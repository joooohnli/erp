...
if(vt.validata((String)session.getAttribute("unit_db_name"),"crm_file","id",id,"check_tag").equals("1")){
try{
	String sqll = "select * from crm_file where id="+id+"" ;
...
<form id="mutiValidation" class="x-form" method="post" action="../../crm_file_change_ok?id=<%=id%>" onSubmit="return doValidate('../../xml/crm/crm_file.xml','mutiValidation')">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3">
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","提交")%>">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="37.4%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="customer_name" style="width:80%" value="<%=exchange.toHtml(rss.getString("customer_name"))%>"></td>
...
%>
		<option value="<%=exchange.toHtml(rs7.getString("type_value"))%>" selected><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs7.getDouble("type_value"))%></option>
<%}else{%>
		<option value="<%=exchange.toHtml(rs7.getString("type_value"))%>"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs7.getDouble("type_value"))%></option>
<%
}
}
%>
...
while(rs8.next()){
	...
	%>
		<option value="<%=exchange.toHtml(rs8.getString("type_value"))%>" selected><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs8.getDouble("type_value"))%></option>
<%}else{%>
		<option value="<%=exchange.toHtml(rs8.getString("type_value"))%>"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs8.getDouble("type_value"))%></option>
<%
}
}
%>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" style="width:49%" name="contact_person1_department" value="<%=exchange.toHtml(rss.getString("contact_person1_department"))%>"></td>
  </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="changer" style="width:49%" value="<%=exchange.toHtml(changer)%>"></td>
  </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3">
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick=location="change_list.jsp"></div></td>
 </tr>
</table>
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
