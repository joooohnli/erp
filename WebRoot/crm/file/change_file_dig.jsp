...
try{
	String sql = "select * from crm_file_dig where change_time='"+change_time+"' and customer_ID='"+customer_ID+"'" ;
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="javascript:winopen('../order/query_list.jsp?keyword_chain=<%=rs.getString("customer_ID")%>&&return_tag=0')"><%=exchange.toHtml(rs.getString("trade_amount"))%></a>&nbsp;</td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="change_file_dig.jsp?time=<%=toUtf8String.utf8String(exchange.toURL(rs.getString("lately_change_time")))%>&&customer_ID=<%=rs.getString("customer_ID")%>"><%=exchange.toHtml(rs.getString("file_change_amount"))%></a>&nbsp;</td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="8%"><%=demo.getLang("erp","联络次数累计")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="../contact/query_list.jsp?keyword_chain=<%=rs.getString("customer_ID")%>"><%=exchange.toHtml(rs.getString("contact_amount"))%></a>&nbsp;</td>
<td <%=TD_STYLE11%> class="TD_STYLE1" width="8%"><%=demo.getLang("erp","档案附件")%></td>
<td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="javascript:winopenm('query_attachment.jsp?id=<%=rs.getString("id")%>&tablename=crm_file_dig&fieldname=attachment_name')">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="../contact/query_list.jsp?keyword_chain=<%=rs.getString("customer_ID")%>"><%=exchange.toHtml(lately_contact_time)%></a>&nbsp;</td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE11%> class="TD_STYLE1" width="8%"><%=demo.getLang("erp","最近变更时间")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="change_file_dig.jsp?time=<%=toUtf8String.utf8String(exchange.toURL(rs.getString("lately_change_time")))%>&&customer_ID=<%=rs.getString("customer_ID")%>"><%=exchange.toHtml(lately_change_time)%></a>&nbsp;</td>
