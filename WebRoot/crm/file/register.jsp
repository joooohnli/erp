...
<form id="mutiValidation" class="x-form" method="post" action="../../crm_file_register_ok" onSubmit="return doValidate('../../xml/crm/crm_file.xml','mutiValidation')">
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDraft("'mutiValidation','../../crm_file_register_draft_ok','../../xml/crm/crm_file.xml'",request)%>&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","提交")%>">&nbsp;<input type="reset" <%=RESET_STYLE1%> class="RESET_STYLE1" value="<%=demo.getLang("erp","清除")%>"></div>
 </td>
 </tr>
</table>
<%
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input id="validator_dup" type="text" <%=INPUT_STYLE1%> style="width:80%" name="customer_name"><a href="javascript:ajax_validation('mutiValidation','validator_dup','crm_file','customer_name','../../vdf','customer_ID','query.jsp',this)" onMouseOver="toolTip('<%=demo.getLang("erp","该功能用于检验客户信息是否重复！")%>',this)" onMouseOut="toolTip()"><img src="../../images/dup.gif" width="15" height="14" align="center" border="0"></a></td>
