...
<div id="nseer1" style="position:relative;display:block;width:80%;height:expression(this.parentElement.offsetHeight-50);overflow:auto; left:17%;top:0px">
...
function addTree(){
 ...
 Nseer_tree1.setModuleName('../../../xml/design/config/file');//xml文件路径
 Nseer_tree1.addRootNode('No0','<%=demo.getLang("erp","全部分类")%>',false,'1',[]);
 Nseer_tree1.setParent('nseer1');
 initMyTree(Nseer_tree1);
createButton('../../../xml/design/config/file','design_config_file_kind','treeButton');
}
</script>