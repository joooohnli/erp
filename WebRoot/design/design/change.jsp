...
if(rs.next()){
	...
	design_ID=rs.getString("design_ID");
%>
...
<form id="mutiValidation" method="POST" action="../../design_design_change_ok?design_ID=<%=design_ID%>" onSubmit="return doValidate('../../xml/design/design_module.xml','mutiValidation')">
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="winopen('register_module_list.jsp')" value="<%=demo.getLang("erp","添加新物料")%>"> 
  <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="delSelect()" value="<%=demo.getLang("erp","删除新物料")%>">&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","重新提交")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onClick="history.back()" value="<%=demo.getLang("erp","返回")%>"></td>
 </tr>
 </table>
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE5%> class="INPUT_STYLE5" name="amount<%=i%>" value="<%=new java.text.DecimalFormat((String)application.getAttribute("nseerAmountPrecision")).format(rs6.getDouble("amount"))%>" style="background-color:#FFFFCC"></td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="change_delete_details.jsp?id=<%=rs6.getString("id")%>&&module_id=<%=module_id%>&&design_ID=<%=design_ID%>"><%=demo.getLang("erp","删除")%></a></td>
 </tr>
<%
	i++;
	}
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="changer" value="<%=exchange.toHtml(changer)%>"></td>
...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="89%" colspan="3"><textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="module_describe"><%=rs.getString("module_describe")%></textarea>
</td>
 </tr>
</table>
