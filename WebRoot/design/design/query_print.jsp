...
<%
    int count=0;
	String sql5="select count(*) from design_module_details where design_ID='"+design_ID+"'";
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" colspan="3" width="89%"><%=rs.getString("module_describe")%>&nbsp;</td>
 </tr>
</table>
</div>
