...
String sql9="select * from design_workflow where object_ID='"+product_ID+"' and check_tag='0' and config_id<'"+config_id+"'";
ResultSet rs9=designdb.executeQuery(sql9);
if(!rs9.next()){
if(vt.validata((String)session.getAttribute("unit_db_name"),"design_file","product_ID",product_ID,"check_tag").equals("0")){
try{
...
<script type="text/javascript" src="../../javascript/design/file/register.js"></script>
