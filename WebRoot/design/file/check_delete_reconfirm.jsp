...
<form class="x-form" method="post" action="../../design_file_check_delete_ok">
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","该产品档案档案审核未通过，您确认吗？请选择处理：")%></td>
 </tr>

<%
int i=1;
String sql6="select config_id from design_workflow where object_ID='"+product_ID+"' and config_id<'"+config_id+"' order by id";
