...
switch(finished_tag){
	case 0:
		out.println(demo.getLang("erp","对不起，产品名称重复，请重新登记，请返回！"));
		break;
	case 1:
		out.println(demo.getLang("erp","分类或产品经理选择错误，请重新登记！"));
		break;
	case 2:
		out.println(demo.getLang("erp","市场单价、成本单价必须是数字且单价必须大于0，请重新登记！"));
		break;
}
%>
</td>
