...
<form class="x-form" method="post" action="../../design_price_change_check_delete_ok">
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10"><%=demo.getLang("erp","该产品价格调整审核未通过，您确认吗？请选择处理：")%></td>
 </tr>
 </table>
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
...
<%
int i=1;
String sql6="select config_id from design_workflow where type_id='02' and object_ID='"+product_ID+"' and config_id<'"+config_id+"' order by id";
