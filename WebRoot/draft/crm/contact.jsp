...
if(vt.validata((String)session.getAttribute("unit_db_name"),"crm_contact","contact_ID",contact_ID,"check_tag").equals("5")||vt.validata((String)session.getAttribute("unit_db_name"),"crm_contact","contact_ID",contact_ID,"check_tag").equals("9")){
try{
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDsend("'mutiValidation','../../draft_crm_contact_draft_ok','../../xml/crm/crm_contact.xml'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交审核")%>" onClick="sendOk('mutiValidation','../../draft_crm_contact_check_ok','../../xml/crm/crm_contact.xml');">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back();"></div>
 </td>
 </tr>
</table>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1"> 
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input name="contact_time" type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" style="width:49%" value="<%=exchange.toHtml(contact_time)%>"></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="checker" style="width:49%" value="<%=exchange.toHtml(register)%>"></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="13%"><%=demo.getLang("erp","登记人编码")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" style="width:49%" name="register_ID" value="<%=exchange.toHtml(register_ID)%>" readonly/></td>
 </tr>
</table>
