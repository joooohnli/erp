...
<link rel="stylesheet" type="text/css" href="<%=url_temp%>javascript/ajax/niceforms-default.css" />
...
<script type='text/javascript' src='<%=url_temp%>javascript/include/nseerTree/nseerReadTableXml.js'></script>
<script type="text/javascript" src='<%=url_temp%>javascript/qcs/config/publics/dealwith.js'></script>
<script type="text/javascript" src='<%=url_temp%>javascript/include/draft_gar/divReconfirm.js'></script>
<script language="javascript" src='<%=url_temp%>javascript/winopen/winopens.js'></script>
<script type="text/javascript" src='<%=url_temp%>javascript/include/div/alert.js'></script>
<script language="javascript">
...
<iframe id="ifra_head" style="filter:alpha(opacity=50);position:absolute;width:expression(this.nextSibling.offsetWidth);height:50px;top:expression(this.nextSibling.offsetTop);left:expression(this.nextSibling.offsetLeft);" frameborder="0" ></iframe>
...
<div  id="LoadProcess_head" style="position:absolute; left:40%; top:111px; width:280px; height:50px; z-index:1;z-index:11;"> 
  <div align=center style="color:#000000;border:0px solid #ffffff;height:50px;padding:5px 0px 0px 0px" id="id2"></div>
</div>
<%
}catch(Exception ex){}
%>
