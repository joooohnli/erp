...
while(rs1.next()){
	if(n.D(rs1.getString("file_path")).indexOf("config")==-1&&!n.D(rs1.getString("hreflink")).equals("")){
String file_path=n.D(rs1.getString("file_path"));
String href_link=n.D(rs1.getString("hreflink"));
