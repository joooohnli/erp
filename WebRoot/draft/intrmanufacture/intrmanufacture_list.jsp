...
nseer_grid.column_width=[40,180,180,100,100,100,160,70];
...
'<div style="text-decoration : underline;color:#3366FF" onclick=id_link("intrmanufacture.jsp?intrmanufacture_ID=<%=rs.getString("intrmanufacture_ID")%>")><%=demo.getLang("erp","重新登记")%></div>'
<%}else{%>
'<div style="text-decoration : underline;color:#3366FF" onclick=id_link("intrmanufacture.jsp?intrmanufacture_ID=<%=rs.getString("intrmanufacture_ID")%>")><%=demo.getLang("erp","继续登记")%></div>'
<%}%>
],
<%
k++;
