...
if(vt.validata((String)session.getAttribute("unit_db_name"),"intrmanufacture_product_providers_recommend","product_providers_recommend_ID",product_providers_recommend_ID,"check_tag").equals("5")||vt.validata((String)session.getAttribute("unit_db_name"),"intrmanufacture_product_providers_recommend","product_providers_recommend_ID",product_providers_recommend_ID,"check_tag").equals("9")){
try{
	String sqll = "select * from intrmanufacture_product_providers_recommend where product_providers_recommend_ID='"+product_providers_recommend_ID+"'" ;
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDsend("'mutiValidation','../../draft_intrmanufacture_productProviders_draft_ok','../../xml/intrmanufacture/intrmanufacture_product_providers_recommend.xml'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交审核")%>" onClick="sendOk('mutiValidation','../../draft_intrmanufacture_productProviders_check_ok?product_providers_recommend_ID=<%=rs.getString("product_providers_recommend_ID")%>','../../xml/intrmanufacture/intrmanufacture_product_providers_recommend.xml');">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="winopen('productProviders_provider_list.jsp')" value="<%=demo.getLang("erp","新添加")%>"> 
  <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="delSelect()" value="<%=demo.getLang("erp","新删除")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick=location="productProviders_list.jsp"></div>
 </td>
 </tr>
</table>
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><input name="product_providers_recommend_ID"  
     type="hidden" value="<%=rs.getString("product_providers_recommend_ID")%>"><%=rs.getString("product_providers_recommend_ID")%></td>
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="../../intrmanufacture/file/query.jsp?provider_ID=<%=rs6.getString("provider_ID")%>"><%=rs6.getString("provider_ID")%></a>
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="productProviders_delete_details.jsp?id=<%=rs6.getString("id")%>&&product_providers_recommend_ID=<%=product_providers_recommend_ID%>"><%=demo.getLang("erp","删除")%></a></td>
<%
}else{
%>
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="register" value="<%=exchange.toHtml(register)%>"><input type="hidden" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="register_id" value="<%=exchange.toHtml(register_id)%>"></td>
