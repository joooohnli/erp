...
nseer_grid.column_width=[40,180,180,100,100,160,70];
...
'<div style="text-decoration : underline;color:#3366FF" onclick=id_link("productProviders.jsp?product_providers_recommend_ID=<%=rs.getString("product_providers_recommend_ID")%>")><%=demo.getLang("erp","重新登记")%></div>'
<%}else{%>
'<div style="text-decoration : underline;color:#3366FF" onclick=id_link("productProviders.jsp?product_providers_recommend_ID=<%=rs.getString("product_providers_recommend_ID")%>")><%=demo.getLang("erp","继续登记")%></div>'
<%}%>
],
<%
k++;
