...
String temp=tablename.split("_")[1].replace("details","file")+"_attachments";
...
String abfile=path+"intrmanufacture\\"+temp+"\\"+filename1;
...
mod=mod.replace("query",tablename.split("_")[1]);
