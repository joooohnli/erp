...
deleteButton8.setAttribute("type", "text");

deleteButton8.setAttribute("name", "provider_web");

deleteButton8.setAttribute("value", provider_web);

deleteButton8.setAttribute("onFocus","this.blur()");

deleteButton8.setAttribute("class","INPUT_STYLE4");
...
nseer_grid.column_width=[200,200,100,150,100,70];
