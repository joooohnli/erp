...
String module_design_ID="";
	String sql0="update manufacture_design_procedure_details set design_module_tag='0' where design_ID='"+design_ID+"' and procedure_name='"+procedure_name+"'";
...
<form id="register_module_again" method="POST" action="designModule_module_reconfirm.jsp">
...
<table <%=TABLE_STYLE5%> class="TABLE_STYLE5">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="9%"><%=demo.getLang("erp","设计数量")%> </td>
	 <td <%=TD_STYLE2%> class="TD_STYLE2" width="9%"><%=demo.getLang("erp","可用数量")%></td>
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input name="product_ID" type="hidden" value="<%=rs6.getString("product_ID")%>"><%=rs6.getString("product_ID")%>&nbsp;</td>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><input name="type" type="hidden" value="<%=exchange.toHtml(rs6.getString("type"))%>"><input name="product_describe" type="hidden" value="<%=rs6.getString("product_describe")%>"><%=rs6.getString("product_describe")%>&nbsp;</td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE5%> class="INPUT_STYLE5" name="using_amount"></td>
 </tr>
<%
	i++;
	}
