...
<form id="register1" method="POST" action="designModule_module_again_list.jsp">
...
<input name="product_ID" type="hidden" value="<%=product_ID%>">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3">
  ...
  <input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","确认")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back()"></div></td>
 </tr>
 </table>
 <table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><font color="red"><%=demo.getLang("erp","重新设计将首先清除原有本工序物料的设计，您确认进行重新设计吗？")%></font></td>
 </tr>
 </table>
...
<table <%=TABLE_STYLE5%> class="TABLE_STYLE5" id=theObjTable>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="17%"><%=demo.getLang("erp","描述")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="9%"><%=demo.getLang("erp","用途类型")%> </td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="9%"><%=demo.getLang("erp","本工序数量")%></td>
...
<%
	String sql1="select * from manufacture_design_procedure_module_details where design_ID='"+design_ID+"' and procedure_name='"+procedure_name+"'";
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=rs1.getString("subtotal")%></td>
 </tr>
