...
<%}%>
 ...
 <form id="change2" method="POST" action="../../draft_manufacture_designModule_module_ok" onsubmit="return doValidate('../../xml/manufacture/manufacture_design_procedure.xml','change2')">
