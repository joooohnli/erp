...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8"><%=DgButton.getDsend("'mutiValidation','../../draft_manufacture_designProcedure_draft_ok'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交审核")%>" onClick="sendOk('mutiValidation','../../draft_manufacture_designProcedure_check_ok?design_ID=<%=design_ID%>');">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="winopen('designProcedure_procedure_list.jsp')" value="<%=demo.getLang("erp","添加新工序")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="delSelect()" value="<%=demo.getLang("erp","删除新工序")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onClick=location="designProcedure_list.jsp" value="<%=demo.getLang("erp","返回")%>"></td> 
 </tr>
 </table>	
<%
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input <%=INPUT_STYLE5%> class="INPUT_STYLE5" name="labour_hour_amount<%=i%>" type="text" value="<%=demo.qformat(rs6.getDouble("labour_hour_amount"))%>"></td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="designProcedure_delete_details.jsp?id=<%=rs6.getString("id")%>&&procedure_id=<%=rs.getString("id")%>&&design_ID=<%=rs.getString("design_ID")%>"><%=demo.getLang("erp","删除")%></a></td>
 </tr>
<%
	i++;
	}
...
<input name="procedure_amount" type="hidden" value="<%=i-1%>">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="procedure_name" type="text"></td>
