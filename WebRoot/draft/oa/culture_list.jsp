...
String nickName="企业文化管理";
String fileName="culture_list.jsp";
String rowSummary=demo.getLang("erp","符合条件的企业文化草稿总数");
int k=1;
%>
...
'<div style="text-decoration : underline;color:#3366FF" onclick=id_link("culture.jsp?culture_ID=<%=rs.getString("culture_ID")%>")><%=demo.getLang("erp","重新制定")%></div>'
<%}else{%>
'<div style="text-decoration : underline;color:#3366FF" onclick=id_link("culture.jsp?culture_ID=<%=rs.getString("culture_ID")%>")><%=demo.getLang("erp","继续制定")%></div>'
<%}%>
],
<%
k++;
