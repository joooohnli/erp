...
String sql="select * from oa_regulation where regulation_ID='"+regulation_ID+"' and (check_tag='5' or check_tag='9')";
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDsend("'mutiValidation','../../draft_oa_regulation_draft_ok?regulation_ID="+regulation_ID+"&"+Globals.TOKEN_KEY+"="+session.getAttribute(Globals.TOKEN_KEY)+"','../../xml/oa/oa_regulation.xml'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交审核")%>" onClick="sendOk('mutiValidation','../../draft_oa_regulation_check_ok?regulation_ID=<%=regulation_ID%>&<%=Globals.TOKEN_KEY%>=<%=session.getAttribute(Globals.TOKEN_KEY)%>','../../xml/oa/oa_regulation.xml');">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back();" /></div></td>
</tr>
</table>
...
<%=isPrint.hasOrNot3d(rs.getString("attachment1"),"附件1&nbsp;&nbsp;&nbsp;","1",response,TR_STYLE1,TD_STYLE1,TD_STYLE2,FILE_STYLE1,rs.getString("id"),"oa_regulation")%>
<%=isPrint.hasOrNot3d(rs.getString("attachment2"),"附件2&nbsp;&nbsp;&nbsp;","2",response,TR_STYLE1,TD_STYLE1,TD_STYLE2,FILE_STYLE1,rs.getString("id"),"oa_regulation")%>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick=location="regulation_list.jsp"></div>
 </td>
 </tr>
</table>
<table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
