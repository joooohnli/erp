...
if(vt.validata((String)session.getAttribute("unit_db_name"),"purchase_contact","contact_ID",contact_ID,"check_tag").equals("9")||vt.validata((String)session.getAttribute("unit_db_name"),"purchase_contact","contact_ID",contact_ID,"check_tag").equals("5")){
try{
...
<form id="mutiValidation" method="POST" action="../../purchase_contact_uncheck_ok?contact_ID=<%=rss.getString("contact_ID")%>" onSubmit="return doValidate('mutiValidation')">
 <table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3">
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDsend("'mutiValidation','../../draft_purchase_contact_draft_ok?contact_ID="+contact_ID+"','../../xml/purchase/purchase_contact.xml'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交审核")%>" onClick="sendOk('mutiValidation','../../draft_purchase_contact_check_ok?contact_ID=<%=rss.getString("contact_ID")%>','../../xml/purchase/purchase_contact.xml');">&nbsp;
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 ...
 <input type="hidden" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="checker_ID" value="<%=checker_ID%>" readonly/>
 </tr>
</table>
