...
String fileName="discussion_product_list.jsp";
...
function addGoodsItem(product_IDa,product_namea,  product_describea, amounta, amount_unita,list_pricea,cost_pricea,real_cost_pricea, typea) {
	...
	var values=[product_IDa,product_name,  describe, describe, amounta, amount_unit,list_pricea,cost_pricea,real_cost_pricea, type];
...
['<%=rs1.getString("product_ID")%>','<%=exchange.toHtml(rs1.getString("product_name"))%>','<%=exchange.toHtml(rs1.getString("type"))%>','<%=rs1.getString("amount_unit")%>','<%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs1.getDouble("list_price"))%>','<div style="text-decoration : underline;color:#3366FF" onclick=addGoodsItem("<%=rs1.getString("product_ID")%>","<%=exchange.unHtmls(exchange.toHtml(rs1.getString("product_name")))%>","<%=exchange.unHtmls(rs1.getString("product_describe"))%>","1","<%=exchange.unHtmls(exchange.toHtml(rs1.getString("amount_unit")))%>","<%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs1.getDouble("list_price"))%>","<%=rs1.getDouble("cost_price")%>","<%=rs1.getDouble("real_cost_price")%>","<%=exchange.unHtmls(exchange.toHtml(rs1.getString("type")))%>")><%=demo.getLang("erp","报价")%></div>'],
</page:pages>
['']];
/*************************************************************/
nseer_grid.init();
