...
String sql8="select * from purchase_purchasing where purchase_ID='"+purchase_ID+"' and check_tag='0'";
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDsend("'mutiValidation','../../draft_purchase_invoice_draft_ok','../../xml/purchase/purchase_purchasing.xml'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交审核")%>" onClick="sendOk('mutiValidation','../../draft_purchase_invoice_check_ok?purchase_ID=<%=rs7.getString("purchase_ID")%>&invoice_time=<%=rs7.getString("invoice_time")%>','../../xml/purchase/purchase_purchasing.xml');">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back()"></div></td>
 </tr>
 </table>
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input name="register_time" type="hidden" style="width: 50%; " value="<%=exchange.toHtml(time)%>"><%=exchange.toHtml(time)%>&nbsp;<input name="register_id" type="hidden" style="width: 50%; " value="<%=exchange.toHtml(register_id)%>"></td>
	</tr>
 </table>
