...
<script type="text/javascript" src="../../javascript/draft/qcs/intrmanufacture.js"></script>
...
try{
	String sql = "select id,apply_id,product_id,product_name,qcs_amount,qcs_time,quality_way,quality_solution,sampling_standard,sampling_amount,accept,reject,qualified,unqualified,register,register_time,qcs_result,attachment1,remark from qcs_intrmanufacture where qcs_id='"+qcs_id+"' and (check_tag='5' or check_tag='9')";
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE1%> class="TD_STYLE8"><%=DgButton.getDsend("'mutiValidation','../../draft_qcs_intrmanufacture_draft_ok','../../xml/qcs/qcs_intrmanufacture.xml'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交审核")%>" onClick="sendOk('mutiValidation','../../draft_qcs_intrmanufacture_check_ok','../../xml/qcs/qcs_intrmanufacture.xml');">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back();" /></td>
 </tr>
 </table>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="changer" name="changer" type="hidden" width="37%" value="<%=changer%>" readonly />
<input id="changer_id" name="changer_id" type="hidden" value="<%=changer_id%>" readonly />
<input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="change_time" name="change_time" type="hidden" width="37%" value="<%=time%>" readonly />
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
