...
<script type="text/javascript" src="../../javascript/draft/qcs/manufactureProcedure.js"></script>
<script type="text/javascript" src="../../javascript/calendar/cal.js"></script>
<link rel="stylesheet" type="text/css" href="../../css/qcs/manufactureProcedure/manufactureProcedure.css" />
...
try{
	String sql = "select id,apply_id,product_id,product_name,qcs_amount,qcs_time,procedure_name,quality_solution,sampling_standard,sampling_amount,qualified,unqualified,register,register_time,qcs_result,attachment1,remark,accept,reject,manufacture_id from qcs_manufacture_procedure where qcs_id='"+qcs_id+"' and (check_tag='5' or check_tag='9')";
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE1%> class="TD_STYLE8"><%=DgButton.getDsend("'mutiValidation','../../draft_qcs_manufactureProcedure_draft_ok','../../xml/qcs/qcs_manufacture_procedure.xml'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交审核")%>" onClick="sendOk('mutiValidation','../../draft_qcs_manufactureProcedure_check_ok','../../xml/qcs/qcs_manufacture_procedure.xml');">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back();" /></td>
 </tr>
 </table>
...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="procedure_name" name="procedure_name" type="text" width="37%" value="<%=procedure_name%>"  onclick="loadAjaxDiv('procedure_name','<%=procedure_name%>');this.blur();" readonly /><div class="select_div_l" id="procedure_name_div"  onclick="loadAjaxDiv('procedure_name','<%=procedure_name%>')"></td>
