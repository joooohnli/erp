...
<script type="text/javascript" src="../../javascript/draft/qcs/sample.js"></script>
...
try{
	String sql = "select id,quality_type,apply_id,sampling_person,sampling_time,register,register_time,attachment1,remark from qcs_sample where sample_id='"+sample_id+"' and check_tag='5' or check_tag='9'";
...
form.action = "../../qcs_sample_uncheck_ok";
form.submit();
}
</script>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE1%> class="TD_STYLE8"><%=DgButton.getDsend("'mutiValidation','../../draft_qcs_sample_draft_ok','../../xml/qcs/qcs_sample.xml'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交审核")%>" onClick="sendOk('mutiValidation','../../draft_qcs_sample_check_ok','../../xml/qcs/qcs_sample.xml');">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back();" /></td>
 </tr>
 </table>
