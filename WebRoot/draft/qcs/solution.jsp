...
<script language="javascript" src="../../javascript/draft/qcs/solution.js"></script>
<% 
...
<div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDsend("'mutiValidation','../../draft_qcs_solution_draft_ok','../../xml/qcs/qcs_solution.xml'",request)%><%=DgButton.getGsend("'mutiValidation','../../draft_qcs_solution_garbage_ok','../../xml/qcs/qcs_solution.xml'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交审核")%>" onClick="sendOk('mutiValidation','../../draft_qcs_solution_check_ok','../../xml/qcs/qcs_solution.xml');">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" id="del_button" onclick="deleteSelect('bill_body')" value=<%=demo.getLang("erp","删除")%>>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onClick="history.back()" value=<%=demo.getLang("erp","返回")%>></div></td>
</tr>
</table>
