...
+ createAddQueryString(product_name, product_ID, product_describe, amount, amount_unit, cost_price, "add") 
...
//*********************************************
function createAddQueryString(product_name, product_ID, product_describe, amount, amount_unit, cost_price, action) {
...
String fileName="applyPay_product_list.jsp";
