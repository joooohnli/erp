 ...
 *version 2 of the License, or (at your option) any later version.
 -->
<%@page contentType="text/html; charset=UTF-8" language="java" import="java.sql.*,include.nseer_cookie.*" import="java.util.*" import="java.io.*" import="include.nseer_cookie.*" import ="include.nseer_db.*,java.text.*,include.get_name_from_ID.*"%>
...
//*********************************************
function addGoodsItem(product_namea, product_IDa, product_describea, amount_unita, amounta, cost_pricea) {
...
+ createAddQueryString(product_name, product_ID, product_describe, amount_unit, amount, cost_price, "add") 
...
//*********************************************
function createAddQueryString(product_name, product_ID, product_describe, amount_unit, amount, cost_price, action) {
...
String fileName="transferGather_product_list.jsp";
...
var names=['product_name','product_ID','product_describe1','product_describe','amount_unit','amount','cost_price'];
function addGoodsItem(product_namea, product_IDa, product_describea, amount_unita, amounta, cost_pricea) {
...
var values=[product_name, product_IDa, describe, describe, amount_unit, amounta, cost_pricea];
