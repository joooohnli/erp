...
%>
 ...
 <table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","申请单编号:")%><font color="<%=color%>"><%=rs.getString("gather_ID")%><%=exchange.toHtml(apply_tag)%></font>
 <%=demo.getLang("erp","其中审核状态:")%><font color="<%=color1%>"><%=exchange.toHtml(check_tag)%></font> <%=demo.getLang("erp","借领状态:")%><font color="<%=color2%>"><%=exchange.toHtml(gather_tag)%></font> <%=demo.getLang("erp","归还状态:")%><font color="<%=color3%>"><%=exchange.toHtml(return_tag)%></font></td>
 </tr>
 </table>
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4" id=theObjTable>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" colspan="3" width="89%"><%=rs.getString("gather_ID")%>&nbsp;</td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="10%"><%=demo.getLang("erp","入库人")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><%=exchange.toHtml(rs.getString("gatherer_name"))%>&nbsp;</td>
	 <td <%=TD_STYLE1%> class="TD_STYLE8" width="10%"><%=demo.getLang("erp","入库人编号")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><%=rs.getString("gatherer_ID")%>&nbsp;</td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<%
String sql2="select * from stock_apply_gather_details where gather_ID='"+gather_ID+"' order by details_number";
