...
<form class="x-form" method="post" action="../../stock_cell_check_delete_ok">
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","该配置单未通过审核，您确认吗？请选择处理：")%></td>
 </tr>
 </table>
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
...
<%
int i=1;
String sql6="select config_id from stock_workflow where object_ID='"+design_ID+"' and config_id<'"+config_id+"' order by id";
