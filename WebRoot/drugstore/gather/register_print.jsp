...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4" id=theObjTable>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input name="reasonexact" type="hidden" value="<%=exchange.toHtml(rs.getString("reasonexact"))%>"><%=exchange.toHtml(rs.getString("reasonexact"))%>/<%=exchange.toHtml(rs.getString("reasonexact_details"))%>&nbsp;</td>
 </tr>
</table>
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<TABLE <%=TABLE_STYLE5%> class="TABLE_STYLE5">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="11%"><%=demo.getLang("erp","产品名称")%></td>
	 ...
	 <td <%=TD_STYLE2%> class="TD_STYLE2" width="13%"><%=demo.getLang("erp","存放地址")%></td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="11%"><%=demo.getLang("erp","已入库件数")%></td>
	 <td <%=TD_STYLE2%> class="TD_STYLE2" width="11%"><%=demo.getLang("erp","本次入库数量")%></td>
	 <td <%=TD_STYLE2%> class="TD_STYLE2" width="11%"><%=demo.getLang("erp","序列号")%></td>
	</tr>
<%
	int count=0;
	String sql5="select count(*) from stock_pre_gathering where gather_ID='"+gather_ID+"'";
...
<%}else if(rs6.getString("gather_check_tag").equals("1")&&!rs6.getString("gather_tag").equals("1")){%>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><input <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="amount" type="hidden" value=""><%=demo.getLang("erp","等待审核")%></td>
	 <td <%=TD_STYLE2%> class="TD_STYLE2">&nbsp;</td>
<%}else if(rs6.getString("gather_tag").equals("1")){%>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><input <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="amount" type="hidden" value=""><%=demo.getLang("erp","完成")%></td>
	 <td <%=TD_STYLE2%> class="TD_STYLE2">&nbsp;</td>
<%}%>
 </tr>
<%
