...
if(!rs6.next()&&vt.validata((String)session.getAttribute("unit_db_name"),"ecommerce_comment","comment_ID",comment_ID,"check_tag").equals("0")){
try{
...
%>
<form id="mutiValidation" method="post" action="../../ecommerce_comment_check_ok?config_id=<%=config_id%>&comment_ID=<%=comment_ID%>" onSubmit="return doValidate('../../xml/ecommerce/ecommerce_comment.xml','mutiValidation')" ENCTYPE="multipart/form-data">
...
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="reply"><%=rss.getString("reply")%></textarea>
</td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
	 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","该反馈信息已回复或前面尚有回复流程未完成，请返回！")%></td>
 <td <%=TD_STYLE3%> class="TD_STYLE3">&nbsp;</td>
 </tr>
</table>
 </div>
