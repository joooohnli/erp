...
<script type='text/javascript' src="../../../javascript/ecommerce/config/news/treeBusiness.js"></script>
...
function addTree(){
 ...
 Nseer_tree1.setModuleName('../../../xml/ecommerce/config/news');//xml文件路径
 Nseer_tree1.addRootNode('No0','<%=demo.getLang("erp","全部分类")%>',false,'1',[]);
 Nseer_tree1.setParent('nseer1');
initMyTree(Nseer_tree1);
createButton('../../../xml/ecommerce/config/news','ecommerce_config_news_kind','treeButton');
}
</script>