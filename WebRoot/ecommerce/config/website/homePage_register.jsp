...
<form id="homePageRegister" class="x-form" method="POST" action="../../../ecommerce_config_website_homePage_register_ok" onSubmit="return doValidate('../../../xml/ecommerce/ecommerce_web_template.xml','homePageRegister')" ENCTYPE="multipart/form-data">
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="80%"><input type="hidden" name="register" style="width: 30%"value="<%=exchange.toHtml((String)session.getAttribute("realeditorc"))%>"><input type="hidden" name="register_ID" style="width: 30%"value="<%=(String)session.getAttribute("human_IDD")%>"><%=exchange.toHtml((String)session.getAttribute("realeditorc"))%></td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
