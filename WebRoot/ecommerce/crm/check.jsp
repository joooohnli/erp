...
String sql6="select * from ecommerce_workflow where object_ID='"+customer_ID+"' and check_tag='0' and config_id<'"+config_id+"'";
ResultSet rs9=crmdb.executeQuery(sql6);
if(!rs9.next()&&vt.validata((String)session.getAttribute("unit_db_name"),"crm_file","customer_ID",customer_ID,"excel_tag").equals("1")){
try{
	...
	String opinion=exchange.unHtml(rss.getString("opinion"));
...
form.action = "../../ecommerce_crm_check_ok?config_id=<%=config_id%>&customer_ID=<%=customer_ID%>";
}
}
</script>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%" colspan="3"><input name="customer_ID" style="width:60%" type="hidden" value="<%=rss.getString("customer_ID")%>"><%=rss.getString("customer_ID")%>　&nbsp; 
 &nbsp;&nbsp;&nbsp;&nbsp;</td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="37.4%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="customer_address" style="width:60%" value="<%=exchange.toHtml(rss.getString("customer_address"))%>"></td>
 </tr>
...
%>
 ...
 <select <%=SELECT_STYLE1%> class="SELECT_STYLE1" name="gather_sum_limit" style="width:60%">
  <%
   sql6 = "select * from crm_config_public_double where kind='欠款' order by type_ID" ;
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="used_customer_name" style="width:60%" value="<%=exchange.toHtml(rss.getString("used_customer_name"))%>"></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="customer_account" style="width:60%" value="<%=exchange.toHtml(rss.getString("customer_account"))%>"></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="customer_tel1" style="width:60%" value="<%=exchange.toHtml(rss.getString("customer_tel1"))%>"></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="customer_fax" style="width:60%" value="<%=exchange.toHtml(rss.getString("customer_fax"))%>"></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="contact_person1" style="width:60%" value="<%=exchange.toHtml(rss.getString("contact_person1"))%>"></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="contact_person1_duty" style="width:60%" value="<%=exchange.toHtml(rss.getString("contact_person1_duty"))%>"></td>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="contact_person1_mobile" style="width:60%" value="<%=exchange.toHtml(rss.getString("contact_person1_mobile"))%>"></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="contact_person1_email" style="width:60%" value="<%=exchange.toHtml(rss.getString("contact_person1_email"))%>"></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="contact_person2" style="width:60%" value="<%=exchange.toHtml(rss.getString("contact_person2"))%>"></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","部门")%></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","职务")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="contact_person2_duty" style="width:60%" value="<%=exchange.toHtml(rss.getString("contact_person2_duty"))%>"></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","办公电话")%></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","手机")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="contact_person2_mobile" style="width:60%" value="<%=exchange.toHtml(rss.getString("contact_person2_mobile"))%>"></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","家庭电话")%> </td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","EMAIL")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="contact_person2_email" style="width:60%" value="<%=exchange.toHtml(rss.getString("contact_person2_email"))%>"></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","性别")%></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%" colspan="3"><a href="javascript:winopenm('../../crm/file/query_attachment.jsp?id=<%=rss.getString("id")%>&tablename=crm_file&fieldname=attachment_name')">
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="opinion"><%=opinion%></textarea>
</td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","销售人员编号")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="sales_ID" style="width:60%" value="<%=rss.getString("sales_ID")%>"></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","登记人")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="hidden" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="register" style="width:60%" value="<%=exchange.toHtml(rss.getString("register"))%>"><%=exchange.toHtml(rss.getString("register"))%></td>
 </tr>		
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","审核人")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="checker" style="width:60%" value="<%=exchange.toHtml(checker)%>"></td>
 ...
 <input name="lately_change_time" type="hidden" value="<%=rss.getString("change_time")%>">
