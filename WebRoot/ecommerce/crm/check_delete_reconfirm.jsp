...
%>
<form class="x-form" method="post" action="../../ecommerce_crm_check_delete_ok">
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10"><%=demo.getLang("erp","该客户档案未通过发布审核，您确认吗？请选择处理：")%></td>
  </tr>
 
<%
int i=1;
String sql6="select * from ecommerce_workflow where object_ID='"+customer_ID+"' and config_id<'"+config_id+"' order by id";
