...
try{
	String sql = "select * from ecommerce_workflow where object_ID='"+customer_ID+"' and config_id='"+config_id+"'" ;
...
<table height="30px" <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","伙伴档案编号")%> </td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="89%"><%=rs.getString("object_ID")%>&nbsp;</td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","审核人编号")%> </td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="89%"><%=rs.getString("checker_ID")%>&nbsp;</td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","审核人")%> </td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="89%"><%=exchange.toHtml(rs.getString("checker"))%>&nbsp;</td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","审核时间")%> </td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="89%"><%=exchange.toHtml(rs.getString("check_time"))%>&nbsp;</td>
</tr>
</table>
</div>
<%
