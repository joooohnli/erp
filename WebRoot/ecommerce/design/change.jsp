...
<form id="mutiValidation" method="post" action="../../ecommerce_design_change_ok?product_ID=<%=product_ID%>" onSubmit="return doValidate('../../xml/design/design_file.xml','mutiValidation')">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
try{
	...
	String promotion=exchange.unHtml(rss.getString("promotion"));
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td  <%=TD_STYLE21%> class="TD_STYLE2" width="37.4%"><input name="product_name" style="width:60%" type="hidden" value="<%=rss.getString("product_name")%>"><%=exchange.toHtml(rss.getString("product_name"))%></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input name="list_price" style="width:60%" type="hidden" value="<%=exchange.toHtml(rss.getString("list_price"))%>"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rss.getDouble("list_price"))%></td>
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="promotion"><%=promotion%></textarea>
</td>
