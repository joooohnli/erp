...
<form class="x-form" method="post" action="../../ecommerce_design_check_delete_ok">

<input type="hidden" name="config_id" value="<%=config_id%>">
<input type="hidden" name="product_ID" value="<%=product_ID%>">
<input type="hidden" name="promotion" value="<%=exchange.toHtml(promotion)%>">
...
<%
int i=1;
String sql6="select * from ecommerce_workflow where type_id='01' and object_ID='"+product_ID+"' and config_id<'"+config_id+"' order by id";
