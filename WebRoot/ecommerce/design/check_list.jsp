...
String condition="check_tag='1' and excel_tag!='3' and excel_tag!='9' and type!='物料'";
...
<%
String sql1="select * from ecommerce_workflow where object_ID='"+rs.getString("product_ID")+"' and check_tag='0'";
ResultSet rs2=design_db1.executeQuery(sql1);
if(rs2.next()){
	sql1="select * from ecommerce_workflow where object_ID='"+rs.getString("product_ID")+"' and type_id='01' order by id";
