...
%>
<form id="mutiValidation" method="post" action="../../ecommerce_logistics_change_ok?product_ID=<%=product_ID%>" onSubmit="return doValidate('../../xml/design/design_file.xml','mutiValidation')">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" >
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
try{
	...
	ResultSet rss = design_db1.executeQuery(sqll) ;
	while(rss.next()){
	...
	String promotion4=exchange.unHtml(rss.getString("promotion4"));
	String opinion4=exchange.unHtml(rss.getString("opinion4"));
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td  <%=TD_STYLE21%> class="TD_STYLE2" width="37.4%"><input name="product_name" style="width:60%" type="hidden" value="<%=exchange.toHtml(rss.getString("product_name"))%>"><%=exchange.toHtml(rss.getString("product_name"))%></td>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="product_nick" style="width:60%" value="<%=exchange.toHtml(rss.getString("product_nick"))%>"></td>
</tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","用途类型")%></td>
	 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><%=exchange.toHtml(rss.getString("type"))%></td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input name="list_price" style="width:60%" type="hidden" value="<%=rss.getString("list_price")%>"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rss.getDouble("list_price"))%></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","计划成本单价")%> </td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input name="cost_price"  style="width:60%" type="hidden" value="<%=rss.getString("cost_price")%>"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rss.getDouble("cost_price"))%></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE4%> class="TD_STYLE7" width="11%" height="65"><%=demo.getLang("erp","配送信息")%> &nbsp; </td>
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%" >
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="promotion4"><%=promotion4%></textarea>
</td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input  name="changer" style="width:60%" type="hidden" value="<%=exchange.toHtml(changer)%>"><%=exchange.toHtml(changer)%></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","变更人编号")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="changer_ID" style="width:60%" ></td>
