...
String sql6="select * from ecommerce_workflow where type_id='05' and object_ID='"+product_ID+"' and check_tag='0' and config_id<'"+config_id+"'";
...
form.action = "../../ecommerce_logistics_check_ok?config_id=<%=config_id%>&product_ID=<%=product_ID%>";
}
}
</script>
...
%>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><a href="javascript:winopenm('../../design/file/query_attchment.jsp?id=<%=rss.getString("id")%>&tablename=design_file&fieldname=attachment_name')">
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="opinion4"><%=opinion4%></textarea>
</td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="hidden" name="checker_ID"  value="<%=checker_ID%>"><input type="hidden" name="checker" style="width:60%"  value="<%=exchange.toHtml(checker)%>"><%=exchange.toHtml(checker)%></td>
