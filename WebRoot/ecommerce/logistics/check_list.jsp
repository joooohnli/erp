...
String condition="check_tag='1' and excel_tag4!='3' and excel_tag4!='9' and type!='物料' and type!='服务型产品'";
...
<%
String sql1="select * from ecommerce_workflow where object_ID='"+rs.getString("product_ID")+"' and check_tag='0' and type_id='05'";
ResultSet rs2=design_db.executeQuery(sql1);
if(rs2.next()){
	sql1="select * from ecommerce_workflow where object_ID='"+rs.getString("product_ID")+"' and type_id='05' order by id";
	rs2=design_db.executeQuery(sql1);
%>
