...
<form class="x-form" method="post" action="../../ecommerce_news_check_delete_ok">
<%
...
<input type="hidden" name="check_time" value="<%=exchange.toHtml(check_time)%>">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2" width="100%">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10"><%=demo.getLang("erp","该新闻未通过发布审核，您确认吗？请选择处理：")%></td>
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10">&nbsp;</td>
 </tr>
<%
int i=1;
String sql6="select config_id from ecommerce_workflow where object_ID='"+news_ID+"' and config_id<'"+config_ID+"' order by id";
