...
try{
	String sql = "select * from ecommerce_workflow where object_id='"+news_ID+"' and config_id='"+config_id+"'" ;
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","新闻编号")%> </td>
