...
<form id="mutiValidation" method="POST" action="../../ecommerce_news_register_ok" onSubmit="return doValidate('../../xml/ecommerce/ecommerce_news.xml','mutiValidation')" ENCTYPE="multipart/form-data">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDraft("'mutiValidation','../../ecommerce_news_register_draft_ok','../../xml/ecommerce/ecommerce_news.xml'",request)%>&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","提交")%>"></div></td>
</tr>
</table>
<%
...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="topic"></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="13%"><%=demo.getLang("erp","新闻分类")%>：</td>
  <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input type="text" id="filekind_chain" <%=INPUT_STYLE3%> class="INPUT_STYLE3" style="width:80%" name="filekind_chain" onFocus="showKind('nseer1',this,showTree)" onkeyup="search_suggest(this.id)" autocomplete="off"><input id="filekind_chain_table" type="hidden" value="ecommerce_config_news_kind"></td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
