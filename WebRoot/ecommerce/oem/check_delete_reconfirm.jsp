...
String opinion3=request.getParameter("3");
...
<form class="x-form" method="post" action="../../ecommerce_intrmanufacture_check_delete_ok">
<input type="hidden" name="config_id" value="<%=config_id%>">
<input type="hidden" name="product_ID" value="<%=product_ID%>">
<input type="hidden" name="promotion3" value="<%=promotion3%>">
<input type="hidden" name="opinion3" value="<%=opinion3%>">
...
<%
int i=1;
String sql6="select * from ecommerce_workflow where type_id='04' and object_ID='"+product_ID+"' and config_id<'"+config_id+"' order by id";
