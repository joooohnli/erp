...
if(vt.validata((String)session.getAttribute("unit_db_name"),"ecommerce_other","other_ID",other_ID,"excel_tag").equals("3")){
try{
...
<form id="mutiValidation" method="post" action="../../ecommerce_other_change_ok?other_ID=<%=other_ID%>" onSubmit="return doValidate('../../xml/ecommerce/ecommerce_other.xml','mutiValidation')" ENCTYPE="multipart/form-data">
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input name="other_ID" type="hidden" value="<%=rss.getString("other_ID")%>"><%=rss.getString("topic")%>&nbsp;</td>
