...
<div id="nseerGround" class="nseerGround">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" style="width: 50; " onClick=location="change.jsp?other_ID=<%=other_ID%>"></div></td>
 </tr>
 </table>
</div>
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
