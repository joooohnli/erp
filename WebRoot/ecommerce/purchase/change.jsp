...
%>
<form id="mutiValidation" method="post" action="../../ecommerce_purchase_change_ok?product_ID=<%=product_ID%>" onSubmit="return doValidate('../../xml/design/design_file.xml','mutiValidation')">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
try{
	...
	String promotion2=exchange.unHtml(rss.getString("promotion2"));
	String opinion2=exchange.unHtml(rss.getString("opinion2"));
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%" >
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="promotion2"><%=promotion2%></textarea>
</td>
