...
String sql6="select * from ecommerce_workflow where type_id='03' and object_ID='"+product_ID+"' and check_tag='0' and config_id<'"+config_id+"'";
...
form.action = "../../ecommerce_purchase_check_ok?config_id=<%=config_id%>&product_ID=<%=product_ID%>";
}
}
</script>
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="opinion2"><%=opinion2%></textarea>
</td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
