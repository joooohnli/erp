...
String condition="check_tag='1' and excel_tag2!='3' and excel_tag2!='9' and (type='物料' or type='外购商品')";
...
<%
String sql1="select * from ecommerce_workflow where object_ID='"+rs.getString("product_ID")+"' and check_tag='0' and type_id='03'";
ResultSet rs2=design_db.executeQuery(sql1);
if(rs2.next()){
	sql1="select * from ecommerce_workflow where object_ID='"+rs.getString("product_ID")+"' and type_id='03' order by id";
