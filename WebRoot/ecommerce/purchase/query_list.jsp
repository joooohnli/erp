...
String condition="check_tag='1' and excel_tag2='3' and type='物料'||type='外购商品'";
...
String sql="select count(id) from ecommerce_config_workflow where type_id='03'";
...
<%
String sql1="select * from ecommerce_workflow where object_ID='"+rs.getString("product_ID")+"' and type_id='03'";
