...
<div id="nseerGround" class="nseerGround">
  <form name="selectList" id="keyRegister" class="x-form" method="POST" action="../../ecommerce_website_column_ok">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
String sql="select * from ecommerce_colsa where unit_id='"+unit_id+"'";
...
<input type="hidden" name="unit_id" value="<%=unit_id%>"> 
 <table <%=TABLE_STYLE1%> class="TABLE_STYLE1"  id=theObjTable>
  <tr <%=TR_STYLE1%> class="TR_STYLE1">
  <td <%=TD_STYLE11%> class="TD_STYLE1" width="25%" colspan=4><%=demo.getLang("erp","请选择栏目")%>&nbsp;&nbsp;<INPUT onclick=selAll(this.form) type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","全选")%>" name=check>
&nbsp;</td> 
 </tr>
<% 
int n=0;
String sql1="select * from ecommerce_config_cols_first where list_tag='1' order by first_kind_ID";
