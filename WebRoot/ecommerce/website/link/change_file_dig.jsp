...
try{
	String sql = "select * from ecommerce_link_dig where link_ID='"+link_ID+"' and change_time='"+change_time+"'" ;
...
<table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
 ...
 <td <%=TD_HANDBOOK_STYLE1%> class="TD_HANDBOOK_STYLE1"><div class="div_handbook"><%=handbook%></div><font color="red"><%=demo.getLang("erp","(历史数据)")%></td>
 </tr>
</table>
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","关闭")%>" onClick="window.close();"></div></td>
 </tr>
</table>
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
