...
String sql9="select * from ecommerce_workflow where object_ID='"+link_ID+"' and check_tag='0' and config_ID<'"+config_ID+"'";
...
form.action = "check_delete_reconfirm.jsp?config_ID=<%=config_ID%>&link_ID=<%=rss.getString("link_ID")%>";
}else{
form.action = "../../../ecommerce_website_link_check_ok?config_ID=<%=config_ID%>&link_ID=<%=rss.getString("link_ID")%>";
}
}
</script>
...
<form id="mutiValidation" method="post" onSubmit="return doValidate('../../../xml/ecommerce/ecommerce_link.xml','mutiValidation')&&TwoSubmit(this)" ENCTYPE="multipart/form-data">
