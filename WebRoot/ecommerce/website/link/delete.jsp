...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><font color="red"><%=demo.getLang("erp","您确认删除该链接吗?")%></font>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","确认")%>" onClick=location="../../../ecommerce_website_link_delete_ok?link_ID=<%=link_ID%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back();"></div></td>
 </tr>
</table>
...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="87%" colspan="3"><%=exchange.toHtml(rs.getString("opinion"))%></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
