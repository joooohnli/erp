...
try{
	String sql = "select * from ecommerce_workflow where object_ID='"+link_ID+"' and config_id='"+config_id+"'" ;
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","链接编号")%> </td>
