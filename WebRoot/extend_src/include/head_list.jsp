...
String msg_path1=request.getRequestURI();
String mod_name=msg_path1.split("/")[2];
String file_url1=request.getRequestURI();
for(int i=0;i<file_url1.split("/").length-3;i++){
	url_temp1+="../";
}
%>
<head>
<%@ taglib uri="http://www.nseer.com/tag" prefix="app" %>
<app:checkLogon database="<%=mod_name%>"/>
<style>
.nseerGround{
	position:absolute;
	left:1%;
