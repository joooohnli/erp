...
double debit_year_amount=0.0d;
double loan_year_amount=0.0d;
double last_balance_amount=0.0d;
double current_balance_amount=0.0d;
double daily_balance_amount=0.0d;
double daily_debit_amount=0.0d;
double daily_loan_amount=0.0d;
double month_debit_amount=0.0d;
double month_loan_amount=0.0d;
int day_control=0;
int month_day_control=0;
if(file_id!=null&&Integer.parseInt(timeb)>=Integer.parseInt(timea)){
	String sql="select debit_or_loan,corr_stock_tag from finance_config_file_kind where file_ID='"+file_id+"'";
	ResultSet rs=finance_db.executeQuery(sql);
	if(rs.next()){
		debit_or_loan=rs.getString("debit_or_loan");
		corr_stock_tag=rs.getString("corr_stock_tag");
	}
	sql="select debit_year_sum,loan_year_sum,current_balance_sum,debit_year_amount,loan_year_amount,current_balance_amount from finance_gl where file_ID='"+file_id+"' and account_period='1'";
	...
	if(rs.next()){
			...
			debit_year_amount=rs.getDouble("debit_year_amount");
			loan_year_amount=rs.getDouble("loan_year_amount");
			last_balance_amount=rs.getDouble("current_balance_amount");
	}
	...
	sql="select debit_subtotal,loan_subtotal,product_amount from finance_voucher where chain_ID like '"+file_id+"%' and check_tag='1' and account_tag='1' and register_time<'"+start_time+"' order by register_time,voucher_in_month_ID";
	rs=finance_db.executeQuery(sql);
	while(rs.next()){
		if(debit_or_loan.equals("借")){
			...
			if(rs.getDouble("debit_subtotal")!=0){
				debit_year_amount+=rs.getDouble("product_amount");
				last_balance_amount=last_balance_amount+rs.getDouble("product_amount");
			}else{
				loan_year_amount+=rs.getDouble("product_amount");
				last_balance_amount=last_balance_amount-rs.getDouble("product_amount");
			}
		}else{
			debit_year_sum+=rs.getDouble("debit_subtotal");
	...
	current_balance_amount=last_balance_amount;
%>
...
function show(option){
	...
	if(a=='0'){
		...
		document.getElementById('haveAmount').style.display='none';
	}else{
		document.getElementById('noAmount').style.display='none';
		document.getElementById('haveAmount').style.display='block';
	}
}
</script>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><select id="if_amount" onChange="show(this)">
 <option value="0" selected><%=demo.getLang("erp","金额式")%></option>
 <%if(corr_stock_tag.equals("是")){
	  %>
 <option value="1"><%=demo.getLang("erp","数量金额式")%></option>
 <%}%>
 </select>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick=location="details_locate.jsp"></div></td>
 </tr>
 </table>
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<div id="noAmount" style="display:block;">
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td align="center"><font size="4"><b><%=file_name%><%=demo.getLang("erp","明细账")%></b></font></td>
 </tr>
 </table>
...
<div id="haveAmount" style="display:none">
<%@include file="../include/paper_top1.html"%>
...
<table <%=TABLE_STYLE5%> class="TABLE_STYLE5" id=theObjTable>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" rowspan="2" width="60"><font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font><%=demo.getLang("erp","凭证号")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" rowspan="2" width="180"><font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font><%=demo.getLang("erp","摘要")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" rowspan="2" width="120"><font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font><%=demo.getLang("erp","单价")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" colspan="2" width="200"><font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font><%=demo.getLang("erp","借方")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" colspan="2" width="200"><font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font><%=demo.getLang("erp","贷方")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" rowspan="2" width="18"><font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font><%=demo.getLang("erp","方向")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" colspan="3" width="300"><font class="resizeDivClass" onmousedown="MouseDownToResize(this);" onmousemove="MouseMoveToResize(this);" onmouseup="MouseUpToResize(this);"></font><%=demo.getLang("erp","余额")%></td>
 </tr>
 <tr <%=TR_STYLE2%> class="TR_STYLE2">
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="25"><%=demo.getLang("erp","月")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="25"><%=demo.getLang("erp","日")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="100"><%=demo.getLang("erp","数量")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="100"><%=demo.getLang("erp","金额")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="100"><%=demo.getLang("erp","数量")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="100"><%=demo.getLang("erp","金额")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="100"><%=demo.getLang("erp","数量")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="100"><%=demo.getLang("erp","单价")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="100"><%=demo.getLang("erp","金额")%></td>
 </tr>
<%
if(last_balance_sum!=0){	
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <%if(debit_or_loan.equals("借")){
	if(last_balance_sum>0){%>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","借")%></td> 
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(last_balance_amount)%></td>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(Math.abs(last_balance_sum/last_balance_amount))%></td>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(last_balance_sum)%></td>
 <%}else if(last_balance_sum<0){%>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","贷")%></td>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(last_balance_amount)%></td>
...
<%}
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=rs.getString("voucher_in_month_ID")%>&nbsp;</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=exchange.toHtml(rs.getString("summary"))%>&nbsp;</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=rs.getString("product_price")%>&nbsp;</td>
 <%if(rs.getDouble("debit_subtotal")!=0){
	if(debit_or_loan.equals("借")){
		current_balance_sum+=rs.getDouble("debit_subtotal");
		current_balance_amount+=rs.getDouble("product_amount");
	}else{
		current_balance_sum=current_balance_sum-rs.getDouble("debit_subtotal");
		current_balance_amount=current_balance_amount-rs.getDouble("product_amount");
	}
	daily_debit_sum+=rs.getDouble("debit_subtotal");
	month_debit_sum+=rs.getDouble("debit_subtotal");
	debit_year_sum+=rs.getDouble("debit_subtotal");
	month_debit_amount+=rs.getDouble("product_amount");
	debit_year_amount+=rs.getDouble("product_amount");
	%>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs.getDouble("product_amount"))%>&nbsp;</td>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs.getDouble("debit_subtotal"))%>&nbsp;</td> 
 <td <%=TD_STYLE2%> class="TD_STYLE2">&nbsp;</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2">&nbsp;</td>
<%
	...
	month_loan_sum+=rs.getDouble("loan_subtotal");
	loan_year_sum+=rs.getDouble("loan_subtotal");
	month_loan_amount+=rs.getDouble("product_amount");
	loan_year_amount+=rs.getDouble("product_amount");
%>
 <td <%=TD_STYLE2%> class="TD_STYLE2">&nbsp;</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2">&nbsp;</td>
 ...
 <%if(debit_or_loan.equals("借")){
	if(current_balance_sum>0){%>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","借")%></td>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(current_balance_amount)%></td>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(Math.abs(current_balance_sum/current_balance_amount))%></td>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(current_balance_sum)%></td>
 <%}else if(current_balance_sum<0){%>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","贷")%></td>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(current_balance_amount)%></td>
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","本月合计")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2">&nbsp;</td>
 <%if(month_debit_amount!=0){%>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(month_debit_amount)%>&nbsp;</td>
 <%}else{%>
 <td <%=TD_STYLE6%> class="TD_STYLE6">&nbsp;</td>
 <%}if(month_debit_sum!=0){%>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(month_debit_sum)%>&nbsp;</td>
 <%}else{%>
 <td <%=TD_STYLE6%> class="TD_STYLE6">&nbsp;</td>
 <%}if(month_loan_amount!=0){%>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(month_loan_amount)%>&nbsp;</td>
 <%}else{%>
 <td <%=TD_STYLE6%> class="TD_STYLE6">&nbsp;</td>
 <%}if(month_loan_sum!=0){%>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(month_loan_sum)%>&nbsp;</td>
...
if(current_balance_sum>0){%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","本年累计")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2">&nbsp;</td>
 <%if(debit_year_amount!=0){%>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(debit_year_amount)%>&nbsp;</td>
 <%}else{%>
 <td <%=TD_STYLE6%> class="TD_STYLE6">&nbsp;</td>
 <%}if(debit_year_sum!=0){%>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(debit_year_sum)%>&nbsp;</td>
 <%}else{%>
 <td <%=TD_STYLE6%> class="TD_STYLE6">&nbsp;</td>
 <%}if(loan_year_amount!=0){%>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(loan_year_amount)%>&nbsp;</td>
 <%}else{%>
 <td <%=TD_STYLE6%> class="TD_STYLE6">&nbsp;</td>
 <%}if(loan_year_sum!=0){%>
 <td <%=TD_STYLE6%> class="TD_STYLE6"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(loan_year_sum)%>&nbsp;</td>
...
<%@include file="../include/paper_bottom1.html"%>
</div>
<%
finance_db.close();
%>
...
<div id="nseerGround" class="nseerGround">
 <table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE1"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick=location="details_locate.jsp"></div></td>
 </tr>
 </table>
 <table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","请正确选择会计期间！")%></td>
 </tr>
 </table>
</div>
<%}
