...
<form id="timeLocateValidation" class="x-form" method="post" action="multi_locate_getpara.jsp">
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1"> 
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="20%"><%=demo.getLang("erp","请选择多栏账")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="80%"><select <%=SELECT_STYLE1%> class="SELECT_STYLE1" name="select1" style="width: 60%;">
<%
String sql = "select category_name from finance_config_file_kind where details_tag='1' order by file_ID" ;
