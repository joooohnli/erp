...
<%
String sql="delete from finance_account_period";
finance_db.executeUpdate(sql);
sql="delete from finance_config_public_char where kind='账务初始时间'";
finance_db.executeUpdate(sql);
sql="delete from finance_gl";
finance_db.executeUpdate(sql);
response.sendRedirect("registerTime.jsp");
%>