...
<!--目录不同-->
<script type='text/javascript' src="../../../javascript/finance/config/fixed_assets/fa_subject/treeBusiness.js"></script>
...
function addTree(){
 ...
 Nseer_tree1.setModuleName('../../../xml/finance/config/fixed_assets/fa_subject');//xml文件路径
 Nseer_tree1.addRootNode('No0','<%=demo.getLang("erp","全部分类")%>',false,'1',[]);
 Nseer_tree1.setParent('nseer1');
initMyTree(Nseer_tree1);
createButton('../../../xml/finance/config/fixed_assets/fa_subject','finance_config_assets_kind','treeButton');
}
</script>