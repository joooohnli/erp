...
<script language="javascript" src="../../../javascript/finance/config/report/property.js"></script>
...
<% 
String sql = "select * from finance_config_report_itema order by id";
...
<page:pages rs="<%=rs%>" strPage="<%=strPage%>">
	['<input type="checkbox" <%=CHECKBOX_STYLE1%> class="CHECKBOX_STYLE1" name="<%=k%>" value="<%=rs.getString("id")%>">','<%=rs.getString("number_in_asset_table")%>','<%=exchange.toHtml(rs.getString("first_kind_name"))%>'],
<%
k++;
%>
</page:pages>
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="70%"><input <%=INPUT_STYLE1%> class="INPUT_STYLE1" style="width:100%" type="text" id="number_in_asset_table" name="number_in_asset_table" value="" onkeyup="inputControl(this.id)"/></td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<page:updowntag num="<%=intRowCount%>" file="property.jsp"/>
