...
%>
<script type="text/javascript" src="../../../javascript/finance/fixed_assets/change/calSum.js"></script>
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交")%>" name="B1" onClick="calSum_ok();"> <input type="reset" <%=RESET_STYLE1%> class="RESET_STYLE1" value="<%=demo.getLang("erp","清除")%>"></div>
 </td>
 </tr>
</table>
<%
...
%>
 ...
 <tr style="background-image:url(../../../images/line.gif)"><td colspan="4"><div style="width:100%; height:12; padding:3px; "><%=demo.getLang("erp","累计折旧调整")%></div></td></tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","变动前累计折旧")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input id="cb_calsum" type="text" style="width:49%" readonly/></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","变动后累计折旧")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input id="ca_calsum" type="text" style="width:49%" onfocus="not_choose(this);" onkeyup="decimalControl(this.id);"/></td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
