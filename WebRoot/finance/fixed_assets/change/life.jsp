...
%>
<script type="text/javascript" src="../../../javascript/finance/fixed_assets/change/life.js"></script>
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交")%>" name="B1" onClick="life_ok();"> <input type="reset" <%=RESET_STYLE1%> class="RESET_STYLE1" value="<%=demo.getLang("erp","清除")%>"></div>
 </td>
 </tr>
</table>
<%
...
%>
 ...
 <tr style="background-image:url(../../../images/line.gif)"><td colspan="4"><div style="width:100%; height:12; padding:3px; "><%=demo.getLang("erp","使用年限调整")%></div></td></tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","变动前使用年限")%></td>
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="cb_lifecycle1" style="width:20%" readonly/><%=demo.getLang("erp","年")%><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="cb_lifecycle2" style="width:20%" readonly/><%=demo.getLang("erp","月")%></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","变动后使用年限")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="ca_lifecycle1" style="width:20%" onfocus="not_choose();"><%=demo.getLang("erp","年")%><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="ca_lifecycle2" style="width:20%" onfocus="not_choose();"><%=demo.getLang("erp","月")%></td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
