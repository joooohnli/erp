...
out.print(search);
	 ...
	 sql="select file_name,start_time,specification,currency,original_value,remnant_value,remnant_value_rate from finance_fa_file where file_id='"+keyword+"'";
	 rs=finance_db.executeQuery(sql);
if(rs.next()){
	search=rs.getString("file_name")+"⊙"+rs.getString("start_time")+"⊙"+rs.getString("specification")+"⊙"+rs.getString("currency")+"⊙"+rs.getString("original_value")+"⊙"+rs.getString("remnant_value")+"⊙"+rs.getString("remnant_value_rate");
	}
 search=!search.equals("")?search:"179206725";
 out.print(search);
}
