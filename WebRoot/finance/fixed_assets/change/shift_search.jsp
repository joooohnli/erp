...
out.print(search);
	...
	sql="select file_name,start_time,specification,department_id,department_name,deposit_place from finance_fa_file where file_id='"+keyword+"'";
	rs=finance_db.executeQuery(sql);
if(rs.next()){
	search=rs.getString("file_name")+"⊙"+rs.getString("start_time")+"⊙"+rs.getString("specification")+"⊙"+rs.getString("department_id")+" "+rs.getString("department_name")+"⊙"+rs.getString("deposit_place");
	}
 	search=!search.equals("")?search:"179206725";
 out.print(search);
}
