...
out.print(search);
	...
	sql="select file_name,start_time,specification,status_id from finance_fa_file where file_id='"+keyword+"'";
	rs=finance_db.executeQuery(sql);
if(rs.next()){
	search=rs.getString("file_name")+"⊙"+rs.getString("start_time")+"⊙"+rs.getString("specification")+"⊙"+rs.getString("status_id");
	}
 	search=!search.equals("")?search:"179206725";
 out.print(search);
}
