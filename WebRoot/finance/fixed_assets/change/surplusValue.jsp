...
%>
<script type="text/javascript" src="../../../javascript/finance/fixed_assets/change/surplusValue.js"></script>
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交")%>" name="B1" onClick="surplusValue_ok();"> <input type="reset" <%=RESET_STYLE1%> class="RESET_STYLE1" value="<%=demo.getLang("erp","清除")%>"></div>
 </td>
 </tr>
</table>
<%
...
%>
 ...
 <tr style="background-image:url(../../../images/line.gif)"><td colspan="4"><div style="width:100%; height:12; padding:3px; "><%=demo.getLang("erp","净残值调整")%></div></td></tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="specification" style="width:49%" readonly/></td>
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","原值")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input id="original_value" type="text" style="width:49%" readonly/></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","净值")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input id="net_value" type="text" style="width:49%" readonly/></td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","变动前净残值率")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input id="cb_remnant_value_rate" type="text" style="width:45%" readonly/>%</td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","变动后净残值率")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input id="ca_remnant_value_rate" type="text" style="width:45%" onfocus="not_choose(this);" onkeyup="ca_remnant_value_rate1(this.id);" onblur="ca_remnant_value_rate2(this.id);">%</td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","变动前净残值")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input id="cb_remnant_value" type="text" style="width:49%" readonly/></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","变动后净残值")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="39%"><input id="ca_remnant_value" type="text" style="width:49%" onfocus="not_choose(this);" onkeyup="ca_remnant_value1(this.id);" onblur="ca_remnant_value2(this.id);"></td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
