...
<form id="timeLocateValidation" class="x-form" method="post" action="query_locate_getpara.jsp">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="80%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="file_id1" name="file_id1" style="width:30%" onkeyup="search_suggest(this.id);" autocomplete="off"><input id="file_id1_table" type="hidden" value="finance_fa_file"></td> 
</tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1"> 
