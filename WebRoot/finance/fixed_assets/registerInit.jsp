...
<script type="text/javascript" src="../../javascript/finance/fixed_assets/registerInit.js"></script>
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交")%>" name="B1" onClick="registerInit_ok();">&nbsp;<input type="reset" <%=RESET_STYLE1%> class="RESET_STYLE1" value="<%=demo.getLang("erp","清除")%>"></div>
 </td>
 </tr>
</table>
<%
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" colspan="3"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="type_name2" name="type_name1" style="width:40%" onFocus="showKind('nseer1',this,showTree1)" onkeyup="search_suggest1(this.id)" autocomplete="off"><input id="type_name2_table" type="hidden" value="finance_config_assets_kind"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><font color=red>*</font><%=demo.getLang("erp","固定资产编号")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="37%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="file_id2" name="file_id2" style="width:49%"></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><font color=red>*</font><%=demo.getLang("erp","固定资产名称")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="37%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="file_name2" name="file_name2" style="width:49%"></td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><font color=red>*</font><%=demo.getLang("erp","增加方式")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="37%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="addway" name="addway1" style="width:49%" onFocus="showKind('nseer2',this,showTree2)" onkeyup="search_suggest(this.id)" autocomplete="off"><input id="addway_table" type="hidden" value="finance_config_assets_fluctuationway"></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><font color=red>*</font><%=demo.getLang("erp","所在机构")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="37%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="department" name="department1" style="width:49%" onFocus="showKind('nseer4',this,showTree4)" onkeyup="search_suggest(this.id)" autocomplete="off"><input id="department_table" type="hidden" value="hr_config_file_kind"></td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="37%"><input id="remnant_value" type="text" style="width:49%" onkeyup="remnant_value1(this);" onblur="remnant_validate(this);"><input type="hidden" id="remnant_value_hidden"></td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="37%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" style="width:49%" id="caled_subtotal_rate"><input type="hidden" id="caled_subtotal_rate_hidden"></td>
 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","月折旧额")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="37%"><input id="caled_subtotal" type="text" style="width:49%"><input type="hidden" id="caled_subtotal_hidden"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<div id="expand" class="cssDiv4" onclick="n_D.maxDiv()"  onmouseover="n_D.mmcMouseStyle(this);"></div>
<div id="collapse" class="cssDiv5" onclick="n_D.minDiv(40)"  onmouseover="n_D.mmcMouseStyle(this);"></div>
 <div  id="nseer2_0" style="position:absolute;left:10px;top:40px;width:100%;height:89%;overflow:auto;">
<script>
var Nseer_tree2;
function showTree2(){
...
<div id="nseer4" nseerDef="dragAble" style="background:#E8E8E8;position:absolute;width:600px;height:300px;top:130px;left:50px;display:none;z-index:1;">
<iframe src="javascript:false" style="position:absolute;visibility:inherit;top:0px;left:0px;width:100%;height:100%;z-index:-1;filter='progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)';"></iframe>
  <TABLE width="100%" height="100%" border=0 cellPadding=0 cellSpacing=0>
  <TBODY>
    <TR>
...
<div id="nseer8" style="display:none;width:93%;height:80%;position:absolute;top:13%;left:6.5%;overflow:auto;"></div>
<div id="nseer9" style="display:none;width:93%;height:80%;position:absolute;top:13%;left:6.5%;overflow:auto;"></div>
<div id="nseer10" style="display:none;width:93%;height:80%;position:absolute;top:13%;left:6.5%;overflow:auto;"></div>
</div>
</TD>
<TD  background="../../images/bg_04.gif"></TD>
    </TR>
