...
<form id="timeLocateValidation" class="x-form" method="post" action="registerWork_locate_getpara.jsp">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="80%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" id="file_id1" name="file_id1" style="width:30%" onkeyup="search_suggest1(this.id);" autocomplete="off"></td> 
</tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1"> 
...
<div id="nseer1" nseerDef="dragAble" style="position:absolute;left:300px;top:100px;display:none;width:500px;height:350px;overflow:hidden;z-index:1;background:#E8E8E8;">
