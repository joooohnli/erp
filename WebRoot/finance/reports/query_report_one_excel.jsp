...
jxl.write.WritableSheet ws =wwb.createSheet("资产负债表",0);
...
all_column="资产<$$>行次<$$>年初数<$$>期末数<$$>负债和所有者权益（或股东权益）<$$>行次<$$>年初数<$$>期末数■"+all_column;
...
jxl.write.Label label30 = new Label(0,0,"资产负债表",wff_merge);   
ws.addCell(label30);
//合并单元格
