...
<form id="tableaValidation" class="x-form" method="post" action="tablea_ok.jsp" onSubmit="return doValidate('../../xml/finance/finance_config_public_char.xml','tableaValidation')">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
