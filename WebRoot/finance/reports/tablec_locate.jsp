...
<form id="tablecValidation" class="x-form" method="post" action="tablec_ok.jsp" onSubmit="return doValidate('../../xml/finance/finance_config_public_char.xml','tablecValidation')">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
