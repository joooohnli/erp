...
<form id="timeLocateValidation" class="x-form" method="post" action="checkup_list.jsp" onSubmit="return doValidate('../../../xml/finance/finance_config_public_char.xml','timeLocateValidation')">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
