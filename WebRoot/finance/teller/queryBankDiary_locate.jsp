...
<form id="timeLocateValidation" class="x-form" method="post" action="queryBankDiary_locate_getpara.jsp" onSubmit="return doValidate('../../xml/finance/finance_config_public_char.xml','timeLocateValidation')">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<script type="text/javascript" src="../../javascript/calendar/cal.js"></script> 
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1"> 
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="20%"><%=demo.getLang("erp","请选择银行日记账")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="80%"><select <%=SELECT_STYLE1%> class="SELECT_STYLE1" name="select1" style="width: 60%;">
<%
  String sql = "select category_name from finance_config_file_kind where bank_tag='1' order by file_ID" ;
