...
String condition2="check_tag='9' and account_period<'16'";
...
String condition="check_tag!='1' and account_period<'16'";
...
nseer_grid.column_width=[70,70,150,150,70,140,70,70];
...
<page:updowntag num="<%=intRowCount%>" file="change_list.jsp"/>
