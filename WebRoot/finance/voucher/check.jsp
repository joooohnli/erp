...
if(!vt.validata((String)session.getAttribute("unit_db_name"),"finance_voucher","voucher_in_month_id",voucher_in_month_id,"register_time",register_time,"check_tag").equals("1")){
...
function TwoSubmit(start_time,end_time){
if (document.getElementById('ref1').checked){
document.getElementById('register_new').action = "check_delete_reconfirm.jsp";
document.getElementById('register_new').submit();
}else{
document.getElementById('register_new').action = "../../finance_voucher_check_ok";
send(start_time,end_time,'1');
document.getElementById('register_new').submit();
...
<form id="register_new" method="POST">
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input id="ref1" name="Ref" type="radio" <%=RADIO_STYLE1%> class="RADIO_STYLE1" value=cop checked> <%=demo.getLang("erp","未通过")%>&nbsp;<input id="ref2" name="Ref" type="radio" <%=RADIO_STYLE1%> class="RADIO_STYLE1" value=Ind> 
  <%=demo.getLang("erp","通过")%> <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","删除")%>" onClick="deleteRow(event)">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="确认" name="B1" onClick="TwoSubmit('<%=account_period[1]%>','<%=account_period[2]%>')"> <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back();"></div></td>
 </tr>
 </table>
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td align="center" height="50px"><input name="example"  type="text" value="<%=demo.getLang("erp","记帐凭证")%>" style="width:200px; height:35px; border-style: none; font : small-caps 600 20pt/20pt 宋体; border-bottom:  3px double #000000; text-align: center;" readonly/></td>
 </tr>
</table> 
<style>
...
<tr width="574" height="24" >
 <td width="55">
 <input name="voucher_type" type="text" id="subject" style="width: 57; height: 23; text-align: Right; border-style:none; border-bottom: 1px solid #000000; padding-right:1px; padding-top : 4px;" size="20" value="<%=rs.getString("voucher_type")%>"></td>
  <td width="30">
 ...
 <b><%=demo.getLang("erp","附件数")%>：</b>
  <td width="72">
 <input name="attachment_amount" type="text" id="subject4" style="width: 68; height: 23; text-align: Right; border-style:none; border-bottom: 1px solid #000000; padding-right:1px; padding-top : 4px;" size="20" value="<%=rs.getString("attachment_amount")%>">
</tr>
</table>
...
cash_sum[<%=rs6.getInt("details_number")%>]='<%=rs6.getString("cash_sum")%>';
   ...
   <tr height="30" id="<%=rs6.getString("details_number")%>">
          ...
          <input name="debit" type="text" id="aaa<%=rs6.getString("details_number")%>" maxlength="15" onkeyup="match(this.id)" class="input2" onkeydown="Clear(this.id,event)" onFocus="fo(this.id)" size="20" value="<%=debit%>">
          </td>
          <td width="155" height="30">
          <input name="loan" type="text" id="bbb<%=rs6.getString("details_number")%>" maxlength="15" onkeyup="match(this.id)" class="input2" onkeydown="Excessively_firefox(this.id,event)" onFocus="fo(this.id)" size="20" value="<%=loan%>">
           </td>
  </tr>
<%
	}else{
...
<td>
<input name="debit" id="aaa<%=rs6.getString("details_number")%>" type="text" maxlength="15" onkeyup="match(this.id)" style="width: 100%; height: 30px; background-image: url('../../images/finance/voucher.bmp'); text-align: Right; border-style: none; border-right:  1px solid #000000; border-bottom:  1px solid #000000; padding-right:1px;padding-top : 10px;" onkeydown="Clear(this.id,event)" autocomplete="off" onFocus="fo(this.id)" value="<%=debit%>">
</td>
<td>
...
%>
 ...
 <tr><td height="20"><%=demo.getLang("erp","会计主管")%><input class="textbox" style="width: 80; height: 20; border-style:none; border-bottom: 1px solid #000000" id="accountant" name="accountant" size="20" value="<%=rs.getString("accountant")%>">
 </td>
 <td height="20"><%=demo.getLang("erp","记帐")%><input class="textbox" style="width: 80; height: 20; border-style:none; border-bottom: 1px solid #000000" id="accounter" name="accounter" size="20" value="<%=rs.getString("accounter")%>">
 </td>
 <td height="20"><%=demo.getLang("erp","出纳")%><input class="textbox" style="width: 80; height: 20; border-style:none; border-bottom: 1px solid #000000" id="cashier" name="cashier" size="20" value="<%=rs.getString("cashier")%>">
</td>
 <td height="20"><%=demo.getLang("erp","审核")%><input class="textbox" style="width: 80; height: 20; border-style:none; border-bottom: 1px solid #000000" id="checker" name="checker" size="20" value="<%=checker%>">
</td>
 <td height="20"><%=demo.getLang("erp","制单")%><input class="textbox" style="width: 80; height: 20; border-style:none; border-bottom: 1px solid #000000" id="register" name="register" size="20" value="<%=rs.getString("register")%>" onFocus="this.blur()"></td>
 </tr>
 </table>
...
cash_sum[<%=rs6.getInt("details_number")%>]='<%=rs6.getString("cash_sum")%>';
 ...
 <tr height="30" id="<%=rs6.getString("details_number")%>">
          <td width="315" style="background:#FFFFFF;border-right:  1px solid #000000;">
          ...
          <td width="355" style="background:#FFFFFF;border-right:  1px solid #000000;">
          ...
          <td width="165"style="background:#FFFFFF; border-right:  1px solid #000000; background-image: url('../../images/finance/voucher.bmp')">
          <input name="loan" type="text" id="bbb<%=rs6.getString("details_number")%>" maxlength="15" onkeyup="match(this.id)" class="input2" onkeydown="Excessively(this.id,event)" onFocus="fo(this.id)" size="20" value="<%=loan%>">
           </td>
  </tr>
<%
	}else{
...
<tr height="30" id="<%=rs6.getString("details_number")%>">
         ...
         <td>
         <input name="debit" type="text" id="aaa<%=rs6.getString("details_number")%>" maxlength="15" onkeyup="match(this.id)" class="input2" onkeydown="Clear(this.id,event)" size="20" onFocus="fo(this.id)" value="<%=debit%>">
         </td>
         <td>
         <input name="loan" type="text" id="bbb<%=rs6.getString("details_number")%>" maxlength="15" onkeyup="match(this.id)" class="input2" onkeydown="Excessively(this.id,event)" size="20" onFocus="fo(this.id)" value="<%=loan%>">
         </td>
  </tr>
<%
}
...
<tr height="30" id="<%=j%>">
         ...
         <td>
         <input name="debit" type="text" id="aaa<%=j%>" maxlength="15" onkeyup="match(this.id)" class="input2" onkeydown="Clear(this.id,event)" size="20" onFocus="fo(this.id)">
         </td>
         <td>
         <input name="loan" type="text" id="bbb<%=j%>" maxlength="15" onkeyup="match(this.id)" class="input2" onkeydown="Excessively(this.id,event)" size="20" onFocus="fo(this.id)">
         </td>
  </tr>
 <%}}%>
 </table>
        ...
        <tr width="582" height="30">
		   ...
		   <td width="109px" style="background-color: #ffffff; background-image: url('../../images/finance/voucher.bmp');"><input name="debit_sum" type="text" id="aOuter" maxlength="15" class="input4" size="20" readonly value="<%=debit_sum%>"/>　 </td>        
           <td width="109px" style="background-color: #ffffff; background-image: url('../../images/finance/voucher.bmp');"><input name="loan_sum" type="text" id="bOuter" maxlength="15" class="input4" size="20" readonly value="<%=loan_sum%>"/></td>
...
<input style="width: 80; height: 20; border-style: none; border-bottom: 1px solid #000000;background:#FFFFFF" id="quantity" name="TH5" size="20" onkeyup="div_match(this.id)">×<%=demo.getLang("erp","单价")%><input type="text" name="net_price>" id="net_price" size="12" style="width: 80; height: 20; border-style: none; border-bottom: 1px solid #000000;background:#FFFFFF" size="20" onkeyup="div_match(this.id)"><%=demo.getLang("erp","税率")%>(%)<input type="text" name="tax_rate" id="tax_rate" size="12" style="width: 40; height: 20; border-style: none; border-bottom: 1px solid #000000;background:#FFFFFF"  size="20" onkeyup="div_match(this.id)"><%=demo.getLang("erp","含税单价")%><input type="text" name="list_price" id="list_price" size="12" style="width: 80; height: 20; border-style: none; border-bottom: 1px solid #000000;background:#FFFFFF" size="20" onkeyup="div_match(this.id)">=<%=demo.getLang("erp","金额")%><input type="text" name="subtotal" id="subtotal" size="12" style="width: 120; height: 20; border-style: none; border-bottom: 1px solid #000000;background:#FFFFFF" size="20" onkeyup="div_match(this.id)">
</td>
</tr>
<tr height="20px">
...
<%}
%>
</select>&nbsp;&nbsp;&nbsp;&nbsp;<%=demo.getLang("erp","票号")%><input style="width: 100; height: 20; border-style: none; border-bottom: 1px solid #000000;background:#FFFFFF;" id="attachmentId" name="TH5" size="20">&nbsp;&nbsp;&nbsp;&nbsp;<%=demo.getLang("erp","票据日期")%><input name="settleTime" type="text" onkeyup="inputCancel(this.id)" id="settleTime" style="width: 104; height: 20; border-style: none; border-bottom: 1px solid #000000; background:#FFFFFF;" size="20">
