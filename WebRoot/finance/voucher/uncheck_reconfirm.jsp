...
<%
String voucher_id=request.getParameter("voucher_in_month_id");
...
<form id="form" class="x-form" method="post" action="../../finance_voucher_uncheck_ok">
...
<input type="hidden" name="register_time" value="<%=exchange.toHtml(register_time)%>">
 ...
 <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick=location="uncheck_list.jsp"></div></td>
 </tr>
 </table>
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10"><%=demo.getLang("erp","该凭证反审核，您确认吗？")%></td>
 </tr>
 </table>
 </form>
 </div>