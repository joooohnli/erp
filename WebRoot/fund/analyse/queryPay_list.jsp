...
String condition="(fund_execute_tag='1' or fund_pre_tag='0') and file_chain_name like '应付账款%'";
String queue="order by register_time desc";
String validationXml="../../xml/fund/fund_fund.xml";
String nickName="采购应付款";
String fileName="queryPay_list.jsp";
String rowSummary=demo.getLang("erp","符合条件的采购应付款总数");
%>
