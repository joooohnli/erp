...
<script type='text/javascript' src="../../../javascript/fund/config/fund/treeBusiness.js"></script>
...
function addTree(){
 ...
 Nseer_tree1.setTableName('fund_config_fund_kind');
 Nseer_tree1.setModuleName('../../../xml/fund/config/fund');//xml文件路径
 Nseer_tree1.addRootNode('No0','<%=demo.getLang("erp","全部分类")%>',false,'1',[]);
 Nseer_tree1.setParent('nseer1');
initMyTree(Nseer_tree1);
createButton('../../../xml/fund/config/fund','fund_config_fund_kind','treeButton');
}
</script>