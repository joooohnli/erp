...
String tablenick=exchange.unURL(request.getParameter("tablenick"));
...
XmlFactory xml= new XmlFactory("conf/xml/fund/file_export.xml",dbase,tablename,colsNames,"conf/xml/fund/data1_excel.xml",sql);
xml.makeElement();
xml.Xmlwrite();
