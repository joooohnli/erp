...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 ...
 <td width="25%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","账户")%></td>
	 <td width="11%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","账号")%></td>
 <td width="6%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","收款方式")%></td>
	 <td width="10%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","票据号码")%></td>
	 <td width="12%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","收款时间")%></td>
<%if(rs.getString("reason").equals("收款")){%>
	 <td width="10%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","本次收款金额")%></td>
<%}else{%>
	 <td width="10%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","本次付款金额")%></td>
<%}%>
 </tr>
<%
int i=1;
