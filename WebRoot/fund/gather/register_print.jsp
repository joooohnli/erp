...
ResultSet rs3=funddb.executeQuery(sql3);
while(rs3.next()){
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 ...
 <td width="11%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","序号")%></td>
 <td width="20%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","账户")%></td>
	 <td width="13%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","账号")%></td>
	 <td width="11%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","金额")%></td>
 <td width="13%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","本次收款方式")%></td>
 <td width="11%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","票据号码")%></td>
	 <td width="13%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","本次收款金额")%></td>
 </tr>
<%
	int count=0;
	String sql5="select count(*) from fund_details where fund_ID='"+fund_ID+"'";
...
if(count>20){
	int m=1;
String sql6="select * from fund_details where fund_ID='"+fund_ID+"'";
