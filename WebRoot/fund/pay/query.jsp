...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="11%"><%=demo.getLang("erp","开户行")%></td>
...
<%if(rs.getString("reason").equals("付款")){%>
	 <td <%=TD_STYLE2%> class="TD_STYLE2" width="11%"><%=demo.getLang("erp","已付款金额")%></td>
<%}else{%>
	 <td <%=TD_STYLE2%> class="TD_STYLE2" width="11%"><%=demo.getLang("erp","已付款金额")%></td>
<%}%>
 </tr>
...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="89%" colspan="3"><%=rs.getString("remark")%>&nbsp;
</td>
 </tr>
 </table>
