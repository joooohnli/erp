...
String rowSummary=demo.getLang("erp","符合条件的友情链接垃圾总数");
int k=1;
%>
...
nseer_grid.column_width=[40,180,200,180,200];
nseer_grid.auto='<%=demo.getLang("erp","链接地址")%>';
nseer_grid.data = [
...
<input type="hidden" id="field1" value="link_id">
<input type="hidden" id="gar_tag" value="check_tag='1'">
<input type="hidden" id="field" value="link_id">
