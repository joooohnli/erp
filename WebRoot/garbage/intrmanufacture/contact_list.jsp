...
String nickName="委外厂商联络垃圾";
String fileName="contact_list.jsp";
String rowSummary=demo.getLang("erp","符合条件的委外厂商联络垃圾总数");
int k=1;
%>
...
nseer_grid.column_width=[40,180,100,100,180,100,100,160];
