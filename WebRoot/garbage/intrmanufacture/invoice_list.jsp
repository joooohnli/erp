...
<script type="text/javascript" src="../../javascript/garbage/intrmanufacture/invoiceReconfirm.js"></script>
...
String rowSummary=demo.getLang("erp","符合条件的委外发票总数");
int k=1;
%>
...
<input type="hidden" id="field1" value="intrmanufacture_id">
<input type="hidden" id="gar_tag" value="invoice_gar_tag='1' and gar_tag='0'">
<input type="hidden" id="field" value="intrmanufacture_id">
