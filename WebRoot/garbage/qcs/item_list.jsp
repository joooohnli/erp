...
String nickName="质检项目垃圾";
String fileName="item_list.jsp";
String rowSummary=demo.getLang("erp","符合条件的质检项目垃圾总数");
int k=1;
%>
...
nseer_grid.column_width=[40,180,100,100,100,100,100,100,200];
...
<input type="hidden" id="field1" value="item_id">
<input type="hidden" id="gar_tag" value="check_tag='1'">
<input type="hidden" id="field" value="item_id">
