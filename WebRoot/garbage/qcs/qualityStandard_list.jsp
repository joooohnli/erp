...
String nickName="质量标准垃圾";
String fileName="qualityStandard_list.jsp";
String rowSummary=demo.getLang("erp","符合条件的质量标准垃圾总数");
int k=1;
%>
...
nseer_grid.column_width=[40,180,200,200,100,100];
...
<input type="hidden" id="field" value="standard_id">
