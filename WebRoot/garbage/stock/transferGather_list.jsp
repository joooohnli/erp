...
String nickName="内部调入";
String fileName="transferGather_list.jsp";
String rowSummary=demo.getLang("erp","符合条件的内部调入总数");
int k=1;
%>
...
nseer_grid.column_width=[40,180,100,160,100,100];
...
<input type="hidden" id="gar_tag" value="gather_tag='2'">
