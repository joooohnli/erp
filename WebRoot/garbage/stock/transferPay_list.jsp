...
String nickName="内部调出";
String fileName="transferPay_list.jsp";
String rowSummary=demo.getLang("erp","符合条件的内部调出总数");
int k=1;
%>
...
<input type="hidden" id="gar_tag" value="pay_tag='2'">
