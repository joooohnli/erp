...
if(rs1.next()&&oldpwd.equals(rs1.getString("passwd"))&&pwd.equals(passwd)&&!pwd.equals("")&&!passwd.equals("")){
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2" width="650" cellpadding="2">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3" colspan="3">
  <p align="center"><font color="#FF0000" size="2"><%=demo.getLang("erp","用户密码修改成功！")%></font></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" colspan="3">　
  <p align="center"><input <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" type="button" value="<%=demo.getLang("erp","返回")%>" onClick=location="login.jsp"></td>
 </tr>
 </table>
...
%>
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" colspan="3">
  <p align="center"><font color="#FF0000" size="2"><%=demo.getLang("erp","对不起，用户名或原密码不正确，请重新输入！")%></font></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" width="15%"></td>
 <td <%=TD_STYLE3%> class="TD_STYLE3" width="30%"></td>
