...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <%=demo.getLang("erp","对不起，数据库连接故障，如有疑问请联系系统管理员。")%>
 </td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
  <td <%=TD_STYLE3%> class="TD_STYLE3" colspan="2" align="center"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" name="ok" value="<%=demo.getLang("erp","返回")%>" onclick=location="login.jsp">
  </td>
 </tr>
 </table>
 </table>
