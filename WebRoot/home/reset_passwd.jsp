...
setGradient('example1','#A5E3FF','#ffffff',0);
 ...
 <p align="center"><b><font color="#800000" size="3"><%=demo.getLang("erp","恩信科技ERP系统修改用户密码")%></b></td>
 </tr>
 </table>
...
<form method="POST" action="reset_passwd_ok.jsp?language=<%=language%>" onSubmit="return CheckForm(this)">
 
 <table <%=TABLE_STYLE1%> class="TABLE_STYLE1" style="width:65%" align="center">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="30%"><%=demo.getLang("erp","用户名")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="70%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="name" style="width:40%"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="30%"><%=demo.getLang("erp","忘记密码时确认身份的问题")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="70%"><input type="text" name="question" <%=INPUT_STYLE1%> class="INPUT_STYLE1" style="width:40%"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="30%"><%=demo.getLang("erp","忘记密码时确认身份的答案")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="70%"><input type="text" name="answer" <%=INPUT_STYLE1%> class="INPUT_STYLE1" style="width:40%"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="30%"><%=demo.getLang("erp","新密码")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="70%"><input type="password" name="pwd" style="background-color: #DEEBF7;width:40%"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="30%"><%=demo.getLang("erp","确认新密码")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="70%"><input type="password" name="passwd" style="background-color: #DEEBF7;width:40%"></td>
 </tr>
 </table>
