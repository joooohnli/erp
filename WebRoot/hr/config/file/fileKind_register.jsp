...
String sql = "insert into stock_config_public_char(stock_ID,stock_name,describe1) values('"+stock_ID+"','"+stock_name+"','库房')" ;
hr_db.executeUpdate(sql) ;
}else if(tag.equals("1")){
String sql = "delete from stock_config_public_char where stock_name='"+file_name+"库房' and describe1='库房'" ;
hr_db.executeUpdate(sql) ;
}
hr_db.close();
