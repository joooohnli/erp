...
<tr style="background-image:url(../../../images/line.gif)"><td colspan="4"><div style="width:100%; height:12; padding:3px; "><%=demo.getLang("erp","主信息")%></div></td></tr> 
 ...
 <!--
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%" rowspan="6"><a href="../resume/query_picture.jsp?picture=<%=rs.getString("picture")%>" target="_blank"><img src="../../human_pictures/<%=rs.getString("picture")%>" width="110" height="128"></a></td>
 -->
 </tr> 
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","姓名")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input name="details_number" type="hidden" value="<%=rs.getString("details_number")%>"><input name="details_number" type="hidden" value="<%=rs.getString("details_number")%>"><input name="human_name" type="hidden" value="<%=exchange.toHtml(rs.getString("human_name"))%>"><%=exchange.toHtml(rs.getString("human_name"))%>&nbsp;</td>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2"  width="24.5%"><%=exchange.toHtml(rs.getString("human_email"))%>&nbsp;</td>
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","招聘类型")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2"  width="24.5%"><%=exchange.toHtml(rs.getString("engage_type"))%></td>
 </tr> 
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="24.5%" ><%=exchange.toHtml(rs.getString("human_cellphone"))%>&nbsp;</td>
 </tr>
  <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="24.5%" ><%=exchange.toHtml(rs.getString("human_address"))%>&nbsp;</td>
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","邮编")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="24.5%" ><%=exchange.toHtml(rs.getString("human_postcode"))%>&nbsp;</td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="24.5%" ><%=exchange.toHtml(rs.getString("birthday"))%>&nbsp;</td> 
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="24.5%" ><%=exchange.toHtml(rs.getString("party"))%>&nbsp;</td> 
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
