...
<form id="change_delete_reconfirm" class="x-form" method="POST" action="../../../hr_engage_major_release_change_delete_ok">
<%
...
<input name="id" type="hidden" value="<%=id%>">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","您确认删除该职位发布吗？")%></td>
 </tr>
 </table>
 </div>
