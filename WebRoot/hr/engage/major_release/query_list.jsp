...
String rowSummary=demo.getLang("erp","当前职位发布总数：");
%>
...
nseer_grid.columns =[
					   ...
					   {name: '<%=demo.getLang("erp","申请该职位")%>'}
]
nseer_grid.column_width=[100,200,100,160,100,70];
