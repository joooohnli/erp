...
String condition="interview_tag='3' and pass_check_tag='0'";
String queue="order by register_time";
String validationXml="../../../xml/hr/hr_resume.xml";
String nickName="简历";
String fileName="register_list.jsp";
String rowSummary=demo.getLang("erp","当前等待录用申请的简历总数：");
%>
