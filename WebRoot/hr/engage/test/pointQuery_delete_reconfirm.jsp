...
<form class="x-form" id="check_delete_reconfirm" method="POST" action="../../../hr_engage_test_pointQuery_delete_ok">       
<input name="human_name" type="hidden" value="<%=exchange.toHtml(human_name)%>">
<input name="idcard" type="hidden" value="<%=exchange.toHtml(idcard)%>">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","您确认删除该简历吗？")%></td>
 </tr>
 </table>
</div>