...
<form class="x-form" id="check_delete_reconfirm" method="POST" action="../../hr_salary_standard_check_delete_ok">		
...
<input type="hidden" name="remark" value="<%=remark%>">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10"><%=demo.getLang("erp","该薪酬标准审核未通过审核，您确认吗？请选择处理：")%></td>
 </tr> 
<%
int i=1;
String sql6="select config_id from hr_workflow where object_ID='"+standard_ID+"' and type_id='02' and config_id<'"+config_id+"' order by id";
