...
<div id="nseerGround" class="nseerGround">
 ...
 <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" style="width: 50; " onClick=location="check_list.jsp"></td>
 </tr>
 </table>
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2" cellpadding="2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td height="10"><%=demo.getLang("erp","该流程审核通过，谢谢！")%></td>
 </tr>
 </table>
 </div>
