...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="86.5%" colspan="7"><a href="javascript:winopen('query_attachment.jsp?id=<%=rs6.getString("id")%>&tablename=intrmanufacture_details&fieldname=attachment_name')">
