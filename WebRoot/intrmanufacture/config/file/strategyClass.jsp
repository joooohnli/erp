...
<% 
 String sql = "select * from intrmanufacture_config_public_char where kind='委外厂商级别' order by type_ID";
...
nseer_grid.columns =[
                     {name: '&nbsp;'},
                     {name: '<%=demo.getLang("erp","委外厂商优质级别名称")%>'}
                     ]
nseer_grid.column_width=[35,100];
nseer_grid.auto='<%=demo.getLang("erp","委外厂商优质级别名称")%>';
nseer_grid.data = [
