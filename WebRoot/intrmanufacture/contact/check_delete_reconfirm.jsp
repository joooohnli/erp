...
<form class="x-form" method="post" action="../../intrmanufacture_contact_check_delete_ok">
...
<input type="hidden" name="check_time" value="<%=check_time%>">
 ...
 <%
int i=1;
String sql6="select config_id from intrmanufacture_workflow where object_ID='"+contact_ID+"' and config_id<'"+config_id+"' order by id";
