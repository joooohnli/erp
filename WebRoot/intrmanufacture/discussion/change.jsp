...
<form id="mutiValidation" method="POST" action="../../intrmanufacture_discussion_change_ok?id=<%=rs.getString("id")%>" onSubmit="return doValidate('../../xml/intrmanufacture/intrmanufacture_discussion.xml','mutiValidation')">
