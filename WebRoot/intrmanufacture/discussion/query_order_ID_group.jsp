...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" colspan="4" width="37.4%"><a href="javascript:winopenm('query_attachment.jsp?id=<%=rs.getString("id")%>&tablename=intrmanufacture_discussion&fieldname=attachment_name')"><%=attachment_name1[1]%></a>&nbsp;</td>
 </tr>
 ...
 <td <%=TD_STYLE1%> class="TD_STYLE1" width="13%"><%=demo.getLang("erp","加工费（元）")%></td>
