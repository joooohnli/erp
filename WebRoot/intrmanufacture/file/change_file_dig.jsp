...
try{
	String sql = "select * from intrmanufacture_file_dig where change_time='"+change_time+"' and provider_ID='"+provider_ID+"'" ;
...
%>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%">&nbsp;</td>
   ...
   <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="change_file_dig.jsp?time=<%=toUtf8String.utf8String(exchange.toURL(rs.getString("lately_change_time")))%>&&provider_ID=<%=rs.getString("provider_ID")%>"><%=exchange.toHtml(rs.getString("file_change_amount"))%></a>&nbsp;</td>
 </tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="javascript:winopenm('query_attachment.jsp?id=<%=rs.getString("id")%>&tablename=intrmanufacture_file_dig&fieldname=attachment_name')">
