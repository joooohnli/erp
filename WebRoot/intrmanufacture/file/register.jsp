...
<form id="mutiValidation" class="x-form" method="post" action="../../intrmanufacture_file_register_ok" onSubmit="return doValidate('../../xml/intrmanufacture/intrmanufacture_file.xml','mutiValidation')">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDraft("'mutiValidation','../../intrmanufacture_file_register_draft_ok','../../xml/intrmanufacture/intrmanufacture_file.xml'",request)%>&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1"  value="<%=demo.getLang("erp","提交")%>" name="B1"> <input type="reset" <%=RESET_STYLE1%> class="RESET_STYLE1" value="<%=demo.getLang("erp","清除")%>"></div>
 </td>
 </tr>
</table>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 ('mutiValidation','validator_dup','intrmanufacture_file','provider_name','../../vdf','provider_ID','query.jsp',this)" onMouseOver="toolTip('<%=demo.getLang("erp","该功能用于检验委外厂商信息是否重复！")%>',this)" onMouseOut="toolTip()"><img src="../../images/dup.gif" width="15" height="14" align="center" border="0"></a>
</td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="intrmanufacturer" style="width:49%"></td>
	 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","负责人编号")%></td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="intrmanufacturer_ID" style="width:49%"></td> 
 </tr>
