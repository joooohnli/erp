...
<%
String intrmanufacture_ID_group=request.getParameter("intrmanufacture_ID") ;
StringTokenizer tokenTO = new StringTokenizer(intrmanufacture_ID_group,", "); 
 while(tokenTO.hasMoreTokens()) {
				String intrmanufacture_ID=tokenTO.nextToken();
try{
...
if(rs.getString("stock_gather_tag").equals("0")){
stock_gather_tag="等待";
}else if(rs.getString("stock_gather_tag").equals("1")){
stock_gather_tag="执行";
...
if(rs.getString("invoice_tag").equals("0")){
invoice_tag="等待";
}else if(rs.getString("invoice_tag").equals("1")){
invoice_tag="执行";
