...
String path=context.getRealPath("/");
	String file1=intrmanufacture_ID+provider_ID;
	...
	String sql="update intrmanufacture_details set attachment_name='"+file+"' where provider_ID='"+provider_ID+"' and intrmanufacture_ID='"+intrmanufacture_ID+"'";
...
<div id="nseerGround" class="nseerGround">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3">
  ...
  <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","继续")%>" style="width: 50; " onClick=location="register_choose.jsp?intrmanufacture_ID=<%=intrmanufacture_ID%>"></div></td>
 </tr>
 </table>
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3">
  <%=demo.getLang("erp","上传成功，请继续！")%></td>
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3">
  <div <%=DIV_STYLE1%> class="DIV_STYLE1"> 
  <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" style="width: 50; " onClick=location="register_choose_attachment.jsp?provider_ID=<%=provider_ID%>&&intrmanufacture_ID=<%=intrmanufacture_ID%>"></div></td>
 </tr>
 </table>
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
