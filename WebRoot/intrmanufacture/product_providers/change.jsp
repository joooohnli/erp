...
<form id="mutiValidation" method="POST" action="../../intrmanufacture_product_providers_change_ok" onSubmit="return doValidate('../../xml/intrmanufacture/intrmanufacture_product_providers_recommend.xml','mutiValidation')">
 <table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="winopen('register_provider_list.jsp')" value="<%=demo.getLang("erp","新添加")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="delSelect()" value="新删除">&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="重新提交">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="history.back()" value="<%=demo.getLang("erp","返回")%>"></div></td>
 </tr>
 </table>
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=exchange.toHtml(rs7.getString("provider_tel1"))%>&nbsp;</td>
	 ...
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="../../intrmanufacture_product_providers_change_delete_details?id=<%=rs6.getString("id")%>&&product_providers_recommend_ID=<%=product_providers_recommend_ID%>"><%=demo.getLang("erp","删除")%></a></td>
<%
}else{
%>
...
<%	}
%>
<input name="provider_amount" type="hidden" style="width: 100%;background-color:#C9E7DC" value="<%=i-1%>">
