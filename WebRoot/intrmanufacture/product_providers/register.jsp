...
<form id="mutiValidation" method="POST" action="../../intrmanufacture_product_providers_register_ok" onSubmit="return doValidate('../../xml/intrmanufacture/intrmanufacture_product_providers_recommend.xml','mutiValidation')">
<%
int i=1;
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="winopen('register_provider_list.jsp')" value="<%=demo.getLang("erp","添加")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="delSelect()" value="<%=demo.getLang("erp","删除")%>"><%=DgButton.getDraft("'mutiValidation','../../intrmanufacture_product_providers_register_draft_ok','../../xml/intrmanufacture/intrmanufacture_product_providers_recommend.xml'",request)%>&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","确认")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="history.back()" value="<%=demo.getLang("erp","返回")%>"></div></td>
 </tr>
 </table>
...
<input name="chain_id" type="hidden" value="<%=exchange.toHtml(rs4.getString("chain_id"))%>">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="recommender"></td>
