 ...
 */
function ajax_validation(formID,valued,values,valuea,valueb,valuec,url,tothis){


var formName=document.getElementById(valuea);

var selectName=document.getElementById(values);
var selectName1=document.getElementById(valued);
...
var Selectvalue1=encodeURI(selectName1.value);
...
loadingDiv.innerHTML='<font color=#ffffff style="font-weight :bold;">'+xmlhttp.responseText+'</font>';
		...
		xmlhttp.send('IDD=true&valuea='+Selectvalue+'&valued='+Selectvalue1+'&'+valuea+'='+Namevalue+'&valueb='+valueb+'&valuec='+valuec);
