...
// $Id: calhms.js,v 1.1 2008/05/24 07:09:30 nseer Exp $
...
Calendar.prototype.create = function (_par) {
	...
	if (this.isPopup) {
		...
		//alert(Calendar._TT["DRAG_TO_MOVE"]);
...
con=con+1;
this.title.innerHTML =Calendar._MN[month] + ", " + year+", <font id=Clock+"+con+">hh</font>";
...
//		alert("Calendar.setup:\n  Nothing to setup (no fields found).  Please check your code");
	...
	function onSelect(cal) {
		...
		if (update && p.inputField) {
			p.inputField.value = cal.date.print(p.ifFormat)+" "+datatime;
...
datatime=timeString;
if(document.getElementById("Clock+"+con)!=null){
	
document.getElementById("Clock+"+con).innerHTML = timeString;
}
