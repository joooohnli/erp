...
function key()
{
	...
	document.getElementById('timeLocateValidation').action='delete_key_locate_getpara.jsp';
}
function back()
{
	var locate=document.getElementById('locate');
	...
	document.getElementById('timeLocateValidation').action='delete_locate_getpara.jsp';
}
function closefile(){
