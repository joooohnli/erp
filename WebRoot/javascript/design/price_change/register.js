...
function key()
{
	...
	document.getElementById('timeLocateValidation').action='register_key_locate_getpara.jsp';
}
function back()
{
	var locate=document.getElementById('locate');
	...
	document.getElementById('timeLocateValidation').action='register_locate_getpara.jsp';
}
function closefile(){
