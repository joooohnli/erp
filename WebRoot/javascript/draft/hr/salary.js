 ...
 */
function showGarDivSalary(value,tableName){/*执行单转入垃圾箱*/
readXml('../../css/include/nseer_cookie/xml-css.css','../../xml/include/draft_gar/divToGar_salary.xml','0');
...
function sendToGarSalary(fileName){
var ids_str='';
...
xmlhttp3.open("POST", "../../draft_hr_salary_garbage_ok", true);
