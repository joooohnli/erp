...
var number_in_asset_table=document.getElementById('number_in_asset_table').value;
...
xmlhttp3.open("POST", "../../../finance_config_report_property_register_ok", true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
xmlhttp3.send('number_in_asset_table='+encodeURI(number_in_asset_table)+'&first_kind_name='+encodeURI(first_kind_name));
}
}
...
if (xmlhttp3.readyState==4){try {if(xmlhttp3.status==200) {
	...
	alert( xmlhttp3.status + '=' + xmlhttp3.statusText);}} catch(exception) {alert(exception);}}};
	xmlhttp3.open("POST", "../../../finance_config_report_property_delete_ok", true);
	xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
