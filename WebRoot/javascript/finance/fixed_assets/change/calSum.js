...
xmlhttp3.open("POST", "calSum_search.jsp", true);
...
var options =xmlhttp3.responseText.split('⊙');
	...
	document.getElementById('cb_calsum').value=options[3];
}else {
alert( xmlhttp3.status + '=' + xmlhttp3.statusText);}} catch(exception) {alert(exception);}}};
xmlhttp3.open("POST", "calSum_search.jsp", true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
var cb_calsum=document.getElementById('cb_calsum').value;
var ca_calsum=document.getElementById('ca_calsum').value;
...
alert( xmlhttp3.status + '=' + xmlhttp3.statusText);}} catch(exception) {alert(exception);}}};
xmlhttp3.open("POST", "../../../finance_fixed_assets_change_calSum_ok", true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
xmlhttp3.send('file_id='+file_id+'&file_name='+encodeURI(file_name)+'&start_time='+start_time+'&specification='+encodeURI(specification)+'&cb_calsum='+cb_calsum+'&ca_calsum='+ca_calsum+'&change_reason='+encodeURI(change_reason)+'&change_date='+change_date+'&changer='+encodeURI(changer));
}
