...
xmlhttp3.open("POST", "workSum_search.jsp", true);
...
var options =xmlhttp3.responseText.split('⊙');
	...
	document.getElementById('cb_work_total').value=options[3];
}else {
alert( xmlhttp3.status + '=' + xmlhttp3.statusText);}} catch(exception) {alert(exception);}}};
xmlhttp3.open("POST", "workSum_search.jsp", true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
var cb_work_total=document.getElementById('cb_work_total').value;
var ca_work_total=document.getElementById('ca_work_total').value;
...
alert( xmlhttp3.status + '=' + xmlhttp3.statusText);}} catch(exception) {alert(exception);}}};
xmlhttp3.open("POST", "../../../finance_fixed_assets_change_workSum_ok", true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
xmlhttp3.send('file_id='+file_id+'&file_name='+encodeURI(file_name)+'&start_time='+start_time+'&specification='+encodeURI(specification)+'&cb_work_total='+cb_work_total+'&ca_work_total='+encodeURI(ca_work_total)+'&change_reason='+encodeURI(change_reason)+'&change_date='+change_date+'&changer='+encodeURI(changer));
}
