...
xmlhttp3.open("POST","../../garbage_crm_invoice_toDra_ok", true);
...
xmlhttp3.open("POST","../../garbage_crm_invoice_delete_ok", true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
xmlhttp3.open("POST",'../../garbage_crm_invoice_recovery_ok', true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
