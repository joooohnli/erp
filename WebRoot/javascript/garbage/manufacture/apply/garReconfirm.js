...
xmlhttp3.open("POST", "../../garbage_manufacture_apply_sendToDra_ok", true);
...
xmlhttp3.open("POST", "../../garbage_manufacture_apply_sendToDelete_ok", true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
xmlhttp3.open("POST",'../../garbage_manufacture_apply_recovery_ok', true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
