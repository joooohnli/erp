...
function showDeleteDiv(value,tableName){/*永久删除*/
...
xmlhttp3.open("POST", '../../garbage_manufacture_designModule_toDra_ok', true);
...
xmlhttp3.open("POST","../../garbage_manufacture_module_delete_ok", true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
if(parseInt(xmlhttp3.responseText.length)==3){
multiLangValidate.dwrGetLang("erp",'还原完成',{callback:function(msg){alert(msg);window.location.reload();}});
}else{
...
xmlhttp3.open("POST",'../../garbage_manufacture_recovery_ok', true);
xmlhttp3.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
