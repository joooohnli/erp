function loadAjaxDiv(input_id,product_id,e){//弹出ajax动态查询数据库层
e=e||window.event;
...
var obj1=document.getElementById(input_id);
	...
	if(document.attachEvent) document.attachEvent('onmousedown',closeResult,e);
	if(document.addEventListener) document.addEventListener('mousedown',closeResult,e);	
}
...
function formSubmit(){
	...
	if (action_tag == 'register'){
	    form_id='manufactureProduct_register';
		form = document.getElementById('manufactureProduct_register');
		form.action = '../../qcs_manufacture_product_register_ok';
	}else if (action_tag == 'change'){
	    form_id='manufactureProduct_change';
		form = document.getElementById('manufactureProduct_change');
		form.action = '../../qcs_manufacture_product_change_ok';
	}else if (action_tag == 'dealwith') {
	    form_id='manufactureProduct_dealwith';
		form = document.getElementById('manufactureProduct_dealwith');
		form.action = '../../qcs_manufacture_product_dealwith_ok';
	}else if (action_tag == 'uncheck') {
	    form_id='manufactureProduct_uncheck';
		form = document.getElementById('manufactureProduct_uncheck');
		form.action = '../../qcs_manufacture_product_uncheck_ok';
	}else if (action_tag == 'uncheck_key') {
	    form_id='manufactureProduct_uncheck_key';
		form = document.getElementById('manufactureProduct_uncheck_key');
		form.action = '../../qcs_manufacture_product_uncheck_key_ok';
	}
...
function dealwithSubmit(this_tag){
action_tag=this_tag;
formSubmit();
}
