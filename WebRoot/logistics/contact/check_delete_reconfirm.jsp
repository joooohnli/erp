...
<form class="x-form" method="post" action="../../logistics_contact_check_delete_ok">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10"><%=demo.getLang("erp","该联络登记未通过审核，您确认吗？请选择处理：")%></td>
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10">
 <div <%=DIV_STYLE1%> class="DIV_STYLE1">&nbsp;</td>
 </tr>
 <%
int i=1;
String sql6="select config_id from logistics_workflow where object_ID='"+contact_ID+"' and config_id<'"+config_id+"' order by id";
