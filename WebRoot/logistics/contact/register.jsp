...
%>
<form id="mutiValidation" method="POST" action="../../logistics_contact_register_ok" onSubmit="return doValidate('../../xml/logistics/logistics_contact.xml','mutiValidation')">
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDraft("'mutiValidation','../../logistics_contact_register_draft_ok','../../xml/logistics/logistics_contact.xml'",request)%>&nbsp;<input type="submit" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","提交")%>">&nbsp;<input type="reset" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","清除")%>"></div></td>
 </tr>
</table>
<%
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input name="provider_ID" type="hidden" width="100%" value="<%=provider_ID%>"><input name="reasonexact" type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" value="<%=exchange.toHtml(reasonexact)%>"></td>
</tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1"> 
