...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="submit" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","确定")%>"></div></td>
 </tr>
</table>
...
<table <%=TABLE_STYLE1%> class="TABLE_STYLE1" id=theObjTable>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="80%"><select <%=SELECT_STYLE1%> class="SELECT_STYLE1" name="reason" style="width: 30%;">
  <%
  String sql5 = "select * from logistics_config_public_char where kind='联络理由' order by type_ID" ;
...
%>
	...
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="20%" <%=TD_STYLE11%> class="TD_STYLE1"><%=demo.getLang("erp","请输入理由对应编码")%></td>
 ...
 <input name="provider_ID" type="hidden" width="100%" value="<%=provider_ID%>">
