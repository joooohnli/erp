...
<form class="x-form" method="post" action="../../logistics_discussion_check_delete_ok">
...
<%
int i=1;
String sql6="select config_id from logistics_workflow where object_ID='"+discussion_ID+"' and config_id<'"+config_id+"' order by id";
