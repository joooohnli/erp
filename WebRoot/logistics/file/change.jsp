...
if(vt.validata((String)session.getAttribute("unit_db_name"),"logistics_file","id",id,"check_tag").equals("1")){
try{
	String sqll = "select * from logistics_file where id="+id+"" ;
	ResultSet rss = logistics_db1.executeQuery(sqll) ;
	while(rss.next()){
...
<form id="mutiValidation" method="POST" class="x-form" action="../../logistics_file_change_ok?id=<%=rss.getString("id")%>" onSubmit="return doValidate('../../xml/logistics/logistics_file.xml','mutiValidation')">
  <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3">
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="submit" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1"  value="<%=demo.getLang("erp","重新提交")%>">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%" colspan="3"><input name="provider_ID" type="hidden" value="<%=rss.getString("provider_ID")%>" style="width:80%"><%=rss.getString("provider_ID")%></td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="37.4%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="provider_address" value="<%=rss.getString("provider_address")%>" style="width:80%"></td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
%>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2"  width="86.5%" colspan="3"><a href="javascript:winopenm('query_attachment.jsp?id=<%=rss.getString("id")%>&tablename=logistics_file&fieldname=attachment_name')">
<%=attachment_name1[1]%></a>&nbsp;</td>
 </tr>
	 <tr <%=TR_STYLE1%> class="TR_STYLE1">
	   <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE7" width="13%" height="65"><%=demo.getLang("erp","开票信息")%> &nbsp; </td>
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="invoice_info"><%=invoice_info%></textarea>
</td>
 
 <td <%=TD_STYLE4%> class="TD_STYLE7" width="13%" height="65"><%=demo.getLang("erp","可配送产品集合")%> &nbsp; </td>
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="demand_products"><%=demand_products%></textarea>
</td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE7" width="13%" height="65"><%=demo.getLang("erp","推荐配送产品集合")%> &nbsp; </td>
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input name="changer" type="hidden" value="<%=exchange.toHtml(changer)%>" style="width:49%"><%=exchange.toHtml(changer)%></td>
	 <td <%=TD_STYLE4%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","变更时间")%>&nbsp;</td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input name="change_time" type="hidden" value="<%=exchange.toHtml(time)%>" style="width:49%"><%=exchange.toHtml(time)%></td>
 </tr>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="logisticser_ID" value="<%=rss.getString("logisticser_ID")%>" style="width:49%"></td>
 </tr>
...
<%@include file="../../include/cDefineMouC.jsp"%>
 <input name="lately_change_time" type="hidden" width="100%" value="<%=exchange.toHtml(rss.getString("change_time"))%>">
	<input name="file_change_amount" type="hidden" width="100%" value="<%=exchange.toHtml(rss.getString("file_change_amount"))%>">
 </table>
 　　
