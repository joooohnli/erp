...
try{
	String sql = "select * from logistics_file_dig where change_time='"+change_time+"' and provider_ID='"+provider_ID+"'" ;
...
<table <%=TABLE_STYLE7%> class="TABLE_STYLE5" style="width:100%;">
 ...
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="8%"><%=demo.getLang("erp","电话")%> </td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><%=exchange.toHtml(rs.getString("provider_tel2"))%>&nbsp;</td>
 </tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%" ><%=exchange.toHtml(rs.getString("invoice_info"))%>&nbsp;</td>
 <td <%=TD_STYLE11%> class="TD_STYLE7" width="8%" height="65"><%=demo.getLang("erp","可配送产品集合")%>&nbsp;</td>
	 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><%=exchange.toHtml(rs.getString("demand_products"))%>&nbsp;</td>
 </tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="javascript:winopenm('query_attachment.jsp?id=<%=rs.getString("id")%>&tablename=logistics_file_dig&fieldname=attachment_name')">
<%=attachment_name1[1]%></a>&nbsp;</td>
 </tr>
	 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td height="65" <%=TD_STYLE11%> class="TD_STYLE7" width="8%"><%=demo.getLang("erp","推荐配送产品集合")%> &nbsp; </td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%" ><%=rs.getString("recommend_products")%>&nbsp;</td>
 ...
 <td <%=TD_STYLE11%> class="TD_STYLE1" width="8%"><%=exchange.toHtml(demo.getLang("erp","最近联络时间"))%></td>
