...
<div id="nseerGround" class="nseerGround">
 <form id="mutiValidation" class="x-form" method="post" action="../../logistics_file_register_ok" onSubmit="return doValidate('../../xml/logistics/logistics_file.xml','mutiValidation')">
  <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDraft("'mutiValidation','../../logistics_file_register_draft_ok','../../xml/logistics/logistics_file.xml'",request)%>&nbsp;<input type="submit" class="SUBMIT_STYLE1" <%=SUBMIT_STYLE1%> value="<%=demo.getLang("erp","提交")%>" name="B1"> <input type="reset" class="RESET_STYLE1" <%=RESET_STYLE1%> value="<%=demo.getLang("erp","清除")%>"></div>
 </td>
 </tr>
</table>
<%
...
style="width:80%" name="provider_name"><a href="javascript:ajax_validation('mutiValidation','validator_dup','logistics_file','provider_name','../../vdf','provider_ID','query.jsp',this)" 
