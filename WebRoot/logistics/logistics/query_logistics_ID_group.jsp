...
<%
String logistics_ID_group=request.getParameter("logistics_ID") ;
StringTokenizer tokenTO = new StringTokenizer(logistics_ID_group,", "); 
 while(tokenTO.hasMoreTokens()) {
				String logistics_ID=tokenTO.nextToken();
try{
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><%=exchange.toHtml(rs.getString("order_ID"))%>&nbsp;</td>
 </tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
