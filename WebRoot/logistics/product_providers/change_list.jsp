...
nseer_grid.column_width=[180,180,200,100,160,50];
...
['<%=rs1.getString("product_logistics_recommend_ID")%>','<%=rs1.getString("product_ID")%>','<%=exchange.toHtml(rs1.getString("product_name"))%>','<%=exchange.toHtml(rs1.getString("chain_name"))%>','<%=exchange.toHtml(register_time)%>','<div style="text-decoration : underline;color:#3366FF" onclick=id_link("change.jsp?product_logistics_recommend_ID=<%=rs1.getString("product_logistics_recommend_ID")%>")><%=demo.getLang("erp","变更")%></div>'],
