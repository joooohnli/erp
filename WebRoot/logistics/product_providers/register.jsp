...
<form id="mutiValidation" method="POST" action="../../logistics_product_providers_register_ok" onSubmit="return doValidate('../../xml/logistics/logistics_product_providers_recommend.xml','mutiValidation')">
<%
int i=1;
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="winopen('register_provider_list.jsp')" value="<%=demo.getLang("erp","添加")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="delSelect()" value="<%=demo.getLang("erp","删除")%>"><%=DgButton.getDraft("'mutiValidation','../../logistics_product_providers_register_draft_ok','../../xml/logistics/logistics_product_providers_recommend.xml'",request)%>&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","确认")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="history.back()" value="<%=demo.getLang("erp","返回")%>"></div></td>
 </tr>
 </table> 
...
<input name="chain_name" type="hidden" value="<%=exchange.toHtml(rs4.getString("chain_name"))%>">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="89%" colspan="3"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="recommender" style="width:44.8%"></td>
 </tr>
  </table>
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<thead>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="11%"><%=demo.getLang("erp","所在区域")%></td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE4%> class="INPUT_STYLE4" 
 name="type" onFocus="this.blur()"></td>
