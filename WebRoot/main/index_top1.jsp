...
String sqld="select * from document_main where value='开发管理' order by id";
	...
	sqla = "select * from document_main where value!='开发管理' AND (reason='stock' OR reason='drugstore') order by id";
}else{
	sqla = "select * from document_main where value!='开发管理' AND (reason='stock' OR reason='drugstore') and fieldType_tag='1' order by id";
}
...
<tr>
  ...
  <%String sql="";
	if(field_type.equals("0")){
	sql = "select * from document_main where value!='开发管理' AND (reason='stock' OR reason='drugstore') order by id";
}else{
	sql = "select * from document_main where value!='开发管理' AND (reason='stock' OR reason='drugstore') and fieldType_tag='1' order by id";
}
