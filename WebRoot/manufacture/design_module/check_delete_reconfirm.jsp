...
<form id="register1" class="x-form" method="POST" action="../../manufacture_design_module_check_delete_ok">
...
String check_suggestion=request.getParameter("check_suggestion");
...
<input name="check_suggestion" type="hidden" value="<%=check_suggestion%>">
...
<div id="nseerGround" class="nseerGround">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2" cellpadding="2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2" cellpadding="2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","该设计单未通过审核，您确认吗？请选择处理：")%></td>
	</tr>
 <%
int i=1;
String sql6="select config_id from manufacture_workflow where object_ID='"+design_ID+"' and type_id='02' and config_id<'"+config_id+"' order by id";
