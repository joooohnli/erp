...
if(rs.getString("design_module_tag").equals("0")||(rs.getString("design_module_tag").equals("1"))){
check_tag="等待";
...
design_tag="等待";
}else if(rs.getString("check_tag").equals("1")&&rs.getString("excel_tag").equals("2")&&(rs.getString("design_module_tag").equals("1")||rs.getString("design_module_tag").equals("3"))&&rs.getString("design_module_change_tag").equals("1")){
design_tag="执行";
...
%>
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value=<%=demo.getLang("erp","打印")%> onClick="javascript:winopen('query_print.jsp?design_ID=<%=design_ID%>')">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="返回" onClick="history.back()"></td> 
 </tr>
</table>
...
<tr <%=TR_STYLE2%> class="TR_STYLE2">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="8%"><%=demo.getLang("erp","查看")%></td>
 </tr>
<%
int i=1;
...
<%if(rs6.getString("design_module_tag").equals("1")){%>
