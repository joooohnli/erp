...
%>
<form id="register1" method="POST" action="register_module_again_list.jsp">
...
<input name="product_ID" type="hidden" value="<%=product_ID%>">
 ...
 <table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE2%> class="TD_STYLE2"><font color="red"><%=demo.getLang("erp","重新设计将首先清除原有本工序物料的设计，您确认进行重新设计吗？")%></td>
</table>
