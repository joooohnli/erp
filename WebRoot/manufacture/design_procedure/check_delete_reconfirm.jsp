...
<form class="x-form" method="post" action="../../manufacture_design_procedure_check_delete_ok">
...
<input type="hidden" name="product_ID" value="<%=product_ID%>">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10"><%=demo.getLang("erp","该设计单未通过审核，您确认吗？请选择处理：")%></td>
 </tr>
 <%
int i=1;
String sql6="select config_id from manufacture_workflow where object_ID='"+design_ID+"' and type_id='01' and config_id<'"+config_id+"' order by id";
