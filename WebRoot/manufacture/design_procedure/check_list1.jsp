...
String sql="select count(id) from manufacture_config_workflow where type_id='01'";
...
nseer_grid.auto='<%=demo.getLang("erp","设计单编号")%>';
nseer_grid.data = [
...
String sql1="select id from manufacture_workflow where object_ID='"+rs.getString("design_ID")+"' and check_tag='0' and type_id='01'";
ResultSet rs2=manufacture_db1.executeQuery(sql1);
if(rs2.next()){
	sql1="select check_tag,describe1,config_id from manufacture_workflow where object_ID='"+rs.getString("design_ID")+"' and type_id='01' order by id";
