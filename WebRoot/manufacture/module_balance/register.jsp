...
<tr <%=TR_STYLE2%> class="TR_STYLE2">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="5%"><%=demo.getLang("erp","登记")%></td>
 </tr>
<%
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=exchange.toHtml(rs6.getString("procedure_name"))%>&nbsp;</td>
	 ...
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=rs6.getDouble("real_labour_hour_amount")%>&nbsp;</td>
...
<%if(rs6.getString("procedure_details_tag").equals("2")){%>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","完成")%></td>
<%}else{%>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="register_procedure_module.jsp?manufacture_ID=<%=rs6.getString("manufacture_ID")%>&&procedure_name=<%=toUtf8String.utf8String(exchange.toURL(rs6.getString("procedure_name")))%>&&procedure_ID=<%=rs6.getString("procedure_ID")%>"><%=demo.getLang("erp","登记")%></a>&nbsp;</td>
<%}%>
	</tr>
<%
	}
