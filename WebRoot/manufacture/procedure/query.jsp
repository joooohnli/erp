...
if(rs.getString("manufacture_procedure_tag").equals("1")&&rs.getString("manufacture_tag").equals("0")){
manufacture_tag="执行";
color="mediumseagreen";
}else if(rs.getString("manufacture_tag").equals("1")){
manufacture_tag="完成";
color="3333FF";
}else if(rs.getString("manufacture_procedure_tag").equals("0")&&rs.getString("manufacture_tag").equals("0")){
manufacture_tag="等待";
}
...
if(rs6.getString("procedure_finish_tag").equals("0")){
procedure_details_tag="等待";
}else if(rs6.getString("procedure_finish_tag").equals("1")){
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="javascript:winopen('query_procedure_details.jsp?manufacture_ID=<%=rs6.getString("manufacture_ID")%>&&procedure_name=<%=exchange.toURL(rs6.getString("procedure_name"))%>')"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs6.getDouble("real_subtotal"))%>&nbsp;</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs6.getDouble("module_subtotal"))%>&nbsp;</td>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="javascript:winopen('query_module_details.jsp?manufacture_ID=<%=rs6.getString("manufacture_ID")%>&&procedure_name=<%=exchange.toHtml(rs6.getString("procedure_name"))%>')"><%=new java.text.DecimalFormat((String)application.getAttribute("nseerPrecision")).format(rs6.getDouble("real_module_subtotal"))%>&nbsp;</td>
