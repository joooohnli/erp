...
<TABLE <%=TABLE_STYLE5%> class="TABLE_STYLE5">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="7%"><%=demo.getLang("erp","工序登记")%></td>
...
<%if(rs6.getString("procedure_check_tag").equals("0")&&!rs6.getString("procedure_details_tag").equals("2")){%>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="register_procedure_details.jsp?manufacture_ID=<%=rs6.getString("manufacture_ID")%>&&procedure_name=<%=toUtf8String.utf8String(exchange.toURL(rs6.getString("procedure_name")))%>&&procedure_id=<%=toUtf8String.utf8String(exchange.toURL(rs6.getString("procedure_id")))%>&&details_number=<%=toUtf8String.utf8String(exchange.toURL(rs6.getString("details_number")))%>"><%=demo.getLang("erp","登记")%></a></td>
<%}else if(rs6.getString("procedure_check_tag").equals("1")&&!rs6.getString("procedure_details_tag").equals("2")){
		 %>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><font color="#FF9A31"><%=demo.getLang("erp","等待审核")%></font></td>
<%}else if(rs6.getString("procedure_details_tag").equals("2")){%>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","完成")%></td>
<%}
if(rs6.getString("procedure_transfer_tag").equals("2")&&rs6.getString("procedure_finish_tag").equals("1")){ 
	 %>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="register_procedure_transfer.jsp?manufacture_ID=<%=rs6.getString("manufacture_ID")%>&&procedure_name=<%=toUtf8String.utf8String(exchange.toURL(rs6.getString("procedure_name")))%>&&details_number=<%=toUtf8String.utf8String(exchange.toURL(rs6.getString("details_number")))%>"><%=demo.getLang("erp","交接登记")%></a></td>
<%}else if(rs6.getString("procedure_transfer_tag").equals("3")&&rs6.getString("procedure_finish_tag").equals("1")){%>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><font color="#FF9A31"><%=demo.getLang("erp","待审核")%></font></td>
