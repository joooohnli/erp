...
<table <%=TABLE_STYLE1%> class="TABLE_STYLE1" width="100%" id=theObjTable>
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","设计单编号")%> </td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37.4%"><%=design_ID%></td>
	 <td <%=TD_STYLE1%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","工序名称")%> </td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37.4%"><%=exchange.toHtml(procedure_name)%></td>
 </tr>
</table>
<table <%=TABLE_STYLE1%> class="TABLE_STYLE1" width="100%" id=theObjTable>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE1%> class="TD_STYLE1" width="9%"><%=demo.getLang("erp","用途类型")%> </td>
	 <td <%=TD_STYLE1%> class="TD_STYLE1" width="9%"><%=demo.getLang("erp","工序数量")%></td>
...
try{
	...
	while(rs1.next()){
		...
		double subtotal=rs1.getDouble("cost_price")*module_amount;
%>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<td <%=TD_STYLE2%> class="TD_STYLE2"><%=rs1.getString("type")%>&nbsp;</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=rs1.getString("product_describe")%>&nbsp;</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=module_amount%>&nbsp;</td>
