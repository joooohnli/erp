...
String messager_type=request.getParameter("fason");
...
%>
<FORM METHOD="POST" id="keyRegister" name="selectList" ACTION="../../oa_intrmessage_check_ok">
...
<input type="hidden" name="messager_type" value="<%=exchange.toHtml(messager_type)%>">
