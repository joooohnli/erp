...
<form id="mutiValidation" method="POST" action="../../oa_intrmessage_register_ok" onSubmit="return doValidate('../../xml/oa/oa_intrmessage.xml','mutiValidation')" ENCTYPE="multipart/form-data">
...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="89%"><select <%=SELECT_STYLE1%> class="SELECT_STYLE1" name="intrmessage_type" style="width: 50%;height: 14">
<%
...
%>
</select><input type="radio" name="bulletin" value="1"><%=demo.getLang("erp","发布外部公告")%></td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
