...
<form class="x-form" method="post" action="../../oa_knowledge_check_delete_ok">
...
<%
int i=1;
String sql6="select config_id from oa_workflow where object_ID='"+knowledge_ID+"' and type_id='04' and config_id<'"+config_id+"' order by id";
