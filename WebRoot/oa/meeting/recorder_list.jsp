...
String nickName="会议";
String fileName="recorder_list.jsp";
String rowSummary=demo.getLang("erp","当前等待整理纪要的会议总数：");
%>
