...
<form id="mutiValidation" method="POST" action="../../oa_message_register_ok" onSubmit="return doValidate('../../xml/oa/oa_message.xml','mutiValidation')" ENCTYPE="multipart/form-data">
...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="89%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" style="width:50%" name="subject"></td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE1%> class="TD_STYLE8" width="9%"><%=demo.getLang("erp","消息类型")%>：</td>
<td <%=TD_STYLE2%> class="TD_STYLE2" width="89%"><select <%=SELECT_STYLE1%> class="SELECT_STYLE1" name="message_type" style="width: 50%;height: 14">
<%
String sql5 = "select * from oa_config_public_char where kind='消息分类' order by type_name" ;
...
%>
</select><input type="radio" name="bulletin" value="1"><%=demo.getLang("erp","发布内部公告")%></td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
%>
<td <%=TD_STYLE2%> class="TD_STYLE2" colspan="2"><textarea id="content" name="content" cols="122" rows="30"></textarea>
...
<%}else{%>
<td <%=TD_STYLE2%> class="TD_STYLE2" colspan="2"><textarea style="width:100%" id="content" name="content" cols="122" rows="30"></textarea></td>
<%}%>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE1%> class="TD_STYLE8" width="9%"><%=demo.getLang("erp","备注")%>&nbsp;&nbsp;&nbsp;&nbsp;：</td> 
<td <%=TD_STYLE2%> class="TD_STYLE2" width="89%"><textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="remark"></textarea></td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
