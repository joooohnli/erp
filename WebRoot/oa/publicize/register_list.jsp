...
%>
 ...
 <div <%=DIV_STYLE1%> class="DIV_STYLE1">
  <table width="100%" height="540" width="100%" bordercolorlight=#333333 bordercolordark=#efefef>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
  <td align="left"><%=demo.getLang("erp","当前等待制定的计划总数：")%><%=intRowCount%><%=demo.getLang("erp","例")%></td>
			 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="添加" onClick=location="register.jsp"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 	 <td <%=TD_STYLE1%> class="TD_STYLE1" width="80%"><%=demo.getLang("erp","会议主题")%></td>
 <td <%=TD_STYLE1%> class="TD_STYLE1" width="6%"><%=demo.getLang("erp","制定")%></td>
 </tr>
<page:pages rs="<%=rs%>" strPage="<%=strPage%>">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
	 <td <%=TD_STYLE2%> class="TD_STYLE2" width="80%"><%=rs.getString("meeting_subject")%></td>
