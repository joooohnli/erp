...
String sql="select * from oa_regulation where regulation_ID='"+regulation_ID+"' and check_tag='1'";
ResultSet rs=oa_db.executeQuery(sql);
if(rs.next()){
%>
<form id="subjectRegister" method="POST" action="../../oa_regulation_change_ok?regulation_ID=<%=regulation_ID%>"  ENCTYPE="multipart/form-data" onSubmit="return doValidate('../../xml/oa/oa_regulation.xml','mutiValidation')">
...
<table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","该制度已变更且未审核，请返回！")%></td>
 </tr>
</table>
</div>
<%}
