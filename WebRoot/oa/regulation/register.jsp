...
<form id="mutiValidation" method="POST" action="../../oa_regulation_register_ok" onSubmit="return doValidate('../../xml/oa/oa_regulation.xml','mutiValidation')" ENCTYPE="multipart/form-data">
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><%=DgButton.getDraft("'mutiValidation','../../oa_regulation_register_draft_ok','../../xml/oa/oa_regulation.xml'",request)%>&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","提交")%>"></div></td>
</tr>
</table>
<%
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE1%> class="TD_STYLE8" width="9%"><%=demo.getLang("erp","制度主题")%>：</td>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="9%"><%=demo.getLang("erp","制度类型")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><select <%=SELECT_STYLE1%> class="SELECT_STYLE1" name="regulation_type">
<%
String sql5 = "select * from oa_config_public_char where kind='制度分类' order by type_name" ;
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE1%> class="TD_STYLE8" width="9%"><%=demo.getLang("erp","制度内容")%>：</td>
...
<script type='text/javascript' src="../../javascript/oa/regulation/treeBusiness.js"></script>
...
function showTree(){
 ...
 Nseer_tree1.setModuleName('../../xml/oa/regulation');
 Nseer_tree1.addRootNode('No0','<%=demo.getLang("erp","全部分类")%>',false,'1',[]);
initMyTree(Nseer_tree1);
createButton('../../xml/oa/regulation','hr_config_file_kind','treeButton');
}
</script>