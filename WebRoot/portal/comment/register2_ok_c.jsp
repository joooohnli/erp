...
<table width="930" height="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	...
	<tr>
        <td width="930" class="STYLE1">&nbsp;&nbsp;<%=demo.getLang("erp","首页")%>&gt;&gt;<%=demo.getLang("erp","我要留言")%></td>
      </tr>
      <tr>
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","该分类未定义发布审核流程，请返回确认！")%></td>
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick=location="register2.jsp"></div></td>
 </tr>
 </table>
</td>
  </tr>
