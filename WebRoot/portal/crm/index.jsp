...
<table width="930" height="680" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	...
	<tr>
        <td width="50%" class="STYLE1">&nbsp;&nbsp;<%=demo.getLang("erp","首页")%>&gt;&gt;<%=demo.getLang("erp","伙伴信息")%></td>
		<td align="right"><a href="register1.jsp"><font color="#000000" size="2"><%=demo.getLang("erp","注册客户信息")%></font></a>&nbsp;&nbsp;<a href="register2.jsp"><font color="#000000" size="2"><%=demo.getLang("erp","我要购买")%></font></a>&nbsp;&nbsp;<a href="../self/index.jsp"><font color="#000000" size="2"><%=demo.getLang("erp","自助服务")%></font></a></td>
      </tr>
      <tr>
...
String trade="";
if(timea==null||timeb==null||first_kind_name==null||second_kind_name==null||third_kind_name==null||trade==null||type==null){
...
ResultSet rs=query.queryDB(dbase,tablename,timea,timeb,first_kind_name,second_kind_name,third_kind_name,trade,fieldName1,fieldName2,fieldName3,fieldName4,fieldName5,condition,queue,realname);
int pageSize=25;
...
<page:pages rs="<%=rs%>" strPage="<%=strPage%>">
      <a href="index_details.jsp?id=<%=rs.getString("id")%>" target="_blank"><%=rs.getString("customer_ID")%>--<%=exchange.toHtml(rs.getString("customer_name"))%>--<%=exchange.toHtml(rs.getString("chain_name"))%></a><br/>
</page:pages>
</td>
      </tr>
      <tr>
