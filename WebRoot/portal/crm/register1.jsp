...
<tr>
	  ...
	  <tr><td>
<form id="mutiValidation" class="x-form" method="post" action="../../portal_crm_register1_ok" onSubmit="return doValidate('../../xml/crm/crm_file.xml','mutiValidation')">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <select <%=SELECT_STYLE1%> class="SELECT_STYLE1" name="type" style="width:45%">
		<option value="合作伙伴"><%=demo.getLang("erp","合作伙伴")%></option>
  </select>
</tr>
