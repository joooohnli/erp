...
<table width="930" height="500" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="710" valign="top"><table width="711" border="0">
	<tr>
        <td width="660" class="STYLE1">&nbsp;&nbsp;<%=demo.getLang("erp","首页")%>&gt;&gt;<%=demo.getLang("erp","注册伙伴信息")%></td>
      </tr>
      <tr>
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","对不起，客户名称重复，请返回确认！")%></td>
	 <td <%=TD_STYLE3%> class="TD_STYLE3">
	 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" style="width: 50; " onClick=location="register1.jsp"></div></td>
 </tr>
 </table>
</td>
  </tr>
