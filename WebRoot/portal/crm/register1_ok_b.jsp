...
<table width="930" height="500" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<tr>
      ...
      <tr>
        <td><img src="../images/list.jpg" width="750" height="2" /></td>
      </tr>
	  <tr><td>
 <table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","分类或客户经理错误，请重新登记！")%></td>
	 <td <%=TD_STYLE3%> class="TD_STYLE3">
	 <div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value=<%=demo.getLang("erp","返回")%> style="width: 60; " onClick=location="register1.jsp"></div></td>
 </tr>
 </table>
</td>
  </tr>
