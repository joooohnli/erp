...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><input name="customer_ID" id="validator_dup" type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" onblur="ajax_validation('mutiValidation','validator_dup','crm_file','customer_ID','../../vd8p',this)"></td>
