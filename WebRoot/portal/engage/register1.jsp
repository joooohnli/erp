...
<table width="930" border="0" align="center" bgcolor="#FFFFFF">
	<tr>
	  ...
	  <tr><td>
<form id="mutiValidation" method="POST" action="../../portal_engage_register1_picture" onSubmit="return doValidate('../../xml/hr/hr_resume.xml','mutiValidation')">    
...
%>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input name="register_time" type="hidden" value="<%=exchange.toHtml(time)%>"><%=exchange.toHtml(time)%></td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
