...
nseer_db hr_db = new nseer_db("ondemand1");
...
<form id="mutiValidation" method="POST" action="../../portal_engage_register2_picture" onSubmit="return doValidate('../../xml/hr/hr_resume.xml','mutiValidation')">
<table width="890" bgcolor="#FFFFFF" align="center" >
...
%>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><input name="register_time" type="hidden" value="<%=exchange.toHtml(time)%>" style="width:49%"><%=exchange.toHtml(time)%></td>
 </tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE1%> class="TD_STYLE7" height="65" width="11%"><%=demo.getLang("erp","个人履历")%>  </td>
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="history_records"></textarea>
</td>
 <td <%=TD_STYLE1%> class="TD_STYLE7" height="65" width="11%"><%=demo.getLang("erp","备注")%>  </td>
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
