...
<table width="930" height="680" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	...
	<tr>
        <td width="50%" class="STYLE1">&nbsp;&nbsp;<%=demo.getLang("erp","首页")%>&gt;&gt;<%=demo.getLang("erp","配送信息")%></td>
		<td align="right"><a href="register1.jsp"><font color="#000000" size="2"><%=demo.getLang("erp","注册配送单位信息")%></font></a>&nbsp;&nbsp;<a href="register2.jsp"><font color="#000000" size="2"><%=demo.getLang("erp","我能配送")%></font></a>&nbsp;&nbsp;<a href="../self/index.jsp"><font color="#000000" size="2"><%=demo.getLang("erp","自助服务")%></font></a></td>
      </tr>
      <tr>
...
String condition="";
if(type.equals("111")){
	condition="check_tag='1' and excel_tag4='3' and type!='物料' and type!='服务型产品'";
}else{
	condition="check_tag='1' and excel_tag4='3' and type='"+type+"'";
}
