...
<table width="930" height="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	...
	<tr>
        <td width="930" class="STYLE1">&nbsp;&nbsp;<%=demo.getLang("erp","首页")%>&gt;&gt;<%=demo.getLang("erp","我能配送")%></td>
      </tr>
      <tr>
...
<form id="mutiValidation" method="POST" action="register2_reconfirm.jsp" onSubmit="return doValidate('../../xml/logistics/logistics_discussion.xml','mutiValidation')">
...
<%@include file="../include/paper_top.html"%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input name="provider_ID" id="validator_dup" type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" onblur="ajax_validation('mutiValidation','validator_dup','logistics_file','provider_ID','../../vd8p',this)"></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="13%"><%=demo.getLang("erp","电话")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%">
 <input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="demand_contact_person_tel"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input type="hidden" name="register_time" <%=INPUT_STYLE3%> class="INPUT_STYLE3" value="<%=exchange.toHtml(time)%>"><%=exchange.toHtml(time)%></td>
 </tr>
...
<thead>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="13%"><%=demo.getLang("erp","运费（元）")%></td>
...
<td <%=TD_STYLE2%> class="TD_STYLE2"><span name="product_describe_ok" style="width:120px;background:#ffffff"></span><input type="hidden" name="product_describe" onFocus="this.blur()"></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="amount" value="1" style="background-color:#FFFFCC"></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="amount_unit" onFocus="this.blur()"></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE5%> class="INPUT_STYLE5" name="list_price" value="1"><input name="cost_price" type="hidden"><input name="real_cost_price" type="hidden"></td>
