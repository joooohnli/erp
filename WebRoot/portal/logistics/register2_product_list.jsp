...
String condition="check_tag='1' and type!='物料' and type!='服务型产品'";
...
<table height="30%" width="930" border="0"  bgcolor="#FFFFFF">
<tr width=100%>
<td width=100%>&nbsp;&nbsp;<div align="center" id="nseer_grid_div" style="width:930px;"></div></td>
</tr>
