...
<form id="mutiValidation" method="POST" action="register2_reconfirm.jsp" onSubmit="return doValidate('../../xml/intrmanufacture/intrmanufacture_discussion.xml','mutiValidation')">
...
<TABLE <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="15%"><%=demo.getLang("erp","委外厂商编号")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="35%"><input name="provider_ID" id="validator_dup" type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" onblur="ajax_validation('mutiValidation','validator_dup','intrmanufacture_file','provider_ID','../../vd8p',this)"></td>
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="15%"><%=demo.getLang("erp","委外加工时间")%>：</td>
...
<thead>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="13%"><%=demo.getLang("erp","加工费（元）")%></td>
...
<td <%=TD_STYLE2%> class="TD_STYLE2"><span name="product_describe_ok" style="width:120px;background:#ffffff"></span><input type="hidden" name="product_describe" onFocus="this.blur()"></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="amount" style="background-color:#FFFFCC"></td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="off_discount" value="0" style="background-color:#FFFFCC"></td>
 </tr>
</thead>
<table>
