...
<table width="930" height="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	...
	<tr>
        <td width="930" class="STYLE1">&nbsp;&nbsp;<%=demo.getLang("erp","首页")%>&gt;&gt;<%=demo.getLang("erp","注册供应商信息")%></td>
      </tr>
      <tr>
        <td align="center"><img src="../images/list.jpg" width="780" height="2" /></td>
      </tr>
	  <tr><td>
<form id="mutiValidation" class="x-form" method="post" action="../../portal_purchase_register1_ok" onSubmit="return doValidate('../../xml/purchase/purchase_file.xml','mutiValidation')">
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="37.4%"><input id="validator_dup" type="text" <%=INPUT_STYLE1%> class="INPUT_STYLE1" style="width:80%" name="provider_name"><a href="javascript:ajax_validation('mutiValidation','validator_dup','purchase_file','provider_name','../../vdf','provider_ID','../../purchase/file/query.jsp',this)" 
...
<input name="register_time" type="hidden" width="100%" value="<%=exchange.toHtml(time)%>">
<input type="hidden" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="purchaser" >
<input type="hidden" <%=INPUT_STYLE1%> class="INPUT_STYLE1" name="purchaser_ID">
