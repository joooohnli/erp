...
<%nseer_db purchase_db = new nseer_db("ondemand1");%>
...
<table width="930" height="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	...
	<tr>
        <td width="930" class="STYLE1">&nbsp;&nbsp;<%=demo.getLang("erp","首页")%>&gt;&gt;<%=demo.getLang("erp","我能供应")%></td>
      </tr>
      <tr>
...
<form id="mutiValidation" method="POST" action="register2_reconfirm.jsp" onSubmit="return doValidate('../../xml/purchase/purchase_discussion.xml','mutiValidation')">
 <table <%=TABLE_STYLE6%> class="TABLE_STYLE6" bgcolor="#FFFFFF">
...
%>
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="15%"><%=demo.getLang("erp","供应商编号")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="35%"><input name="provider_ID" id="validator_dup" type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" onblur="ajax_validation('mutiValidation','validator_dup','purchase_file','provider_ID','../../vd8p',this)"></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="15%"><%=demo.getLang("erp","电话")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="35%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="demand_contact_person_tel"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="15%"><%=demo.getLang("erp","拟供货时间")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="35%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="demand_pay_time" onfocus="" id="date_start"></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="15%"><%=demo.getLang("erp","登记时间")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="35%"><input type="hidden" name="register_time" <%=INPUT_STYLE3%> class="INPUT_STYLE3" value="<%=exchange.toHtml(time)%>"><%=exchange.toHtml(time)%></td>
 </tr>
...
<thead>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="11%"><%=demo.getLang("erp","点选")%></td>
...
<td <%=TD_STYLE2%> class="TD_STYLE2"><span name="product_describe_ok" style="width:120px;background:#ffffff"></span><input type="hidden" name="product_describe" onFocus="this.blur()"></td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE4%> class="INPUT_STYLE4" name="list_price" onFocus="this.blur()" value="1"><input name="cost_price" type="hidden"><input name="real_cost_price" type="hidden"></td>
