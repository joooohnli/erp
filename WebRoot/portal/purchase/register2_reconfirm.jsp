...
if(p==0){
%>
<form id="register2" method="POST" action="../../portal_purchase_register2_ok">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="13%"><%=demo.getLang("erp","供应商编号")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input name="provider_ID" type="hidden" width="100%" <%=INPUT_STYLE3%> class="INPUT_STYLE3" value="<%=provider_ID%>"><%=provider_ID%></td>
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="13%"><%=demo.getLang("erp","拟供货时间")%>：</td>
