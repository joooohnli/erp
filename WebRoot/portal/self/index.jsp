...
<table width="930" height="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
	...
	<tr>
        <td width="600" class="STYLE1">&nbsp;&nbsp;<%=demo.getLang("erp","首页")%>&gt;&gt;<%=demo.getLang("erp","自助服务")%></td>
      </tr>
      <tr>
...
<img src="../../images/nseer_extend.gif" width="100" height="100" hspace="1">
</td>
<td <%=TD_STYLE3%> class="TD_STYLE3">
<%=demo.getLang("erp","正在建设中")%>......
</td>
</table>
</td>
  </tr>
