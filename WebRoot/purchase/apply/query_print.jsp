...
<%
	int count=0;
	String sql5="select count(*) from purchase_apply where apply_ID='"+apply_ID+"'";
...
if(count>20){
	int m=1;
String sql6="select * from purchase_apply where apply_ID='"+apply_ID+"'";
...
%>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
     ...
     <td colspan="3" <%=TD_STYLE2%> class="TD_STYLE2"><%=exchange.toHtml(rs6.getString("pay_ID_group"))%>&nbsp;</td>
 </tr>
<%
	m++;
	}
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=exchange.toHtml(rs6.getString("product_name"))%>&nbsp;</td>
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=rs6.getString("product_describe")%>&nbsp;</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=rs6.getDouble("amount")%>&nbsp;</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" colspan="3"><%=exchange.toHtml(rs6.getString("pay_ID_group"))%>&nbsp;</td>
 </tr>
<%
	m++;
}
