...
<% 
 String sql = "select * from purchase_config_public_char where kind='供应商级别' order by type_ID";
...
nseer_grid.columns =[
                       {name: '&nbsp;'},
                       {name: '<%=demo.getLang("erp","供应商优质级别名称")%>'}
                  ]
nseer_grid.column_width=[40,180];
nseer_grid.auto='<%=demo.getLang("erp","供应商优质级别名称")%>';
nseer_grid.data = [
