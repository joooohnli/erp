...
<input name="validator.form" type="hidden" value="mutiValidation">
<form id="mutiValidation" method="POST" action="../../purchase_contact_register_ok" onSubmit="return doValidate('../../xml/purchase/purchase_contact.xml','mutiValidation')">
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8">&nbsp;<%=DgButton.getDraft("'mutiValidation','../../purchase_contact_register_draft_ok','../../xml/purchase/purchase_contact.xml'",request)%>&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","提交")%>">&nbsp;<input type="reset" <%=RESET_STYLE1%> class="RESET_STYLE1" value="<%=demo.getLang("erp","清除")%>"></td>
 </tr>
</table>
<%
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input name="person_contacted" type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" value="<%=exchange.toHtml(contact_person1)%>"></td> 
 </tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td class="TD_STYLE8" width="13%" <%=TD_STYLE1%>><%=demo.getLang("erp","联络理由编号")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input name="provider_ID" type="hidden" width="100%" value="<%=provider_ID%>"><input name="reasonexact" type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" value="<%=reasonexact%>"></td>
</tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1"> 
