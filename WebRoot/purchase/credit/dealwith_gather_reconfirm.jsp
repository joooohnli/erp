...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="13%"><input name="provider_ID" type="hidden" width="100%" value="<%=provider_ID%>"><%=provider_ID%></td>
	 <td colspan="2" <%=TD_STYLE1%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","电话")%></td>
...
<input name="invoice_info" type="hidden">
 ...
 <td colspan="2" <%=TD_STYLE1%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","登记人")%></td>
...
<td <%=TD_STYLE2%> class="TD_STYLE2" colspan="8" width="86.5%">
