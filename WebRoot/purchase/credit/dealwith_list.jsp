...
function id_link1(provider_ID,provider_name,purchaser_ID,purchaser,purchasecredit_cost_price_sum){ 
 var link1='dealwith_getpara.jsp?provider_ID='+provider_ID+'&&provider_name='+provider_name+'&&purchaser_ID='+purchaser_ID+'&&purchaser='+purchaser+'&&purchasecredit_cost_price_sum='+purchasecredit_cost_price_sum;
