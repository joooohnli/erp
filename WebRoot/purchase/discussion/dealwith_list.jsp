...
String condition="discussion_tag!='2' and check_tag='1' and gar_tag='0'";
String queue="order by register_time";
String validationXml="../../xml/purchase/purchase_discussion.xml";
String nickName="报价单";
String fileName="dealwith_list.jsp";
String rowSummary=demo.getLang("erp","当前可处理的报价单总数");
int k=1;
%>
...
nseer_grid.column_width=[180,200,100,100,100,70];
