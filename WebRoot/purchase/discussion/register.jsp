...
<form id="mutiValidation" method="POST" action="register_reconfirm.jsp" onSubmit="return doValidate('../../xml/purchase/purchase_discussion.xml','mutiValidation')">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="40%"><input name="provider_ID" type="hidden" value="<%=provider_ID%>"><%=provider_ID%></td>
</tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
