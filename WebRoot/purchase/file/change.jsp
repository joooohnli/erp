...
if(vt.validata((String)session.getAttribute("unit_db_name"),"purchase_file","id",id,"check_tag").equals("1")){
try{
	String sqll = "select * from purchase_file where id="+id+"" ;
...
<form id="mutiValidation" class="x-form" method="post" action="../../purchase_file_change_ok?id=<%=rss.getString("id")%>" onSubmit="return doValidate('../../xml/purchase/purchase_file.xml','mutiValidation')">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
%>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="13%" colspan="3"><a href="javascript:winopenm('query_attachment.jsp?id=<%=rss.getString("id")%>&tablename=purchase_file&fieldname=attachment_name')">
...
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="invoice_info"><%=invoice_info%></textarea>
 ...
 <td <%=TD_STYLE4%> class="TD_STYLE7" width="13%" height="65"><%=demo.getLang("erp","可供应产品集合")%> &nbsp; </td>
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="demand_products"><%=demand_products%></textarea>
</td>
 </tr>
	 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE4%> class="TD_STYLE7" width="13%" height="65"><%=demo.getLang("erp","推荐供应产品集合")%> &nbsp; </td>
<td <%=TD_STYLE21%> class="TD_STYLE2" width="13%">
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="recommend_products"><%=recommend_products%></textarea></td>
