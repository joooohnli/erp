...
String sql9="select * from purchase_workflow where object_ID='"+provider_ID+"' and check_tag='0' and config_id<'"+config_id+"'";
ResultSet rs9=purchasedb.executeQuery(sql9);
if(!rs9.next()){
if(vt.validata((String)session.getAttribute("unit_db_name"),"purchase_file","provider_ID",provider_ID,"check_tag").equals("0")){
try{
...
form.action = "../../purchase_file_check_ok?config_id=<%=config_id%>&provider_ID=<%=provider_ID%>";
}
}
</script>
<div id="nseerGround" class="nseerGround">
<form id="mutiValidation" class="x-form" method="post" onSubmit="return doValidate('../../xml/purchase/purchase_file.xml','mutiValidation')&&TwoSubmit(this)">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td colspan="7" <%=TD_STYLE21%> class="TD_STYLE2" width="13%"><a href="javascript:winopenm('query_attachment.jsp?id=<%=rss.getString("id")%>&tablename=purchase_file&fieldname=attachment_name')">
