...
<tr style="background-image:url(../../images/line.gif)"><td colspan="4"><div style="width:100%; height:12; padding:3px; "><%=demo.getLang("erp","主信息")%></div></td></tr>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="<%=provider_web%>" target="_blank"><%=exchange.toHtml(provider_web)%></a>&nbsp;</td>
 </tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="18%" height="65"><%=rs.getString("invoice_info")%>&nbsp;</td>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"></a>&nbsp;</td>
...
%>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="javascript:winopenm('query_attachment.jsp?id=<%=rs.getString("id")%>&tablename=purchase_file&fieldname=attachment_name')">
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="18%" height="65">&nbsp;</td>
 ...
 <td <%=TD_STYLE21%> class="TD_STYLE2" width="18%"><a href="../contact/query_list.jsp?keyword_chain=<%=rs.getString("provider_ID")%>"><%=exchange.toHtml(lately_contact_time)%></a>
 &nbsp;</td>
 </tr>
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
