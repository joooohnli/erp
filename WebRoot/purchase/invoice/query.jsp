...
int invoiced_percent1=(int)(rs.getDouble("invoiced_sum")/rs.getDouble("demand_cost_price_sum")*100);
String invoiced_percent=invoiced_percent1+"%";
%>
<table <%=TABLE_STYLE3%> class="TABLE_STYLE3">
 ...
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","打印")%>" onClick="javascript:winopen('query_print.jsp?purchase_ID=<%=purchase_ID%>')">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back();"></td>
 </tr>
</table>
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4" id=theObjTable>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="87%" colspan="3"><%=purchase_ID%></td>
 </tr>
		<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<%
	int i=1;
String sql6="select * from purchase_purchasing where purchase_ID='"+purchase_ID+"' and kind='发票' and check_tag='1' order by register_time";
