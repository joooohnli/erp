...
<%
	int count=0;
	String sql5="select count(*) from purchase_purchasing where purchase_ID='"+purchase_ID+"' and kind='发票' and check_tag='1'";
...
if(count>20){
	int m=1;
String sql6="select * from purchase_purchasing where purchase_ID='"+purchase_ID+"' and kind='发票' and check_tag='1'";
