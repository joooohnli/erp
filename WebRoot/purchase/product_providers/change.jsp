...
%>
<form id="mutiValidation" method="POST" action="../../purchase_product_providers_change_ok" onSubmit="return doValidate('../../xml/purchase/purchase_product_providers_recommend.xml','mutiValidation')">
...
<table <%=TABLE_STYLE6%> class="TABLE_STYLE6">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="winopen('register_provider_list.jsp')" value="<%=demo.getLang("erp","新添加")%>"> 
  <input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="delSelect()" value="<%=demo.getLang("erp","新删除")%>">&nbsp;<input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value="<%=demo.getLang("erp","重新提交")%>">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="history.back()" value="<%=demo.getLang("erp","返回")%>"></td>
 </tr>
 </table>
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><%=exchange.toHtml(rs7.getString("provider_tel1"))%>&nbsp;</td>
	 ...
	 <td <%=TD_STYLE2%> class="TD_STYLE2"><a href="../../purchase_product_providers_change_delete_details?id=<%=rs6.getString("id")%>&&product_providers_recommend_ID=<%=product_providers_recommend_ID%>"><%=demo.getLang("erp","删除")%></a></td>
 </tr>
<%
}else{
%>
