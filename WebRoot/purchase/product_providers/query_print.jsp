...
try{
String sql="select * from purchase_product_providers_recommend where product_providers_recommend_ID='"+product_providers_recommend_ID+"'";
...
<TABLE <%=TABLE_STYLE5%> class="TABLE_STYLE5">
 ...
 <td width="13%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","所在区域")%></td>
 <td width="11%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","优质级别")%></td>
	 <td width="13%" <%=TD_STYLE2%> class="TD_STYLE2"><%=demo.getLang("erp","电话")%></td>
...
<%
	int count=0;
	String sql5="select count(*) from purchase_product_providers_recommend_details where product_providers_recommend_ID='"+product_providers_recommend_ID+"'";
