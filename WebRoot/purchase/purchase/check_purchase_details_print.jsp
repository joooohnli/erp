...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37.4%" colspan="3"><%=rs6.getString("provider_name")%>&nbsp;</td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="13%"><%=rs6.getString("demand_gather_shipFee_sum")%>&nbsp;</td>
 ...
 <td <%=TD_STYLE1%> class="TD_STYLE1" width="11%"><%=demo.getLang("erp","申请采购数量")%></td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="13%"><%=rs6.getString("demand_amount")%>&nbsp;</td>
