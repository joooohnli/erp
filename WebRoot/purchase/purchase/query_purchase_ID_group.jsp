...
<%
String purchase_ID_group=request.getParameter("purchase_ID") ;
StringTokenizer tokenTO = new StringTokenizer(purchase_ID_group,", "); 
 while(tokenTO.hasMoreTokens()) {
				String purchase_ID=tokenTO.nextToken();
try{
