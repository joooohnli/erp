...
%>
	<td <%=TD_STYLE2%> class="TD_STYLE2"><a href="register_choose_attachment.jsp?provider_ID=<%=rs6.getString("provider_ID")%>&&purchase_ID=<%=purchase_ID%>"><%=demo.getLang("erp","上传附件")%></a></td>
<%}else{%>
	<td <%=TD_STYLE2%> class="TD_STYLE2"><a href="register_choose_attachment.jsp?provider_ID=<%=rs6.getString("provider_ID")%>&&purchase_ID=<%=purchase_ID%>"><font color="#0099cc"><%=demo.getLang("erp","重新上传附件")%></a></td>
<%}%>
 </tr>
<%
	}
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
	 <td <%=TD_STYLE1%> class="TD_STYLE8" width="13%"><%=demo.getLang("erp","采购申请数量")%>：</td>
	 ...
	 <td <%=TD_STYLE1%> class="TD_STYLE8" width="13%"><%=demo.getLang("erp","采购申请金额")%>：</td>
