...
<form id="accidentDealwith" method="POST" ENCTYPE="multipart/form-data">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="formSumbit('dealwith');" value="<%=demo.getLang("erp","确定")%>"></div></td>
</tr>
</table>
<%
try{
...
<td <%=TD_STYLE2%> class="TD_STYLE2" colspan="3"><textarea style="width:100%" id="measure" name="measure" cols="5" rows="5"></textarea></td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="35%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="handler" name="handler" type="text" width="100%" value="<%=handler%>" readonly/><input type="hidden" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="handler_id" value="<%=handler_id%>"></td>
<td <%=TD_STYLE1%> class="TD_STYLE8" width="15%"><%=demo.getLang("erp","处理时间")%>：</td>
<td <%=TD_STYLE2%> class="TD_STYLE2" width="35%">
<input <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="dealwith_time" type="text" style="width: 100%" value="<%=dealwith_time%>" readonly/></td>
</tr>
</table>
