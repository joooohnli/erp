...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onclick="changeOk('<%=complain_id%>');" value="<%=demo.getLang("erp","提交")%>"></div></td>
</tr>
</table>
<%
try{
...
String sql="select * from qcs_complain where complain_id='"+complain_id+"' and dealwith_tag='1' and visit_tag='0'";
...
<td <%=TD_STYLE2%> class="TD_STYLE2" colspan="3"><textarea style="width:100%" id="records" name="records" cols="5" rows="5"><%=records%></textarea></td>
</tr>
<%=isPrint.hasOrNot3d(rs.getString("attachment2"),"附件&nbsp;&nbsp;&nbsp;","1",response,TR_STYLE1,TD_STYLE1,TD_STYLE2,FILE_STYLE1,rs.getString("id"),"qcs_complain")%>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
