...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","添加")%>" onClick="addDiv('addLevel.xml')">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","删除")%>" onClick="deleteDiv('deleteLevel.xml')"></div></td>
</tr>
</table>
<% 
 String sql = "select * from qcs_config_public_char where kind_id ='02' order by type_ID";
...
<page:updowntag num="<%=intRowCount%>" file="qualityLevel.jsp"/> 
