...
<% 
 String sql = "select * from qcs_config_public_char where kind_id ='15' order by type_id";
...
nseer_grid.column_width=[100,100];
nseer_grid.auto='<%=demo.getLang("erp","名称")%>';
nseer_grid.data = [
<page:pages rs="<%=rs%>" strPage="<%=strPage%>"> 
['<%=exchange.toHtml(rs.getString("type_id"))%>','<%=exchange.toHtml(rs.getString("type_name"))%>'],
</page:pages>
['']];
nseer_grid.init();
</script>
...
<page:updowntag num="<%=intRowCount%>" file="qualityType.jsp"/> 
