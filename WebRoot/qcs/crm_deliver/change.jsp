...
try{
	String sql = "select id,apply_id,stock_name,product_id,product_name,qcs_amount,qcs_time,quality_way,quality_solution,sampling_standard,sampling_amount,accept,reject,qualified,unqualified,register,register_time,qcs_result,attachment1,remark from qcs_crm_deliver where qcs_id='"+qcs_id+"' and check_tag='1'";
...
<form id="crmDeliver_change" METHOD="POST" ENCTYPE="multipart/form-data">
...
<td <%=TD_STYLE1%> class="TD_STYLE8" width="13%"><%=demo.getLang("erp","不合格数")%>：</td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="stock_name" name="stock_name" type="text" width="37%" value="<%=stock_name%>" readonly/></td>
