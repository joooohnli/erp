...
%>
<form id="mutiValidation" class="x-form" method="POST" action="../../qcs_crm_deliver_check_delete_ok">
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" height="10"><%=demo.getLang("erp","该发货质检单未通过审核，您确认吗？请选择处理：")%></td>
