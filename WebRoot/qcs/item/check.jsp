...
String sqla="select id from qcs_workflow where object_ID='"+item_id+"' and check_tag='0' and config_id<'"+config_id+"'";
...
form.action = "../../qcs_item_check_ok?config_id=<%=config_id%>";
}
...
<%=demo.getLang("erp","通过")%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" id="QV_button" onclick="showQVDiv('QV_hidden','QV_table2',0,'check',event);" value="质检值" disabled>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onClick="TwoSubmit()" value=<%=demo.getLang("erp","确认")%>>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onClick=location="check_list.jsp" value=<%=demo.getLang("erp","返回")%>></div></td>
</tr>
</table>
...
<td <%=TD_STYLE3%> class="TD_STYLE3" colspan="3" width="89%"></td>
 ...
 </tr> <%=isPrint.hasOrNot3d(rs.getString("attachment1"),"附件&nbsp;&nbsp;&nbsp;","1",response,TR_STYLE1,TD_STYLE1,TD_STYLE2,FILE_STYLE1,rs.getString("id"),"qcs_item")%>
</table>
