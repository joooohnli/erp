...
<div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" id="QV_button" onclick="showQVDiv('QV_hidden','QV_table2',1,'query',event);" value="质检值" disabled>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onClick="history.back()" value=<%=demo.getLang("erp","返回")%>></div></td>
</tr>
</table>
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" type="text" id="item_id" name="item_id" onfocus="this.blur();"; value="<%=item_id%>" readonly /></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="14%"><%=demo.getLang("erp","项目名称")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="item_name" name="item_name" type="text" width="100%" value="<%=rs.getString("item_name")%>" readonly /></td>
 </tr>
 <%
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="designer" name="designer" type="text" width="100%" value="<%=rs.getString("designer")%>" readonly /></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="14%"><%=demo.getLang("erp","分析方法")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input class="INPUT_STYLE3" id="analyse_method" name="analyse_method" type="text" value="<%=rs.getString("analyse_method")%>" readonly/></td>
</tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
  <td <%=TD_STYLE1%> class="TD_STYLE8" width="14%"><%=demo.getLang("erp","首选质检依据")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="default_basis" name="default_basis" type="text" width="100%" value="<%=rs.getString("default_basis")%>"  readonly/></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="14%"><%=demo.getLang("erp","备选质检依据")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input class="INPUT_STYLE3" id="ready_basis" name="ready_basis" type="text" value="<%=rs.getString("ready_basis")%>"  readonly/></td>
</tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
  <td <%=TD_STYLE1%> class="TD_STYLE8" width="14%"><%=demo.getLang("erp","质检方法")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="quality_method" name="quality_method" type="text" width="100%" value="<%=rs.getString("quality_method")%>"  readonly/></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="14%"><%=demo.getLang("erp","质检设备")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input class="INPUT_STYLE3" id="quality_equipment" name="quality_equipment" type="text" value="<%=rs.getString("quality_equipment")%>"  readonly/></td>
</tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
  <td <%=TD_STYLE1%> class="TD_STYLE8" width="14%"><%=demo.getLang("erp","抽样标准")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="sampling_standard" name="sampling_standard" type="text" width="100%" value="<%=rs.getString("sampling_standard")%>"  readonly/></td>
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="14%"><%=demo.getLang("erp","质量问题等级")%>：</td>
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="defect_class" name="defect_class" type="text" width="100%" value="<%=rs.getString("defect_class")%>"  readonly/></td>
</tr>
<%
String check_tag="";
...
%>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="important" name="important" type="text" value="<%=demo.getLang("erp",check_tag)%>"  readonly /></td>
...
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="remark" readonly /><%=exchange.unURL(rs.getString("remark"))%></textarea>
</td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE1%> class="TD_STYLE8" width="14%"></td>
<td <%=TD_STYLE3%> class="TD_STYLE3" colspan="3" width="89%"></td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="36%"><input type="text" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="checker" value="<%=checker%>" readonly /><input type="hidden" <%=INPUT_STYLE3%> class="INPUT_STYLE3" name="checker_id" value="<%=checker_id%>"></td>
...
<%=isPrint.printOrNot3(rs.getString("attachment1"),"附件&nbsp;&nbsp;&nbsp;",response,TR_STYLE1,TD_STYLE1,TD_STYLE2,rs.getString("id"),"qcs_item","attachment1")%>
</table>
