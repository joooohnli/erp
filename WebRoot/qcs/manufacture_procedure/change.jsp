...
try{
	String sql = "select id,apply_id,product_id,product_name,qcs_amount,qcs_time,procedure_name,quality_solution,sampling_standard,sampling_amount,qualified,unqualified,register,register_time,qcs_result,attachment1,remark,accept,reject,manufacture_id from qcs_manufacture_procedure where qcs_id='"+qcs_id+"' and check_tag='1'";
...
<form id="manufactureProcedure_change" METHOD="POST" ENCTYPE="multipart/form-data">
