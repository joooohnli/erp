...
try{
	String sql = "select apply_id,product_id,product_name,demand_amount from qcs_apply_details where manufacture_id='"+manufacture_id+"' and apply_id='"+apply_id+"'";
...
<form id="manufactureProcedure_register" METHOD="POST" ENCTYPE="multipart/form-data">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <td <%=TD_STYLE1%> class="TD_STYLE8"><%=DgButton.getDraft("'manufactureProcedure_register','../../qcs_manufacture_procedure_register_draft_ok','../../xml/qcs/qcs_manufacture_procedure.xml'",request)%>&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","保存")%>" onClick="showFormSubmit('register');">&nbsp;<input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" value="<%=demo.getLang("erp","返回")%>" onClick="history.back();"></td>
 </tr>
 </table>
...
<td <%=TD_STYLE1%> class="TD_STYLE8" width="13%"><%=demo.getLang("erp","质检方式")%>：</td>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="quality_solution" name="quality_solution" type="text" width="37%"  onclick="loadAjaxDiv('quality_solution','<%=rs.getString("product_id")%>',event);this.blur();" value="" readonly/><div class="select_div_r" id="quality_solution_div"  onclick="loadAjaxDiv('quality_solution','<%=rs.getString("product_id")%>',event)"></td>
 </tr>
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input id="manufacture_id" name="manufacture_id" type="hidden" value="<%=manufacture_id%>" readonly /></td>
 </tr>
</table>
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
<tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
	<tr <%=TR_STYLE1%> class="TR_STYLE1">
	 ...
	 <td <%=TD_STYLE2%> class="TD_STYLE2" width="37%"><input <%=INPUT_STYLE3%> class="INPUT_STYLE3" id="qcs_result" name="qcs_result" type="text" width="37%" onclick="loadAjaxDiv('qcs_result','14',event);this.blur();" value="" readonly/><div class="select_div_l" id="qcs_result_div"  onclick="loadAjaxDiv('qcs_result','14',event)"></td>
	 <td <%=TD_STYLE1%> class="TD_STYLE8" width="13%"></td>
