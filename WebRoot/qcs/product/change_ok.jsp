...
<td <%=TD_STYLE1%> class="TD_STYLE8"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onClick=location="change_list.jsp" value="<%=demo.getLang("erp","返回")%>"></div></td>
</tr>
</table>
...
switch(finished_tag){
	case 0:
		...
		break;
	case 1:
		out.println(demo.getLang("erp","变更成功，请返回！"));
		break;
	case 2:
