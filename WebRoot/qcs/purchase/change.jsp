...
<script type="text/javascript" src="../../javascript/qcs/purchase/purchase.js"></script>
...
try{
	String sql = "select id,apply_id,product_id,product_name,qcs_amount,qcs_time,quality_way,quality_solution,sampling_standard,sampling_amount,accept,reject,qualified,unqualified,register,register_time,qcs_result,attachment1,remark from qcs_purchase where qcs_id='"+qcs_id+"' and check_tag='1'";
...
<form id="purchase_change" METHOD="POST" ENCTYPE="multipart/form-data">
...
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE5%> class="TD_STYLE5"><font size="4"><b><%=demo.getLang("erp","采购质检单")%></b></font></td>
 </tr>
 </table>
<table <%=TABLE_STYLE4%> class="TABLE_STYLE4">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<script>
<%
sql="select * from qcs_purchase_details where qcs_id='"+qcs_id+"' order by details_number";
