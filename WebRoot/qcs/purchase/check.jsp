...
try{
	...
	if(!rsa.next()){
	String sql = "select id,apply_id,product_id,product_name,qcs_amount,qcs_time,quality_way,quality_solution,sampling_standard,sampling_amount,accept,reject,qualified,unqualified,register,register_time,qcs_result,attachment1,remark from qcs_purchase where qcs_id='"+qcs_id+"' and check_tag='0'";
...
function TwoSubmit(){
var form=document.getElementById('purchase_check');
if (form.Ref[0].checked){
form.action = "check_delete_reconfirm.jsp";
}else{
form.action = "../../qcs_purchase_check_ok";
}
if (doValidate('../../xml/qcs/qcs_purchase.xml','purchase_check')){
form.submit();
}
}
</script>
<body onload="locateSelectDiv()">
<form id="purchase_check" METHOD="POST" ENCTYPE="multipart/form-data">
