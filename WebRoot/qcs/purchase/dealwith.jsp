...
try{
	String sql = "select id,apply_id,product_id,product_name,qcs_amount,qcs_time,quality_way,quality_solution,sampling_standard,sampling_amount,accept,reject,qualified,unqualified,register,register_time,qcs_result,attachment1,remark,limit_tag from qcs_purchase where qcs_id='"+qcs_id+"'";
...
<form id="purchase_dealwith" METHOD="POST">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <%
 sql="select type_name,describe2 from qcs_config_public_char where kind_id='07' and describe1='1' and used_tag='1' order by describe1";
