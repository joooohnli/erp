...
switch(Integer.parseInt(search_tag)){
	...
	case 1:
	{
		...
		rs=qcs_db.executeQuery(sql);
		while(rs.next()){			search+=rs.getString("item")+"⊙"+rs.getString("analyse_method")+"⊙"+rs.getString("default_basis")+"⊙"+rs.getString("ready_basis")+"⊙"+rs.getString("quality_method")+"⊙"+rs.getString("standard_value")+"⊙"+rs.getString("standard_max")+"⊙"+rs.getString("standard_min")+"\n";
		}
		break;
	}
	case 2:
