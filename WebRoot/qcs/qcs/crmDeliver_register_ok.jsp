...
<td <%=TD_STYLE1%> class="TD_STYLE8"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="button" <%=BUTTON_STYLE1%> class="BUTTON_STYLE1" onClick=location="crmDeliver.jsp" value="<%=demo.getLang("erp","返回")%>"></div></td>
</tr>
</table>
