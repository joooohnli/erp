...
String condition="check_tag='1' and type!='服务型产品' and qcs_apply_tag='0'";
String queue="order by register_time";
String validationXml="../../xml/design/design_file.xml";
String nickName="产品档案";
String fileName="other.jsp";
...
function id_link1(product_id,product_name){
	var link1='other_register.jsp?product_id='+product_id+'&&product_name='+product_name;
