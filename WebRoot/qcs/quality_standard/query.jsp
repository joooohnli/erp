...
String sql = "select id,checker,check_time,standard_name,product_id,product_name,register,register_time,designer,remark,attachment1 from qcs_quality_standard where standard_id='"+standard_id+"'" ;
...
<textarea <%=TEXTAREA_STYLE1%> class="TEXTAREA_STYLE1" name="remark" readonly /><%=exchange.unURL(remark)%></textarea>
 ...
 <%=isPrint.printOrNot3(attachment1,"附件&nbsp;&nbsp;&nbsp;",response,TR_STYLE1,TD_STYLE1,TD_STYLE2,id,"qcs_quality_standard","attachment1")%>
</table>
