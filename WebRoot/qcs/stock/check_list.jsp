...
String validationXml="../../xml/qcs/qcs_stock.xml";
String nickName="库存质检申请单";
String fileName="check_list.jsp";
String rowSummary=demo.getLang("erp","符合条件的库存质检单总数：");
%>
<%@include file="../../include/search.jsp"%>
<%	
String register_ID=(String)session.getAttribute("human_IDD");
int workflow_amount=0;
String sql="select count(id) from qcs_config_workflow where type_id='11'";
