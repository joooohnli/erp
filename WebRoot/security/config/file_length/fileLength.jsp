...
if(rs.next()){
file_length=rs.getString("type_name");
%>
<form id="priceAlarm" class="x-form" method="POST" action="fileLength_change.jsp?file_length=<%=file_length%>">
...
<div id="nseerGround" class="nseerGround">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
	<td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","附件容量：")%><%=exchange.toHtml(file_length)%>KB</td>
...
file_length="尚未设置";
%>
<form id="priceAlarm" method="POST" action="fileLength_change.jsp?file_length=<%=file_length%>">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
	<td <%=TD_HANDBOOK_STYLE1%> class="TD_HANDBOOK_STYLE1"><div class="div_handbook"><%=handbook%></div></td>
 </tr>
...
<div id="nseerGround" class="nseerGround">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
	<td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","附件容量：")%><%=file_length%></td>
	<td <%=TD_STYLE3%> class="TD_STYLE3"></td>
 </tr>
 </table>
</div>
