...
%>
<form id="priceAlarm" class="x-form" method="POST" action="task_change.jsp?task=<%=task%>">
...
<div id="nseerGround" class="nseerGround">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
	<td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","任务是否启用：")%><%=demo.getLang("erp",task)%></td>
...
<%}else{
task=demo.getLang("erp","尚未设置");
%>
<form id="priceAlarm" method="POST" action="task_change.jsp?task=">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
	<td <%=TD_HANDBOOK_STYLE1%> class="TD_HANDBOOK_STYLE1"><div class="div_handbook"><%=handbook%></div></td>
 </tr>
