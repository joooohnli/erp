...
%>
<form id="priceAlarm" class="x-form" method="POST" action="taskRefresh_change.jsp?refresh=<%=refresh%>">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><input type="submit" <%=SUBMIT_STYLE1%> class="SUBMIT_STYLE1" value= "<%=demo.getLang("erp","设置")%>"></div></td>
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
<td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","任务调度刷新：")%><%=exchange.toHtml(refresh)%><%=demo.getLang("erp","分钟")%></td>
<td <%=TD_STYLE3%> class="TD_STYLE3"></td>
 </tr>
 </table>
</form> 
<%}else{
refresh=demo.getLang("erp","尚未设置");
%>
<form id="priceAlarm" method="POST" action="taskRefresh_change.jsp?refresh=">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 ...
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
	<td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","任务调度刷新：")%><%=refresh%></td>
	<td <%=TD_STYLE3%> class="TD_STYLE3"></td>
 </tr>
 </table>
</form> 
