...
%>	
['<span style="color:<%=color%>"><%=rs.getString("human_ID")%></span>','<span style="color:<%=color%>"><%=exchange.toHtml(rs.getString("human_name"))%></span>','<span style="color:<%=color%>"><%=exchange.toHtml(rs.getString("chain_name"))%></span>','<span style="color:<%=color%>"><%=exchange.toHtml(rs.getString("register_time"))%></span>','<span style="color:<%=color%>"><%=exchange.toHtml(rs.getString("expiry_period"))%></span>','<div style="text-decoration : underline;color:#3366FF" onclick=id_link("delete_reconfirm.jsp?human_ID=<%=rs.getString("human_ID")%>&id=<%=rs.getString("id")%>")><%=demo.getLang("erp","吊销")%></div>'],
</page:pages>
['']];
