...
<div id="nseerGround" class="nseerGround">
 ...
 <td <%=TD_STYLE3%> class="TD_STYLE3"><div <%=DIV_STYLE1%> class="DIV_STYLE1"><a href="../../security_recovery_recovery_ok"><font color="red"><%=demo.getLang("erp","确认")%></a></div></td>
 </tr>
 </table>
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3" width="70%"><font color="red"><%=demo.getLang("erp","做恢复计数器文件操作之前必须做过数据恢复，否则将引起严重的数据错误,您确认做过数据恢复吗？")%></td>
