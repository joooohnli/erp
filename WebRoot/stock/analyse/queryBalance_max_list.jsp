...
String rowSummary=demo.getLang("erp","库存上限报警产品种类数");
int k=1;
%>
...
<table <%=TABLE_STYLE4%> style="width:98%;">
  <tr <%=TR_STYLE1%> class="TR_STYLE1">
  <td <%=TD_STYLE3%> class="TD_STYLE3"><font color="orange"><%=demo.getLang("erp","当前库存上限报警产品种类数：")%><%=n%><%=demo.getLang("erp","种")%></font></td>
 </tr>
 </table>
