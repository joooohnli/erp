...
<form id="priceAlarm" class="x-form" method="POST" action="serialNumberLength_change.jsp">
<input type="hidden" name="stock_name" value="<%=exchange.toHtml(stock_name)%>">
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
 <td <%=TD_STYLE3%> class="TD_STYLE3"><%=demo.getLang("erp","S/N长度：")%><%=serial_number_length%></td>
 </tr>
 </table>
</form> 
</div>