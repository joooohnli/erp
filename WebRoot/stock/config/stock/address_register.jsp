...
<form id="address" class="x-form" method="post" action="../../../stock_config_stock_address_register_ok" onSubmit="return doValidate('../../../xml/stock/stock_config_public_char.xml','address')">
 <table <%=TABLE_STYLE2%> class="TABLE_STYLE2">
 <tr <%=TR_STYLE1%> class="TR_STYLE1">
...
<td <%=TD_STYLE21%> class="TD_STYLE2" width="80%"><input type="hidden" name="stock_ID" style="width: 30%;" value="<%=stock_ID%>"><%=stock_ID%></td>
</tr>
<tr <%=TR_STYLE1%> class="TR_STYLE1">
