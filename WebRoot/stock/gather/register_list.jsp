...
String[] gather_ID_group1=new String[10000];
	...
	while(rs.next()){
		...
		while(rs4.next()){
			if(stock_ID.indexOf(rs4.getString("stock_ID"))!= -1&&rs4.getString("gather_check_tag").equals("0")&&rs4.getString("gather_tag").equals("0")){
