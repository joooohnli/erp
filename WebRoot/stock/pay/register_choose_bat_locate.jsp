...
<form id="timeLocateValidation" class="x-form" method="post" action="register_choose_bat.jsp" onSubmit="return doValidate('../../xml/stock/stock_balance_details_details.xml','timeLocateValidation')">
<%
