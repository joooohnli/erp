...
String sql="select count(id) from stock_config_workflow where type_id='04'";
...
String sql1="select id from stock_workflow where object_ID='"+rs.getString("pay_ID")+"' and check_tag='0'";
