...
<form id="mutiValidation" method="POST" action="register_reconfirm.jsp" onSubmit="return doValidate('../../xml/stock/stock_transfer_pay.xml','mutiValidation')">
...
<tr <%=TR_STYLE1%> class="TR_STYLE1"> 
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2" width="89%"><select <%=SELECT_STYLE1%> class="SELECT_STYLE1" name="reasonexact" style="width:44.8%">
	<%
  for(int i=0;i<m;i++){
	%>
...
<thead>
 ...
 <td <%=TD_STYLE2%> class="TD_STYLE2"><input type="text" <%=INPUT_STYLE5%> class="INPUT_STYLE5" name="amount" value="1"><input name="balance_amount" type="hidden"></td>
