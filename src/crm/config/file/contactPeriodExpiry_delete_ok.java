...
public class contactPeriodExpiry_delete_ok extends HttpServlet{
...
int i;
int intRowCount;
String sqll = "select * from crm_config_public_double where kind='联络' order by type_ID" ;
...
response.sendRedirect("crm/config/file/contactPeriodExpiry.jsp");
