...
public class gatherSumLimit_delete_ok extends HttpServlet{
...
int i;
int intRowCount;
String sqll = "select * from crm_config_public_double where kind='欠款' order by type_ID" ;
...
response.sendRedirect("crm/config/file/gatherSumLimit.jsp");
}else{
