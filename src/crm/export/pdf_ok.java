...
mm.setConfigFile("xml/crm/pdf_export.xml");
...
}else if(tablename.equals("crm_discussion")){
...
mm.make((String)dbSession.getAttribute("unit_db_name"),tablename,sqla,sql,"pdf_files/crm_data",1500,session);
int fileAmount=mm.fileAmount();
response.sendRedirect("crm/export/pdf_ok_a.jsp?file_amount="+fileAmount+"");
