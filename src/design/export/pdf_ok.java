...
mm.setConfigFile("xml/design/pdf_export.xml");
...
mm.make((String)dbSession.getAttribute("unit_db_name"),tablename,sqla,sql,"pdf_files/design_data",1500,session);
int fileAmount=mm.fileAmount();
response.sendRedirect("design/export/pdf_ok_a.jsp?file_amount="+fileAmount+"");
