...
response.sendRedirect("draft/crm/file_choose_attachment.jsp?customer_ID="+customer_ID+"");//提交审核成功
}else{
  response.sendRedirect("draft/crm/file_ok.jsp?finished_tag=5");
}}else{
