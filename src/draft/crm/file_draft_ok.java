...
response.sendRedirect("draft/crm/file_choose_attachment.jsp?customer_ID="+customer_ID+"");
}else{

  response.sendRedirect("draft/crm/file_ok.jsp?finished_tag=2");//用户时候登陆过
