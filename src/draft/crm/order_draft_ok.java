...
public class order_draft_ok extends HttpServlet{
...
response.sendRedirect("draft/crm/order_choose_attachment.jsp?order_ID="+order_ID+"");
	...
	response.sendRedirect("draft/crm/order_ok.jsp?finished_tag=2");
}
