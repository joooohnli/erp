...
public class order_garbage_ok extends HttpServlet{
...
if(vt.validata((String)dbSession.getAttribute("unit_db_name"),"crm_order","order_ID",order_ID,"check_tag").equals("5")||vt.validata((String)dbSession.getAttribute("unit_db_name"),"crm_order","order_ID",order_ID,"check_tag").equals("9")){
if(n==0){
String time="";
...
response.sendRedirect("draft/crm/order_ok.jsp?finished_tag=3");
	}else{
    response.sendRedirect("draft/crm/order_ok.jsp?finished_tag=1");
	}
}else{
	response.sendRedirect("draft/crm/order_ok.jsp?finished_tag=4");
}
