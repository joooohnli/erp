...
for(int i=0;i<mySmartUpload.getFiles().getCount();i++){
	...
	String sqla = "update ecommerce_contact set chain_id='"+chain_id+"',chain_name='"+chain_name+"',email='"+email+"',tel='"+tel+"',fax='"+fax+"',address='"+address+"',postcode='"+postcode+"',qq1='"+qq1+"',qq2='"+qq2+"',qq3='"+qq3+"',qq4='"+qq4+"',register_id='"+register_id+"',register='"+register+"',register_time='"+register_time+"',check_tag='5'";
...
response.sendRedirect("draft/ecommerce/contact_ok.jsp?finished_tag=0");

}else{
response.sendRedirect("draft/ecommerce/contact_ok.jsp?finished_tag=1");
}
