...
for(int i=0;i<mySmartUpload.getFiles().getCount();i++){
	...
	String sqla = "update ecommerce_contact set tel='"+tel+"',fax='"+fax+"',address='"+address+"',postcode='"+postcode+"',qq1='"+qq1+"',qq2='"+qq2+"',qq3='"+qq3+"',qq4='"+qq4+"',register_id='"+register_id+"',register='"+register+"',register_time='"+register_time+"',check_tag='2'";
...
response.sendRedirect("draft/ecommerce/contact_ok.jsp?finished_tag=2");

}else{
response.sendRedirect("draft/ecommerce/contact_ok.jsp?finished_tag=3");
}
