...
public class link_draft_ok extends HttpServlet{
...
for(int i=0;i<mySmartUpload.getFiles().getCount();i++){
	...
	String sqla = "update ecommerce_link set link_ID='"+link_ID+"',topic='"+topic+"',url='"+url+"',content='"+content+"',check_tag='5'";
...
response.sendRedirect("draft/ecommerce/link_ok.jsp?finished_tag=0");

}else{
response.sendRedirect("draft/ecommerce/link_ok.jsp?finished_tag=1");
}
