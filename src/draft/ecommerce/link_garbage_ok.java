...
public class link_garbage_ok extends HttpServlet{
...
for(int i=0;i<mySmartUpload.getFiles().getCount();i++){
	...
	String sqla = "update ecommerce_link set link_ID='"+link_ID+"',topic='"+topic+"',url='"+url+"',content='"+content+"',opinion='"+opinion+"',check_tag='2'";
...
response.sendRedirect("draft/ecommerce/link_ok.jsp?finished_tag=2");

}else{
response.sendRedirect("draft/ecommerce/link_ok.jsp?finished_tag=3");
}
