...
public class news_draft_ok extends HttpServlet{
...
String sqla = "update ecommerce_news set topic='"+topic+"',chain_id='"+chain_id+"',chain_name='"+chain_name+"',news_ID='"+news_ID+"',content='"+content+"',check_tag='5'";
...
response.sendRedirect("draft/ecommerce/news_ok.jsp?finished_tag=0");

}else{
response.sendRedirect("draft/ecommerce/news_ok.jsp?finished_tag=1");
}
ecommerce_db.commit();
ecommerce_db.close();
