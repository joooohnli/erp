...
public class news_garbage_ok extends HttpServlet{
...
String sqla = "update ecommerce_news set chain_id='"+chain_id+"',chain_name='"+chain_name+"',news_ID='"+news_ID+"',content='"+content+"',opinion='"+opinion+"',check_tag='2'";
...
response.sendRedirect("draft/ecommerce/news_ok.jsp?finished_tag=2");

}else{
response.sendRedirect("draft/ecommerce/news_ok.jsp?finished_tag=3");
}
ecommerce_db.commit();
ecommerce_db.close();
