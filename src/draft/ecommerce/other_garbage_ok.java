...
for(int i=0;i<mySmartUpload.getFiles().getCount();i++){
	...
	String sqla = "update ecommerce_other set chain_id='"+chain_id+"',chain_name='"+chain_name+"',other_ID='"+other_ID+"',content='"+content+"',opinion='"+opinion+"',check_tag='2',excel_tag='3'";
...
response.sendRedirect("draft/ecommerce/other_ok.jsp?finished_tag=3");
