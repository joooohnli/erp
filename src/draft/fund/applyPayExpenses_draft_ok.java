...
String cost_price_subtotal1="";
	...
	String sql = "update fund_apply_pay set demand_cost_price_sum='"+demand_cost_price_sum+"',register_time='"+register_time+"',register='"+register+"',remark='"+remark+"' where apply_pay_ID='"+apply_pay_ID+"'" ;
