...
public class majorChange_check_ok extends HttpServlet{//创建方法
...
try{
	String sql = "update hr_major_change set new_chain_id='"+new_chain_id+"',new_chain_name='"+new_chain_name+"',new_human_major_first_kind_ID='"+new_major_first_kind_ID+"',new_human_major_first_kind_name='"+new_major_first_kind_name+"',new_human_major_second_kind_ID='"+new_major_second_kind_ID+"',new_human_major_second_kind_name='"+new_major_second_kind_name+"',human_name='"+human_name+"',major_type='"+major_type+"',salary_standard_ID='"+salary_standard_ID+"',salary_standard_name='"+salary_standard_name+"',salary_sum='"+salary_sum+"',new_major_type='"+new_major_type+"',new_salary_standard_ID='"+new_salary_standard_ID+"',new_salary_standard_name='"+new_salary_standard_name+"',new_salary_sum='"+new_salary_sum+"',register='"+register+"',register_time='"+register_time+"',remark1='"+remark1+"',check_tag='0' where human_ID='"+human_ID+"' and major_time='"+major_time+"'";
	...
	String sql3="update hr_file set chain_id='"+chain_id+"',chain_name='"+chain_name+"',human_major_first_kind_ID='"+major_first_kind_ID+"',human_major_first_kind_name='"+major_first_kind_name+"',human_major_second_kind_ID='"+major_second_kind_ID+"',human_major_second_kind_name='"+major_second_kind_name+"',major_type='"+major_type+"',salary_standard_ID='"+salary_standard_ID+"',salary_standard_name='"+salary_standard_name+"',salary_sum='"+salary_sum+"',lately_change_time='"+register_time+"',change_time='"+register_time+"',file_change_amount='"+file_change_amount1+"',major_change_tag='0' where human_ID='"+human_ID+"'";
	hr_db.executeUpdate(sql3);
	String sql7="update security_users set chain_id='"+chain_id+"',chain_name='"+chain_name+"',human_major_second_kind_ID='"+major_second_kind_ID+"',human_major_second_kind_name='"+major_second_kind_name+"' where human_ID='"+human_ID+"'";
...
while(rs111.next()){
	...
	crm_db1.executeUpdate(sqla);
		...
		hr_db.executeUpdate(sql) ;
		sql="update hr_major_change set check_tag='0' where human_ID='"+human_ID+"' and major_time='"+major_time+"'";
		hr_db.executeUpdate(sql) ;
	...
	response.sendRedirect("draft/hr/majorChange_ok.jsp?finished_tag=4");
...
response.sendRedirect("draft/hr/majorChange_ok.jsp?finished_tag=5");
}
 hr_db.commit();
  hr_db1.commit();
   crm_db.commit();
