...
if(vt.validata((String)dbSession.getAttribute("unit_db_name"),"intrmanufacture_discussion","id",id,"check_tag").equals("5")||vt.validata((String)dbSession.getAttribute("unit_db_name"),"intrmanufacture_discussion","id",id,"check_tag").equals("9")){
...
ex.printStackTrace();
	...
	response.sendRedirect("draft/intrmanufacture/discussion_choose_attachment.jsp?discussion_ID="+discussion_ID+"");
		...
		response.sendRedirect("draft/intrmanufacture/discussion_ok_a.jsp?id="+id+"");
}
}else{
	response.sendRedirect("draft/intrmanufacture/discussion_ok.jsp?finished_tag=0");
}
