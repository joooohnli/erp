...
public class intrmanufacture_check_ok extends HttpServlet{
...
String sql1="update intrmanufacture_intrmanufacture set product_ID='"+product_ID+"',product_name='"+product_name+"',register='"+register+"',register_time='"+register_time+"',demand_amount='"+demand_amount_sum+"',demand_price='"+price+"',demand_cost_price_sum='"+demand_cost_price_sum+"',check_tag='1',pay_ID_group='新发生' where intrmanufacture_ID='"+intrmanufacture_ID+"'";
intrmanufacture_db.executeUpdate(sql1);
	...
	sql = "update intrmanufacture_intrmanufacture set list_price_sum='"+list_price_sum+"',list_price='"+price+"',register_time='"+register+"',check_time='"+register_time+"',check_tag='2',intrmanufacture_tag='1',invoice_tag='1',gather_tag='1',stock_gather_tag='1',pay_tag='1',module_cost_price_sum='"+module_cost+"' where intrmanufacture_ID='"+intrmanufacture_ID+"'" ;
	//out.println(sql);
	intrmanufacture_db.executeUpdate(sql) ;
...
if(rs1.next()){
   ...
   second_code3=rs1.getString("second_code");
	...
	while(rs99.next()){
		...
		String mod3="/erp/fund_pay_register_ok";
		int filenum=count.readTime((String)dbSession.getAttribute("unit_db_name"),mod3);
		count.writeTime((String)dbSession.getAttribute("unit_db_name"),mod3);

		String fund_ID=main_code3+first_code3+second_code3+time+filenum;
...
response.sendRedirect("draft/intrmanufacture/intrmanufacture_choose.jsp?intrmanufacture_ID="+intrmanufacture_ID+"");
