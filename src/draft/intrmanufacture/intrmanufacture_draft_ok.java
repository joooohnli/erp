...
public class intrmanufacture_draft_ok extends HttpServlet{
...
String sql1="update intrmanufacture_intrmanufacture set product_ID='"+product_ID+"',product_name='"+product_name+"',register='"+register+"',register_time='"+register_time+"',demand_amount='"+demand_amount_sum+"',demand_price='"+price+"',demand_cost_price_sum='"+demand_cost_price_sum+"',check_tag='5',pay_ID_group='新发生' where intrmanufacture_ID='"+intrmanufacture_ID+"'";
