...
try{
	String sql = "update logistics_product_providers_recommend set register_time='"+register_time+"',recommender='"+recommender+"',recommend_describe='"+recommend_describe+"',check_tag='0' where product_logistics_recommend_ID='"+product_logistics_recommend_ID+"'" ;
...
response.sendRedirect("draft/logistics/productProviders_ok.jsp?finished_tag=4");
}else{
response.sendRedirect("draft/logistics/productProviders_ok.jsp?finished_tag=5");
}
  }
		logistics_db.commit();	
logistics_db.close();
