...
public class planing_draft_ok extends HttpServlet{
...
if(!rs.next()){
	...
	response.sendRedirect("draft/oa/planing_ok.jsp?finished_tag=1");
}else{
...
String sqla = "update oa_planing set content='"+content+"'";
...
response.sendRedirect("draft/oa/planing_ok.jsp?finished_tag=0");
}
}catch(Exception ex){
}
