...
String sql="update purchase_product_providers_recommend set recommend_describe='"+recommend_describe+"',register='"+register+"' where product_providers_recommend_ID='"+product_providers_recommend_ID+"'";
