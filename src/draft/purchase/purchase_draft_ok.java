...
try{
		...
		String sqll = "update purchase_purchase set remark='"+remark+"' where purchase_ID='"+purchase_ID+"'" ;
...
ex.printStackTrace();
	...
	response.sendRedirect("draft/purchase/purchase_ok.jsp?finished_tag=0");
	}else{
	
	response.sendRedirect("draft/purchase/purchase_ok.jsp?finished_tag=1");
}
