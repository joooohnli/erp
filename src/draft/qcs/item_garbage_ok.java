...
public class item_garbage_ok extends HttpServlet{
...
if(!rs.next()){
	...
	response.sendRedirect("draft/qcs/item_ok.jsp?finished_tag=3");
}else{
...
String sqla = "update qcs_item set item_name='"+item_name+"',register_id='"+register_id+"',register='"+register+"',register_time='"+register_time+"',analyse_method='"+analyse_method+"',designer='"+designer+"',default_basis='"+default_basis+"',ready_basis='"+ready_basis+"',quality_method='"+quality_method+"',quality_equipment='"+quality_equipment+"',sampling_standard='"+sampling_standard+"',defect_class='"+defect_class+"',important='"+important+"',quality_value='"+QV_hidden+"',remark='"+remark+"',check_tag='2'";
...
response.sendRedirect("draft/qcs/item_ok.jsp?finished_tag=2");
}
