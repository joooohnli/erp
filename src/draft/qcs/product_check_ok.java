...
public class product_check_ok extends HttpServlet{
...
if(!rs.next()){	
	response.sendRedirect("draft/qcs/product_ok.jsp?finished_tag=5");
}else{
...
response.sendRedirect("draft/qcs/product_ok.jsp?finished_tag=4");
}
qcs_db.commit();
qcs_db.close();
}
