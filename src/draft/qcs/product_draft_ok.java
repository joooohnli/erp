...
public class product_draft_ok extends HttpServlet{
...
if(!rs.next()){	
	response.sendRedirect("draft/qcs/product_ok.jsp?finished_tag=1");
}else{
...
response.sendRedirect("draft/qcs/product_ok.jsp?finished_tag=0");
}
