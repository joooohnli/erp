...
public class samplingStandard_draft_ok extends HttpServlet{
...
if(!rs.next()){
	...
	response.sendRedirect("draft/qcs/samplingStandard_ok.jsp?finished_tag=1");
}else{
...
if(aql_id==null) aql_id="";
	...
	String sqla = "update qcs_sampling_standard set standard_name='"+standard_name+"',checker_id='"+checker_id+"',checker='"+checker+"',sampling_method='"+method_name+"',designer='"+designer+"',quality_level='"+level_id+"',mil_std='"+class_id+"',aql='"+aql_id+"',remark='"+remark+"', check_tag='5'";
...
response.sendRedirect("draft/qcs/samplingStandard_ok.jsp?finished_tag=0");
}
