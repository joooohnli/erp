...
public class solution_draft_ok extends HttpServlet{
...
if(!rs.next()){
	...
	response.sendRedirect("qcs/solution/check_ok.jsp?finished_tag=1");
}else{
...
response.sendRedirect("draft/qcs/solution_ok.jsp?finished_tag=0");
}
