...
double cost_price_sum=0.0d;
	...
	String sql4="update stock_paying_gathering set amount='"+amount[i]+"',paid_amount='"+paid_amount[i]+"',balance_amount='"+balance_amount11+"',subtotal='"+subtotal+"',register_time='"+register_time+"',check_tag='0' where id='"+id[i]+"'";
