...
response.sendRedirect("ecommerce/config/key/key_register_ok_a.jsp");
	...
	response.sendRedirect("ecommerce/config/key/key_register_ok_b.jsp");
	}
security_db.commit();
security_db.close();
}else{
