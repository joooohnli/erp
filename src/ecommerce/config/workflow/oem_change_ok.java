...
public class oem_change_ok extends HttpServlet{
...
if(chain_id_array==null){
  	response.sendRedirect("ecommerce/config/workflow/oem_change_ok_a.jsp?id="+id+"&type_id="+type_id);
}else{
String describe1="";
String describe2="";
...
String sql="select product_ID from design_file where check_tag='1' and excel_tag3!='3'";
	...
	ecommerce_db.executeUpdate(sql1);	
response.sendRedirect("ecommerce/config/workflow/oem_change_ok_b.jsp?id="+id+"&type_id="+type_id);
}
	ecommerce_db.commit();
