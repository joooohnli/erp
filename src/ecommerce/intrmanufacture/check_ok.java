...
String promotion3=exchange.toHtml(bodyb);
String bodyd = new String(request.getParameter("opinion3").getBytes("UTF-8"),"UTF-8");
String opinion3=exchange.toHtml(bodyd);
...
String sql6="select * from ecommerce_workflow where object_ID='"+product_ID+"' and type_id='04' and ((check_tag='0' and config_id<'"+config_id+"') or (check_tag='1' and config_id='"+config_id+"'))";
...
String column_group=getInsertSql.sql((String)dbSession.getAttribute("unit_db_name"),"design_file");
	sql6="select * from ecommerce_workflow where object_ID='"+product_ID+"' and config_id<'"+config_id+"' and type_id='04'";
