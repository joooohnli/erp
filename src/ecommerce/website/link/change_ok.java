...
String sqloo= "select * from ecommerce_link where link_ID='"+link_ID+"'";
	 ResultSet rsoo = ecommerce_db.executeQuery(sqloo);
	 if(rsoo.next()){
	String sqll="insert into ecommerce_link_dig(link_ID,topic,url,content,attachment1,attachment2,attachment3,opinion,CHECK_TAG,FILE_CHANGE_AMOUNT,REGISTER,CHECKER,CHANGER,REGISTER_ID,CHECKER_ID,CHANGER_ID,REGISTER_TIME,CHECK_TIME,CHANGE_TIME,LATELY_CHANGE_TIME,EXCEL_TAG) values('"+rsoo.getString("link_ID")+"','"+rsoo.getString("topic")+"','"+rsoo.getString("url")+"','"+rsoo.getString("content")+"','"+rsoo.getString("attachment1")+"','"+rsoo.getString("attachment2")+"','"+rsoo.getString("attachment3")+"','"+rsoo.getString("opinion")+"','"+rsoo.getString("CHECK_TAG")+"','"+rsoo.getString("FILE_CHANGE_AMOUNT")+"','"+rsoo.getString("REGISTER")+"','"+rsoo.getString("CHECKER")+"','"+rsoo.getString("CHANGER")+"','"+rsoo.getString("REGISTER_ID")+"','"+rsoo.getString("CHECKER_ID")+"','"+rsoo.getString("CHANGER_ID")+"','"+rsoo.getString("REGISTER_TIME")+"','"+rsoo.getString("CHECK_TIME")+"','"+rsoo.getString("CHANGE_TIME")+"','"+rsoo.getString("LATELY_CHANGE_TIME")+"','"+rsoo.getString("EXCEL_TAG")+"')";
...
for(int i=0;i<mySmartUpload.getFiles().getCount();i++){
	...
	String sqla = "update ecommerce_link set topic='"+topic+"',url='"+url+"',content='"+content+"',check_tag='0',excel_tag='0',changer_ID='"+changer_ID+"',changer='"+changer+"',change_time='"+change_time+"',lately_change_time='"+lately_change_time+"',file_change_amount='"+change_amount+"'";
...
response.sendRedirect("ecommerce/website/link/change_ok_a.jsp");

}else{
response.sendRedirect("ecommerce/website/link/change_ok_c.jsp");
}
ecommerce_db.commit();
ecommerce_db.close();

}catch(Exception ex){
response.sendRedirect("ecommerce/website/link/change_ok_b.jsp?link_ID="+link_ID+"");
	}
