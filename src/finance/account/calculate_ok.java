...
String sqq="select * from finance_voucher where account_tag='1' and (profit_or_cost='0' or profit_or_cost='1') and profit_tag='0' and account_period='"+account_period[0]+"' order by chain_ID";
...
financedb.executeUpdate(sql);
sql="update finance_voucher set profit_tag='1' where id='"+rsq.getString("id")+"'";
financedb.executeUpdate(sql);
}
response.sendRedirect("finance/account/calculate_ok_a.jsp");
financedb.commit();
finance_db.commit();
financedb.close();
finance_db.close();
