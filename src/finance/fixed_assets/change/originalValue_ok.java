...
public class originalValue_ok extends HttpServlet{
...
String change_amount=request.getParameter("change_amount");
String currency=request.getParameter("currency");
String currency_rate=request.getParameter("currency_rate");
String cremnant_value_rate=request.getParameter("cremnant_value_rate");
String cremnant_value=request.getParameter("cremnant_value");
String cb_original_value=request.getParameter("cb_original_value");
String ca_original_value=request.getParameter("ca_original_value");
...
ResultSet rs=null;
    ...
    sql = "insert into finance_fa_change(changebill_id,file_id,file_name,start_time,type_name,specification,change_sub,currency,exchange_rate,cremnant_value,cremnant_value_rate,cb_original_value,ca_original_value,cb_remnant_value,ca_remnant_value,change_reason,change_time,changer,change_kind) values('"+changebill_id+"','"+file_id+"','"+file_name+"','"+start_time+"','"+change_type+"','"+specification+"','"+change_amount+"','"+currency+"','"+currency_rate+"','"+cremnant_value+"','"+cremnant_value_rate+"','"+cb_original_value+"','"+ca_original_value+"','"+cb_remnant_value+"','"+ca_remnant_value+"','"+change_reason+"','"+change_time+"','"+changer+"','原值调整')";
    	finance_db.executeUpdate(sql); 
    	
    sql="select * from finance_fa_file where file_id='"+file_id+"'";
    	rs=finance_db.executeQuery(sql);
    if(rs.next()){
    	double ca_net_value=Double.parseDouble(ca_original_value)-Double.parseDouble(rs.getString("caled_sum"));
      ...
      sql="update finance_fa_file set original_value='"+ca_original_value+"',remnant_value='"+ca_remnant_value+"',net_value='"+ca_net_value+"',change_time='"+change_time+"' where file_id='"+file_id+"'";	
      finance_db.executeUpdate(sql);
    }
		finance_db.commit();
		finance_db.close();
