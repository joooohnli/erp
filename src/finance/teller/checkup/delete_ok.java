...
if(finance_db.conn((String)dbSession.getAttribute("unit_db_name"))){
	...
	String sql = "update finance_bill set delete_tag='1' where file_id="+file_id+" and checkup_tag!='0'";
           finance_db.executeUpdate(sql) ;
		   sql = "update finance_voucher set delete_tag='1' where chain_id="+file_id+" and checkup_tag!='0'";
           finance_db.executeUpdate(sql) ;
