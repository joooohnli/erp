...
i=0;
String sql2="select id from finance_bill where id='"+value[5]+"'";
ResultSet rs2=finance_db.executeQuery(sql2);
String sql="";
if(rs2.next()){
	sql="update finance_bill set settle_time='"+value[0]+"',way='"+value[1]+"',attachment_id='"+value[2]+"',debit_subtotal='"+value[3]+"',loan_subtotal='"+value[4]+"',file_id='"+file_id+"' where id='"+value[5]+"'";
}else{
