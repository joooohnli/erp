...
public class executeMethod_delete_ok extends HttpServlet{
//创建方法
...
try{
	if(del[i-1]!=null){
	String sql = "delete from fund_config_public_char where id='"+del[i-1]+"'" ;
...
response.sendRedirect("fund/config/fund/executeMethod.jsp");
