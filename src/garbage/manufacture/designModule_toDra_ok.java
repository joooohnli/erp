...
public class designModule_toDra_ok extends HttpServlet{
...
if(gar_tag!=null&&!gar_tag.equals("")&&field!=null&&!field.equals("")){
	for(int i=0;i<value1.length;i++){
		...
		if(rs.next()){
			...
			sqll="update "+tableName+" set design_module_tag='5' where design_ID='"+id+"'";
	...
	for(int i=0;i<value1.length;i++){
		String id=value1[i];
		String sqll="update "+tableName+" set design_module_tag='5' where design_ID='"+id+"'";
		qcs_db.executeUpdate(sqll);
	}
}
