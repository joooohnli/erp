...
public class product_delete_ok extends HttpServlet{
...
for(int i=0;i<value1.length;i++){
	...
	if(rs.next()){
		sql="update design_file set qcs_tag='0',other_qcs_way='',stock_qcs_way='',manu_procedure_qcs_way='',manu_product_qcs_way='',crm_deliver_qcs_way='',intrmanu_qcs_way='',purchase_qcs_way='' where product_id='"+rs.getString("product_id")+"'";
