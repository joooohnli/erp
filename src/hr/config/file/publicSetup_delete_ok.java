...
public class publicSetup_delete_ok extends HttpServlet{
//创建方法
...
int i;
int intRowCount;
String sqll = "select * from hr_config_public_char" ;
...
response.sendRedirect("hr/config/file/publicSetup.jsp");
}else{
