...
try{
	String sql = "delete from hr_resume where details_number='"+details_number+"'" ;
	hr_db.executeUpdate(sql) ;
	String sql1 = "delete from hr_interview where details_number='"+details_number+"'" ;
...
hr_db.close();
  	...
  	response.sendRedirect("hr/engage/interview/check_list.jsp");
}else{
