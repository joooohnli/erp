...
try{
	String sql = "update hr_questiones set first_kind_ID='"+first_kind_ID+"',second_kind_ID='"+second_kind_ID+"',first_kind_name='"+first_kind_name+"',second_kind_name='"+second_kind_name+"',register='"+changer+"',register_time='"+change_time+"',derivation='"+derivation+"',content='"+content+"',keya='"+keya+"',keyb='"+keyb+"',keyc='"+keyc+"',keyd='"+keyd+"',keye='"+keye+"',correctkey='"+correctkey+"' where id='"+id+"'" ;
...
hr_db.commit();
hr_db.close();
response.sendRedirect("hr/engage/questiones/change_ok_a.jsp");
