...
try{
	...
	String sql2="insert into hr_salary_standard(standard_ID,standard_name,major_type,designer,register,register_time,salary_sum,check_tag) values('"+standard_ID+"','"+standard_name+"','"+major_type+"','"+designer+"','"+register+"','"+register_time+"','"+salary_sum+"','5')";
...
response.sendRedirect("hr/salary_standard/register_draft_ok.jsp?finished_tag=0");
}else{


response.sendRedirect("hr/salary_standard/register_draft_ok.jsp?finished_tag=1");


}}else{
		
response.sendRedirect("hr/salary_standard/register_draft_ok.jsp?finished_tag=2");
