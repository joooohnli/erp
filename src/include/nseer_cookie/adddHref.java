...
public class adddHref {
	...
	public adddHref(ServletContext dbApplication){
		this.dbApplication=dbApplication;
	}

	public String adddHref(String unit_db_name,String a){
		this.a=a;
		this.d=a;
		...
		try{
			...
			int i=a.indexOf("**");
				while(i!=-1){
					...
					if(!rs.next()){
						String sql1="insert into document_comment(name) values('"+c+"')";
