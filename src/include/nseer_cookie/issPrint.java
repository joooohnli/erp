...
public class issPrint {

private businessComment demo=new businessComment();


	public issPrint(HttpServletRequest request){
	...
	public String printOrNotTd(String file,HttpServletResponse response,String id,String tablename,String field_name){
		...
		try{
			...
			if(!file.equals("")){
				...
				content.append(file.substring(7));
	...
	public String hasOrNot7(String file,String topic,String name,HttpServletResponse response,String id,String tablename){
		...
		try{
			...
			if(!file.equals("")){
				...
				content.append(demo.getLang("erp",topic));
				content.append("</font>&nbsp;</td>");
				content.append("<td colspan=\"7\" bgcolor=\"#FFFFFF\" width=\"80%\"><input type=\"file\" name=\""+name+"\" width=\"100%\"><a href=\"javascript:winopenm('query_attachment.jsp?id=" + id+"&tablename="+tablename+"&fieldname="+field_name);
				content.append("')\"><font color=\"#3333FF\">");
				content.append(file.substring(10));
				content.append("</font></a>&nbsp;<input type=\"checkbox\" name=\"attachment\" value=\""+field_name+"\">删除该附件</td>");
				content.append("</tr>");
				...
				content.append(demo.getLang("erp",topic));
				content.append("</font>&nbsp;</td>");
				content.append("<td colspan=\"7\" bgcolor=\"#FFFFFF\" width=\"80%\"><input type=\"file\" name=\""+name+"\" width=\"100%\"></td>");
				content.append("</tr>");
			}
		}catch(Exception ex){
			ex.printStackTrace();
	...
	public String hasOrNot3(String file,String topic,String name,HttpServletResponse response,String tr_style,String td_style1,String td_style2,String file_style,String id,String tablename){
		StringBuffer content=new  StringBuffer();
		try{
			PrintWriter out=response.getWriter();
			String field_name="attachment"+name;
			...
			if(!file.equals("")){
				...
				content.append(demo.getLang("erp",topic)+"：");
				content.append("</td>");
				content.append("<td colspan=\"3\"" + td_style2 + " CLASS=\"TD_STYLE2\" width=\"87%\"><input type=\"file\" name=\""+name+"\"" +file_style+" CLASS=\"FILE_STYLE1\" width=\"100%\"></td>");
				content.append("</tr>");
			}
		}catch(Exception ex){
			ex.printStackTrace();
	...
	public String hasOrNot33(String file,String topic,String name,HttpServletResponse response,String tr_style,String td_style1,String td_style2,String file_style,String id,String tablename){
		StringBuffer content=new  StringBuffer();
		try{
			PrintWriter out=response.getWriter();
			String field_name="attachment"+name;
