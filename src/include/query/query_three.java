...
public class query_three {
  ...
  private double doubleValue=0.0d;
	...
	public double sumTotal(String fName,String reason,int temp) {
					this.fieldName=fName;//字段
					String paying_or_gathering=reason;
					double tradeTotal=0.0d;
				...
				try{
					...
					if(temp==1){
					while(rs2.next()){
						if(rs2.getString("paying_or_gathering").equals(paying_or_gathering)){
