...
public class ValidatorDup5 extends HttpServlet {
	...
	public void service(HttpServletRequest request,HttpServletResponse response) throws IOException,ServletException{
		try{
			...
			ValidatorDupBean5 vdb=new ValidatorDupBean5();
			if(vdb.isDup(session,table_name,fn,value,values)){
				out.println(demo.getLang("erp","用户名重复！"));
			}
		}catch(Exception ex){
		ex.printStackTrace();
		}
