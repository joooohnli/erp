...
int i;
int intRowCount;
String sqll = "select * from intrmanufacture_config_public_char where kind='委外厂商级别' order by type_ID" ;
...
response.sendRedirect("intrmanufacture/config/file/strategyClass.jsp");
