...
int i;
int intRowCount;
String sqll = "select * from intrmanufacture_config_public_char where kind='\u533a\u57df' order by type_ID" ;
...
response.sendRedirect("intrmanufacture/config/file/territory.jsp");
