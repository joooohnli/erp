 ...
 */
package intrmanufacture.config.key;
...
String[] cols=request.getParameterValues("col");
   ...
   if(cols==null){
response.sendRedirect("intrmanufacture/config/key/key_register_ok_a.jsp");
}else{
	String column_group="";
...
response.sendRedirect("intrmanufacture/config/key/key_register_ok_b.jsp");
}
security_db.commit();
		security_db.close();
