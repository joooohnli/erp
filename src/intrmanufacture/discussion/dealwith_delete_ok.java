...
String sql2="update intrmanufacture_discussion set gar_tag='1' where discussion_ID='"+discussion_ID+"'";
	intrmanufacture_db.executeUpdate(sql2);
/*
String sql3="delete from intrmanufacture_discussion_details where discussion_ID='"+discussion_ID+"'";
intrmanufacture_db.executeUpdate(sql3);
*/
response.sendRedirect("intrmanufacture/discussion/dealwith_list.jsp");
