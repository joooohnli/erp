...
response.sendRedirect("intrmanufacture/discussion/register_choose_attachment.jsp?discussion_ID="+discussion_ID+"");	
}
catch (Exception ex){
ex.printStackTrace();
}
}else{	
	response.sendRedirect("intrmanufacture/discussion/register_ok_a.jsp");
	}
