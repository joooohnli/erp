...
Solid writer=new Solid("xml/intrmanufacture/excel_export.xml");
...
session.setAttribute("keyword",keyword);
   ...
   if(cols==null){
	response.sendRedirect("intrmanufacture/export/excel_locate_getpara_a.jsp?tablenick="+toUtf8String.utf8String(exchange.toURL(tablenick))+"");
	}else{
   ...
   response.sendRedirect("intrmanufacture_export_excel_ok");
}
