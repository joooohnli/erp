...
public class register_intrmanufacture_details_again_ok extends HttpServlet{
...
response.sendRedirect("intrmanufacture/intrmanufacture/register_intrmanufacture_details_again_ok_a.jsp?intrmanufacture_ID="+intrmanufacture_ID+"");

}else{

response.sendRedirect("intrmanufacture/intrmanufacture/register_intrmanufacture_details_again_ok_b.jsp?intrmanufacture_ID="+intrmanufacture_ID+"");
}
}else{

response.sendRedirect("intrmanufacture/intrmanufacture/register_intrmanufacture_details_again_ok_c.jsp?intrmanufacture_ID="+intrmanufacture_ID+"");
}
