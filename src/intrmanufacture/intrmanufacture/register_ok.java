...
int n=0;
	...
	while(tokenTO2.hasMoreTokens()) {
        String sql5="select * from manufacture_apply where manufacture_tag='1' and id='"+tokenTO2.nextToken()+"'";
...
response.sendRedirect("intrmanufacture/intrmanufacture/register_ok_a.jsp");
}else{
response.sendRedirect("intrmanufacture/intrmanufacture/register_ok_b.jsp");
}}else{
response.sendRedirect("intrmanufacture/intrmanufacture/register_ok_c.jsp");
}
  }else{
response.sendRedirect("intrmanufacture/intrmanufacture/register_ok_d.jsp");
}
}else{
response.sendRedirect("intrmanufacture/intrmanufacture/register_ok_e.jsp");
}
