...
XlsWriter xls=new XlsWriter((String)dbSession.getAttribute("unit_db_name"),"xml/logistics/excel_export.xml");
...
String contact_ID=(String)session.getAttribute("contact_ID");
...
String logisticser_ID=(String)session.getAttribute("logisticser_ID");
String logistics_ID=(String)session.getAttribute("logistics_ID");
String keyword=(String)session.getAttribute("keyword");
if(table.equals("物流单位档案")){
String dbase=(String)dbSession.getAttribute("unit_db_name");
tablename="logistics_file";
...
String fieldName5="logisticser_ID";
String condition="check_tag='1'";
String queue="order by register_time";
sql=query.query(dbase,tablename,timea,timeb,first_kind_name,second_kind_name,third_kind_name,logisticser_ID,fieldName1,fieldName2,fieldName3,fieldName4,fieldName5,condition,queue,realname);
}else if(table.equals("物流单位联络")){
String dbase=(String)dbSession.getAttribute("unit_db_name");
tablename="logistics_contact";
String fieldName1="contact_time";
String fieldName2="contact_ID";
...
sql=query_three.query(dbase,tablename,timea,timeb,contact_ID,keyword,fieldName1,fieldName2,fieldName3,condition,queue);
}else if(table.equals("配送单")){
	String dbase=(String)dbSession.getAttribute("unit_db_name");
	tablename="logistics_logistics";
	String fieldName1="register_time";
	String fieldName2="logistics_ID";
	String[] fieldName3=column.Column(dbase,tablename);
	String queue="order by register_time desc";
	String condition="check_tag='1'";
	sql=query_three.query(dbase,tablename,timea,timeb,logistics_ID,keyword,fieldName1,fieldName2,fieldName3,condition,queue);
}else{
	String dbase=(String)session.getAttribute("unit_db_name");
 tablename="logistics_discussion";
String fieldName1="register_time";
String fieldName2="first_kind_name";
String fieldName3="third_kind_name";
String fieldName4="second_kind_name";
...
String queue="order by register_time desc";
String condition="discussion_tag='2' and excel_tag='2'";
...
xls.write(path+"excel_files/logistics_data.xls");
response.sendRedirect("logistics/export/excel_ok_a.jsp");
}
catch (Exception ex){
ex.printStackTrace();
}
