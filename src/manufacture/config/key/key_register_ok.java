 ...
 */
package manufacture.config.key;
...
response.sendRedirect("manufacture/config/key/key_register_ok_a.jsp");
}else{
	String column_group="";
	...
	security_db.commit();
	security_db.close();
response.sendRedirect("manufacture/config/key/key_register_ok_b.jsp");
}
}else{
