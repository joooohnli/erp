...
public class designModule_change_ok extends HttpServlet{
...
if(chain_id_array==null){
  	response.sendRedirect("manufacture/config/workflow/designModule_change_ok_a.jsp?id="+id+"&type_id="+type_id);
}else{
String describe1="";
String describe2="";
...
String sql="select design_id from manufacture_design_procedure where design_module_tag='1'";
	...
	manufacture_db.executeUpdate(sql1);	
response.sendRedirect("manufacture/config/workflow/designModule_change_ok_b.jsp?id="+id+"&type_id="+type_id);
}
