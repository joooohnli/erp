...
public class manufacture_change_ok extends HttpServlet{
...
if(chain_id_array==null){
  	response.sendRedirect("manufacture/config/workflow/manufacture_change_ok_a.jsp?id="+id+"&type_id="+type_id);
}else{
String describe1="";
String describe2="";
...
String sql="select manufacture_id from manufacture_manufacture where check_tag='0'";
	...
	manufacture_db.executeUpdate(sql1);	
response.sendRedirect("manufacture/config/workflow/manufacture_change_ok_b.jsp?id="+id+"&type_id="+type_id);
}
