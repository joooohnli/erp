...
response.sendRedirect("manufacture/design_module/change.jsp?design_ID="+design_ID+"");
}
catch (Exception ex){
ex.printStackTrace();
}
	...
	response.sendRedirect("manufacture/design_module/change_module_ok_b.jsp?design_ID="+design_ID+"");
}
  design_db.commit();
