...
ex.printStackTrace();
	...
	response.sendRedirect("manufacture/design_procedure/register_draft_ok.jsp?finished_tag=0");
}else{

	response.sendRedirect("manufacture/design_procedure/register_draft_ok.jsp?finished_tag=1");
}
}else{

response.sendRedirect("manufacture/design_procedure/register_draft_ok.jsp?finished_tag=2");
}
  design_db.commit();
