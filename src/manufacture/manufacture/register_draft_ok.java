...
ex.printStackTrace();
	...
	response.sendRedirect("manufacture/manufacture/register_draft_ok.jsp?finished_tag=0");
}else{
	
	response.sendRedirect("manufacture/manufacture/register_draft_ok.jsp?finished_tag=1");
}
