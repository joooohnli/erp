...
String remark=exchange.toHtml(bodyb);
	String sql = "update manufacture_manufacture set designer='"+designer+"',register='"+register+"',register_time='"+register_time+"',remark='"+remark+"',checker='"+checker+"',check_time='"+check_time+"',check_tag='1' where manufacture_ID='"+manufacture_ID+"'" ;
