...
public class messagerType_delete_ok extends HttpServlet{
...
int i;
int intRowCount;
String sqll = "select * from oa_config_public_char where kind='群发对象分类' order by type_ID" ;
...
oa_db.commit();
oa_db.close();
response.sendRedirect("oa/config/messager/messagerType.jsp");
