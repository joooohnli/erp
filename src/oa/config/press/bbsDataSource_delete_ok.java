...
public class bbsDataSource_delete_ok extends HttpServlet{
...
int i;
int intRowCount;
String sqll = "select * from oa_config_public_char where kind='数据源' order by type_ID" ;
...
oa_db.commit();
oa_db.close();
response.sendRedirect("oa/config/press/bbsDataSource.jsp");
