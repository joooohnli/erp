...
public class web_delete_ok extends HttpServlet{
...
int i;
int intRowCount;
String sqll = "select * from oa_config_public_char where kind='公司网站' order by type_ID" ;
...
oa_db.commit();
oa_db.close();
response.sendRedirect("oa/config/press/web.jsp");
