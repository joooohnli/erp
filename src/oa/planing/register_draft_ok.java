...
if(human!=null&&!human.equals("")){
	...
	String sqlb = ") values ('"+register+"','"+register_ID+"','"+register_time+"','"+planing_ID+"','"+subject+"','"+meeting_subject+"','"+planing_type+"','"+begin_time+"','"+end_time+"','"+content+"','"+chain_id+"','"+chain_name+"','"+human_ID+"','"+human_name+"','5'" ;
for(int i=0;i<mySmartUpload.getFiles().getCount();i++){
	int p=i+1;
