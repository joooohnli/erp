...
response.sendRedirect("portal/crm/register2_choose_attachment.jsp?discussion_ID="+discussion_ID+"");	
}
catch (Exception ex){
out.println("error"+ex);
	...
	response.sendRedirect("portal/crm/register2_ok_a.jsp?customer_ID="+customer_ID);
	}
	crm_db.commit();
	crm_db.close();
}else{
