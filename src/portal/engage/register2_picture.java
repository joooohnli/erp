...
public class register2_picture extends HttpServlet{
//创建方法
...
String details_number=NseerId.getId("hr/engage/resume",(String)dbSession.getAttribute("unit_db_name"));
...
if(birthday.equals("")) birthday="1800-01-01";
	...
	hr_db.commit();
	hr_db.close();
	response.sendRedirect("portal/engage/register2_choose_picture.jsp?details_number="+details_number);
}else{
