...
int i;
int intRowCount;
String sqll = "select * from purchase_config_public_char where kind='\u8054\u7edc\u7406\u7531' order by type_ID" ;
...
try{
	if(del[i-1]!=null){
	String sql = "delete from purchase_config_public_char where id='"+del[i-1]+"'" ;
...
purchase_db.close();
response.sendRedirect("purchase/config/contact/reason.jsp");
