...
String[] cols=request.getParameterValues("col");
   ...
   if(cols==null){
response.sendRedirect("purchase/config/key/key_register_ok_a.jsp");
}else{
	String column_group="";
...
response.sendRedirect("purchase/config/key/key_register_ok_b.jsp");
}
	security_db.commit();
	security_db.close();
