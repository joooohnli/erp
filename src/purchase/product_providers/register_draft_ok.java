...
response.sendRedirect("purchase/product_providers/register_draft_ok.jsp?finished_tag=0");
}else{
	response.sendRedirect("purchase/product_providers/register_draft_ok.jsp?finished_tag=1");
	}
	}else{
	response.sendRedirect("purchase/product_providers/register_draft_ok.jsp?finished_tag=2");
	}
		purchase_db.commit();	
	design_db.commit();
	purchase_db.close();
