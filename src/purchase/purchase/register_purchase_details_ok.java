...
public class register_purchase_details_ok extends HttpServlet{
...
if(Double.parseDouble(demand_amount)<=Double.parseDouble(amount)||Double.parseDouble(demand_amount)>=Double.parseDouble(amount)){
	String sql = "insert into purchase_details(purchase_ID,details_number,provider_ID,provider_name,designer,demand_contact_person,demand_contact_person_tel,demand_gather_time,demand_gather_type,demand_gather_shipFee_type,demand_gather_shipFee_sum,demand_pay_time,demand_pay_type,demand_pay_method,demand_invoice_type,demand_amount,demand_price,demand_cost_price_sum,credit_period,remark,check_tag) values ('"+purchase_ID+"','"+details_number+"','"+provider_ID+"','"+provider_name+"','"+designer+"','"+contact_person+"','"+provider_tel+"','"+demand_gather_time+"','"+demand_gather_type+"','"+demand_gather_shipFee_type+"','"+demand_gather_shipFee_sum+"','"+demand_pay_time+"','"+demand_pay_type+"','"+demand_pay_method+"','"+demand_invoice_type+"','"+demand_amount+"','"+demand_price+"','"+demand_cost_price_sum+"','"+credit_period+"','"+remark+"','0')" ;
