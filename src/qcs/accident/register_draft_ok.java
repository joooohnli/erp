...
String sqla = "insert into qcs_accident(accident_id,accident_time,accident_name,product_id,product_name,accident_outlines,explanation,survey_result,scene_measure,register_id,register,register_time,remark,check_tag";
	String sqlb = ") values ('"+accident_id+"','"+accident_time+"','"+accident_name+"','"+product_id+"','"+product_name+"','"+accident_outlines+"','"+explanation+"','"+survey_result+"','"+scene_measure+"','"+register_id+"','"+register+"','"+register_time+"','"+remark+"','5'";
...
String sql=sqla+sqlb+")";
	...
	response.sendRedirect("qcs/accident/register_draft_ok.jsp?finished_tag=0");
