...
String qcs_id=time+filenum;
mod=mod.substring(mod.lastIndexOf("/")+1);
String main_kind1=mod.split("_")[0];
String first_kind1=mod.split("_")[1];
String sqla="select main_code,first_code,second_code from document_first where main_kind_name='"+main_kind1+"' and first_kind_name='"+first_kind1+"' ";
...
qcs_id=main_code+first_code+second_code+qcs_id;
