...
try{
String sqll = "update stock_apply_gather set check_tag='1' where gather_ID='"+gather_ID+"'" ;
...
//String pay_ID=time+filenumber2;
...
String first_code2="";
String second_code2="";
String sqla="select * from document_first where main_kind_name='stock' and first_kind_name='gather'";
...
response.sendRedirect("stock/apply_gather/check_ok.jsp?finished_tag=0");
}else{
response.sendRedirect("stock/apply_gather/check_ok.jsp?finished_tag=1");
}
}
catch (Exception ex){
ex.printStackTrace();
...
response.sendRedirect("stock/apply_gather/check_ok.jsp?finished_tag=2");
}}else{
response.sendRedirect("stock/apply_gather/check_ok.jsp?finished_tag=3");
}
}else{
response.sendRedirect("stock/apply_gather/check_ok.jsp?finished_tag=4");
}
stock_db.commit();
stock_db.close();
}else{
