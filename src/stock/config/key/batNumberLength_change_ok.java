...
response.sendRedirect("stock/config/key/batNumberLength_change_ok_a.jsp");
}else{
	response.sendRedirect("stock/config/key/batNumberLength_change_ok_b.jsp");
}
}else{
	response.sendRedirect("stock/config/key/batNumberLength_change_ok_c.jsp");
}
stock_db.commit();
stock_db.close();
}else{
