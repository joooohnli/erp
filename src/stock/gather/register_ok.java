...
sqq="update stock_gather set gathering_time='"+gathering_time+"' where gather_ID='"+gather_ID+"'";
...
String sql10="select * from stock_balance_details_details where stock_name='"+stock_name[i]+"' and product_ID='"+product_ID[i]+"' and serial_number='"+serial_number1+"'";
ResultSet rs10=stock_db.executeQuery(sql10);
if(rs10.next()){double amount1=Double.parseDouble(amount[i])+rs10.getDouble("amount");

String sql101="update stock_balance_details_details set amount='"+amount1+"' where stock_name='"+stock_name[i]+"' and product_ID='"+product_ID[i]+"' and serial_number='"+serial_number1+"'";
...
String sqli10="select * from stock_balance_details_details_for_cost where stock_name='"+stock_name[i]+"' and product_ID='"+product_ID[i]+"' and serial_number='"+serial_number1+"'";
...
String sqli101="update stock_balance_details_details_for_cost set amount='"+amount1+"' where stock_name='"+stock_name[i]+"' and product_ID='"+product_ID[i]+"' and serial_number='"+serial_number1+"'";
...
if(serial_number_tag==1){
			String sql100="insert into stock_balance_details_details(chain_id,chain_name,product_ID,product_name,amount,cost_price,subtotal,stock_ID,stock_name,serial_number,register_time) values('"+chain_id+"','"+chain_name+"','"+product_ID[i]+"','"+product_name[i]+"','"+amount[i]+"','"+cost_price[i]+"','"+subtotal+"','','"+reason+"','"+serial_number1+"','"+time+"')";
			stock_db.executeUpdate(sql100);
			String sqll100="insert into stock_balance_details_details_for_cost(chain_id,chain_name,product_ID,product_name,amount,cost_price,subtotal,stock_ID,stock_name,serial_number,register_time) values('"+chain_id+"','"+chain_name+"','"+product_ID[i]+"','"+product_name[i]+"','"+amount[i]+"','"+cost_price[i]+"','"+subtotal+"','','"+reason+"','"+serial_number1+"','"+time+"')";
			stock_db.executeUpdate(sqll100);

			}else{


String sql10="select * from stock_balance_details_details where stock_name='"+reason+"' and product_ID='"+product_ID[i]+"' and serial_number='"+serial_number1+"'";
ResultSet rs10=stock_db.executeQuery(sql10);
if(rs10.next()){
