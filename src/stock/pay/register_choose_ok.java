...
String sql1="insert into stock_paying_temp(pay_ID,product_ID,stock_ID,serial_number,amount) values('"+pay_ID+"','"+product_ID+"','"+stock_ID+"','"+serial_number+"','"+serial_number_group.length+"')";
